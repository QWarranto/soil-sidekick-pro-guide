#!/bin/bash
# Launch Antigravity Agent - QA & Documentation Agent
# Usage: ./launch-qa-docs-agent.sh

AGENT_NAME="qa-docs-agent"
TASK_FILE="/Users/reginaldrice/clawd/agents/tasks/qa-docs-agent-task.md"
