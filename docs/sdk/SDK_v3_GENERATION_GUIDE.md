...
openapi-generator-cli generate \
  ...
  -g typescript-fetch \
  -o ./sdks/typescript \
  --additional-properties=npmName=@soilsidekick/sdk,npmVersion=3.0.0,supportsES6=true
```
...
openapi-generator-cli generate \
  ...
  -g python \
  -o ./sdks/python \
  --additional-properties=packageName=soilsidekick,packageVersion=3.0.0
```
...
openapi-generator-cli generate \
  ...
  -g ruby \
  -o ./sdks/ruby \
  --additional-properties=gemName=soilsidekick,gemVersion=3.0.0
```
...
openapi-generator-cli generate \
  ...
  -g php \
  -o ./sdks/php \
  --additional-properties=packageName=soilsidekick/sdk,packageVersion=3.0.0
```
...
openapi-generator-cli generate \
  ...
  -g java \
  -o ./sdks/java \
  --additional-properties=groupId=com.soilsidekick,artifactId=soilsidekick-sdk,artifactVersion=3.0.0
```
...
gem push soilsidekick-3.0.0.gem
```
