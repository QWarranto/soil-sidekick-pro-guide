...
> 🟢 **Now on the [GitHub MCP Registry](https://github.com/mcp)** — Discoverable natively in Claude Desktop, Cursor, and any registry-aware MCP client.

**Patent-protected soil analysis, environmental intelligence, and satellite-enhanced geotechnical reports** powered by USDA, EPA, NOAA, and Google Earth Engine data. The complete platform for agronomists, consultants, and developers worldwide.

## 📡 Install from the GitHub MCP Registry

LeafEngines is officially listed on the GitHub MCP Registry. In any registry-aware client, search **"LeafEngines"** and click Install, or add manually:
...
Replace the test key with your own from [app.soilsidekickpro.com/api-keys](https://app.soilsidekickpro.com/api-keys) for production.

## 🏆 Platform Validation — June 2026

> **A-Excellent Verified** — The LeafEngines™ platform earned an **A-Excellent verified rating** on MCP World (June 2026), the leading directory for AI-powered agricultural tools. SDK v3.0 is hardware-ready for direct sensor integration. MCP server deployed across nine channels including GitHub MCP Registry, NPM, and Telegram. QGIS Plugin (ID 4987) officially approved. **750+ developers** globally.
...
SoilSidekick Pro delivers agricultural intelligence through multiple channels:

- **Soil Analysis** — USDA SSURGO soil composition, pH, NPK, drainage, recommendations for any US county
- **Satellite Intelligence** — Real-time vegetation health via Google Earth Engine (AlphaEarth)
- **Water Quality** — EPA Water Quality Portal integration (400+ monitoring agencies)
- **Environmental Impact** — Patent-pending Environmental Compatibility Score
- **Carbon Credits** — Proprietary models for compliance reporting
- **Precision Agriculture** — VRT prescription maps, planting calendar optimization
- **Crop Recommendations** — AI-powered, location-specific planting advice
...
| **[Direct API](https://app.soilsidekickpro.com/api-docs)** | HTTP calls to Supabase edge functions | Custom integrations |
...
| Proprietary | $5.00/bundle | $0.010/call | Planting optimization, carbon credits, VRT | [Buy →](https://buy.stripe.com/28EeVd9oWeAf2F48MSaMU0d) |
...
- SOC 2 Type 1 certified security controls
...
- **Multi-platform SDKs** — MCP, ClawHub, n8n, Node-RED, QGIS, direct API
...
## 🗺️ Sample GeoJSON Deliverables

SoilCertify produces PDF reports + RFC 7946 GeoJSON for every property. Below are unmodified pilot outputs from four jurisdictions. Each file renders as an interactive map when viewed on GitHub, or can be downloaded for use in QGIS, ArcGIS, PostGIS, and other geospatial environments.

| Location | Report Type | Interactive Preview | Raw GeoJSON (QGIS/ArcGIS) |
|----------|-------------|---------------------|---------------------------|
| Austin, TX, USA | Summary | [View Map](samples/soilcertify-pilot-geojsons/austin_summary.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/austin_summary.geojson) |
| Austin, TX, USA | Detailed | [View Map](samples/soilcertify-pilot-geojsons/austin_detailed.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/austin_detailed.geojson) |
| London, UK | Summary | [View Map](samples/soilcertify-pilot-geojsons/london_summary.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/london_summary.geojson) |
| London, UK | Detailed | [View Map](samples/soilcertify-pilot-geojsons/london_detailed.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/london_detailed.geojson) |
| Sydney, AU | Summary | [View Map](samples/soilcertify-pilot-geojsons/sydney_summary.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/sydney_summary.geojson) |
| Sydney, AU | Detailed | [View Map](samples/soilcertify-pilot-geojsons/sydney_detailed.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/sydney_detailed.geojson) |
| Wellington, NZ | Summary | [View Map](samples/soilcertify-pilot-geojsons/wellington_summary.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/wellington_summary.geojson) |
| Wellington, NZ | Detailed | [View Map](samples/soilcertify-pilot-geojsons/wellington_detailed.geojson) | [Download](https://raw.githubusercontent.com/QWarranto/soil-sidekick-pro-guide/main/samples/soilcertify-pilot-geojsons/wellington_detailed.geojson) |

**QGIS users:** Copy any Raw GeoJSON URL → Layer → Add Layer → Add Vector Layer → Protocol → paste URL.
...
- **SDK Quickstart:** [app.soilsidekickpro.com/sdk-quickstart](https://app.soilsidekickpro.com/sdk-quickstart)
- **Integration Guides:** [app.soilsidekickpro.com/docs](https://app.soilsidekickpro.com/docs)

## 📞 Support

- **GitHub Issues:** [github.com/QWarranto/soil-sidekick-pro-guide/issues](https://github.com/QWarranto/soil-sidekick-pro-guide/issues)
