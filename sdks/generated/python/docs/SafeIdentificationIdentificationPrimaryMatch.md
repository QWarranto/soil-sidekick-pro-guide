...
safe_identification_identification_primary_match_from_dict = SafeIdentificationIdentificationPrimaryMatch.from_dict(safe_identification_identification_primary_match_dict)
```
