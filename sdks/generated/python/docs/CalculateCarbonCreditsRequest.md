...
**soil_analysis_id** | **UUID** | Reference to existing soil analysis | [optional] 
...
calculate_carbon_credits_request_from_dict = CalculateCarbonCreditsRequest.from_dict(calculate_carbon_credits_request_dict)
```
