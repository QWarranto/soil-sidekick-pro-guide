...
seasonal_planning_response_recommendations_from_dict = SeasonalPlanningResponseRecommendations.from_dict(seasonal_planning_response_recommendations_dict)
```
