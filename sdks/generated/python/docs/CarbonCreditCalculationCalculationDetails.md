...
carbon_credit_calculation_calculation_details_from_dict = CarbonCreditCalculationCalculationDetails.from_dict(carbon_credit_calculation_calculation_details_dict)
```
