...
class CarbonApi:
    ...
    def calculate_carbon_credits(
        self,
        calculate_carbon_credits_request: CalculateCarbonCreditsRequest,
        ...
        :param calculate_carbon_credits_request: (required)
        :type calculate_carbon_credits_request: CalculateCarbonCreditsRequest
        ...
        _param = self._calculate_carbon_credits_serialize(
            calculate_carbon_credits_request=calculate_carbon_credits_request,
    ...
    @validate_call
    def calculate_carbon_credits_with_http_info(
        self,
        calculate_carbon_credits_request: CalculateCarbonCreditsRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CarbonCreditCalculation]:
        """Calculate carbon credits
    ...
    @validate_call
    def calculate_carbon_credits_without_preload_content(
        self,
        calculate_carbon_credits_request: CalculateCarbonCreditsRequest,
        _request_timeout: Union[
            None,
    ...
    def _calculate_carbon_credits_serialize(
        self,
        calculate_carbon_credits_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if calculate_carbon_credits_request is not None:
            _body_params = calculate_carbon_credits_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/carbon-credit-calculator',
