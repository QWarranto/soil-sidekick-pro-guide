...
class VRTApi:
    ...
    @validate_call
    def generate_vrt_prescription(
        self,
        generate_vrt_prescription_request: GenerateVRTPrescriptionRequest,
        ...
        :param generate_vrt_prescription_request: (required)
        :type generate_vrt_prescription_request: GenerateVRTPrescriptionRequest
        ...
        _param = self._generate_vrt_prescription_serialize(
            generate_vrt_prescription_request=generate_vrt_prescription_request,
    ...
    @validate_call
    def generate_vrt_prescription_with_http_info(
        self,
        generate_vrt_prescription_request: GenerateVRTPrescriptionRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_vrt_prescription_without_preload_content(
        self,
        generate_vrt_prescription_request: GenerateVRTPrescriptionRequest,
        _request_timeout: Union[
            None,
    ...
    def _generate_vrt_prescription_serialize(
        self,
        generate_vrt_prescription_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if generate_vrt_prescription_request is not None:
            _body_params = generate_vrt_prescription_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/generate-vrt-prescription',
