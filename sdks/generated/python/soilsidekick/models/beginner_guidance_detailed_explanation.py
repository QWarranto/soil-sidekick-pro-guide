...
class BeginnerGuidanceDetailedExplanation(BaseModel):
    """
    More details for users who want to learn
    """ # noqa: E501
    technical_term: Optional[StrictStr] = None
    plain_english: Optional[StrictStr] = None
    common_causes: Optional[List[StrictStr]] = None
    prevention_tips: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["technical_term", "plain_english", "common_causes", "prevention_tips"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "technical_term": obj.get("technical_term"),
            "plain_english": obj.get("plain_english"),
            "common_causes": obj.get("common_causes"),
            "prevention_tips": obj.get("prevention_tips")
        })
        return _obj
