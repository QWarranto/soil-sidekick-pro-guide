...
class CarbonCreditCalculationCreditRecord(BaseModel):
    """
    CarbonCreditCalculationCreditRecord
    """ # noqa: E501
    id: Optional[UUID] = None
    field_name: Optional[StrictStr] = None
    field_size_acres: Optional[Union[StrictFloat, StrictInt]] = None
    credits_earned: Optional[Union[StrictFloat, StrictInt]] = None
    verification_status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "field_name", "field_size_acres", "credits_earned", "verification_status"]
