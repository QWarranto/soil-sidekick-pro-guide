...
class DynamicCareRequestLocation(BaseModel):
    """
    DynamicCareRequestLocation
    """ # noqa: E501
    county_fips: Annotated[str, Field(strict=True)]
    state_code: Optional[StrictStr] = None
    indoor: Optional[StrictBool] = Field(default=None, description="Whether the plant is indoors")
    __properties: ClassVar[List[str]] = ["county_fips", "state_code", "indoor"]
