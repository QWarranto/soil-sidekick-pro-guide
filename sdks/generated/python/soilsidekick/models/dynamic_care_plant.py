...
class DynamicCarePlant(BaseModel):
    """
    DynamicCarePlant
    """ # noqa: E501
    common_name: Optional[StrictStr] = None
    scientific_name: Optional[StrictStr] = None
    care_difficulty: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["common_name", "scientific_name", "care_difficulty"]

    @field_validator('care_difficulty')
    def care_difficulty_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['easy', 'moderate', 'challenging']):
            raise ValueError("must be one of enum values ('easy', 'moderate', 'challenging')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "care_difficulty": obj.get("care_difficulty")
        })
        return _obj
