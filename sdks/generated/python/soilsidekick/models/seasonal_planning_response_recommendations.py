...
class SeasonalPlanningResponseRecommendations(BaseModel):
    """
    SeasonalPlanningResponseRecommendations
    """ # noqa: E501
    seasonal_tasks: Optional[List[Dict[str, Any]]] = None
    crop_recommendations: Optional[List[StrictStr]] = None
    timing_guidance: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["seasonal_tasks", "crop_recommendations", "timing_guidance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "seasonal_tasks": obj.get("seasonal_tasks"),
            "crop_recommendations": obj.get("crop_recommendations"),
            "timing_guidance": obj.get("timing_guidance")
        })
        return _obj
