...
class CalculateEnvironmentalImpactRequestProposedTreatmentsInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['nitrogen_fertilizer', 'phosphorus_fertilizer', 'pesticide']):
            raise ValueError("must be one of enum values ('nitrogen_fertilizer', 'phosphorus_fertilizer', 'pesticide')")
        return value
