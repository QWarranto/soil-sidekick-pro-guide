...
class LeafenginesQueryRequestPlantCareRequirements(BaseModel):
    ...
    def sun_exposure_validate_enum(cls, value):
        ...
        if value not in set(['full_sun', 'partial_shade', 'full_shade']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "soil_ph_range": LeafenginesQueryRequestPlantCareRequirementsSoilPhRange.from_dict(obj["soil_ph_range"]) if obj.get("soil_ph_range") is not None else None
        })
        return _obj
