...
class PlantingCalendar(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optimal_planting_window": GetTerritorialWaterAnalyticsRequestDateRange.from_dict(obj["optimal_planting_window"]) if obj.get("optimal_planting_window") is not None else None,
