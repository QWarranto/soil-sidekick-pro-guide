...
class SafeIdentificationMetadata(BaseModel):
    """
    SafeIdentificationMetadata
    """ # noqa: E501
    analysis_id: Optional[UUID] = None
    timestamp: Optional[datetime] = None
    environmental_data_used: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["analysis_id", "timestamp", "environmental_data_used"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "environmental_data_used": obj.get("environmental_data_used")
        })
        return _obj
