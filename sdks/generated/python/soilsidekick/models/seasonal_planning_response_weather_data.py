...
class SeasonalPlanningResponseWeatherData(BaseModel):
    """
    SeasonalPlanningResponseWeatherData
    """ # noqa: E501
    current_season: Optional[StrictStr] = Field(default=None, alias="currentSeason")
    temperature: Optional[StrictStr] = None
    rainfall: Optional[StrictStr] = None
    frost_dates: Optional[Dict[str, Any]] = Field(default=None, alias="frostDates")
    growing_season: Optional[StrictStr] = Field(default=None, alias="growingSeason")
    zone: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["currentSeason", "temperature", "rainfall", "frostDates", "growingSeason", "zone"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rainfall": obj.get("rainfall"),
            "frostDates": obj.get("frostDates"),
            "growingSeason": obj.get("growingSeason"),
            "zone": obj.get("zone")
        })
        return _obj
