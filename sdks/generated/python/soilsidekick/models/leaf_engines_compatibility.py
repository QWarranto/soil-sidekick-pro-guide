...
class LeafEnginesCompatibility(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": LeafEnginesCompatibilityData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "usage": LeafEnginesCompatibilityUsage.from_dict(obj["usage"]) if obj.get("usage") is not None else None
        })
        return _obj
