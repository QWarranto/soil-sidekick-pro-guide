...
class TurboQuantCapabilitiesRequest(BaseModel):
    """
    TurboQuantCapabilitiesRequest
    """ # noqa: E501
    device_memory_gb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Device RAM in GB", json_schema_extra={"examples": [4]})
    has_webgpu: Optional[StrictBool] = Field(default=None, description="Whether WebGPU is available", json_schema_extra={"examples": [True]})
    platform: Optional[StrictStr] = Field(default=None, json_schema_extra={"examples": ["mobile"]})
    __properties: ClassVar[List[str]] = ["device_memory_gb", "has_webgpu", "platform"]
    ...
    def platform_validate_enum(cls, value):
        ...
        if value not in set(['mobile', 'tablet', 'desktop', 'server']):
            raise ValueError("must be one of enum values ('mobile', 'tablet', 'desktop', 'server')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device_memory_gb": obj.get("device_memory_gb"),
            "has_webgpu": obj.get("has_webgpu"),
