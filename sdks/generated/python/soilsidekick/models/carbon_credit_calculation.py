...
class CarbonCreditCalculation(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "credit_record": CarbonCreditCalculationCreditRecord.from_dict(obj["credit_record"]) if obj.get("credit_record") is not None else None,
            "calculation_details": CarbonCreditCalculationCalculationDetails.from_dict(obj["calculation_details"]) if obj.get("calculation_details") is not None else None
        })
        return _obj
