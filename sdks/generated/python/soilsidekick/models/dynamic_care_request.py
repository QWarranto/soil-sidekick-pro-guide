...
class DynamicCareRequest(BaseModel):
    ...
    DynamicCareRequest
    """ # noqa: E501
    plant_species: StrictStr = Field(description="Common or scientific plant name", json_schema_extra={"examples": ["Monstera deliciosa"]})
    ...
    def soil_type_validate_enum(cls, value):
        ...
        if value not in set(['potting_mix', 'succulent_mix', 'orchid_bark', 'garden_soil', 'sandy', 'clay']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "location": DynamicCareRequestLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "environment": DynamicCareRequestEnvironment.from_dict(obj["environment"]) if obj.get("environment") is not None else None,
            "container_details": DynamicCareRequestContainerDetails.from_dict(obj["container_details"]) if obj.get("container_details") is not None else None,
