...
class EnvironmentalImpactDetailedAnalysis(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "runoff_risk": EnvironmentalImpactDetailedAnalysisRunoffRisk.from_dict(obj["runoff_risk"]) if obj.get("runoff_risk") is not None else None,
            "contamination_assessment": obj.get("contamination_assessment"),
            "eco_alternatives": EnvironmentalImpactDetailedAnalysisEcoAlternatives.from_dict(obj["eco_alternatives"]) if obj.get("eco_alternatives") is not None else None,
