...
class GetSeasonalPlanningAssistantRequest(BaseModel):
    ...
    def planning_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['spring_planting', 'fall_harvest', 'winter_prep', 'year_round']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location": GetSeasonalPlanningAssistantRequestLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
