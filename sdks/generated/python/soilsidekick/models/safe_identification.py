...
class SafeIdentification(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identification": SafeIdentificationIdentification.from_dict(obj["identification"]) if obj.get("identification") is not None else None,
            "safety_analysis": SafeIdentificationSafetyAnalysis.from_dict(obj["safety_analysis"]) if obj.get("safety_analysis") is not None else None,
            "confidence_breakdown": SafeIdentificationConfidenceBreakdown.from_dict(obj["confidence_breakdown"]) if obj.get("confidence_breakdown") is not None else None,
            "metadata": SafeIdentificationMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
