...
class GetSoilDataRequest(BaseModel):
    """
    GetSoilDataRequest
    """ # noqa: E501
    county_fips: Annotated[str, Field(strict=True)] = Field(description="5-digit FIPS code", json_schema_extra={"examples": ["12345"]})
    __properties: ClassVar[List[str]] = ["county_fips"]
