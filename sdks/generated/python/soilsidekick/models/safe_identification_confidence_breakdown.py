...
class SafeIdentificationConfidenceBreakdown(BaseModel):
    """
    SafeIdentificationConfidenceBreakdown
    """ # noqa: E501
    visual_match: Optional[Union[StrictFloat, StrictInt]] = None
    environmental_context: Optional[Union[StrictFloat, StrictInt]] = None
    regional_prevalence: Optional[Union[StrictFloat, StrictInt]] = None
    growth_stage_alignment: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["visual_match", "environmental_context", "regional_prevalence", "growth_stage_alignment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "visual_match": obj.get("visual_match"),
            "environmental_context": obj.get("environmental_context"),
            "regional_prevalence": obj.get("regional_prevalence"),
            "growth_stage_alignment": obj.get("growth_stage_alignment")
        })
        return _obj
