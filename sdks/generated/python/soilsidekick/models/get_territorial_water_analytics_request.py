...
class GetTerritorialWaterAnalyticsRequest(BaseModel):
    ...
    def territory_type_validate_enum(cls, value):
        ...
        if value not in set(['state', 'territory', 'compact_state']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date_range": GetTerritorialWaterAnalyticsRequestDateRange.from_dict(obj["date_range"]) if obj.get("date_range") is not None else None
        })
        return _obj
