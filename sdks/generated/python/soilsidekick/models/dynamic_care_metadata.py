...
class DynamicCareMetadata(BaseModel):
    """
    DynamicCareMetadata
    """ # noqa: E501
    location_data_used: Optional[StrictBool] = None
    weather_data_freshness: Optional[StrictStr] = None
    confidence: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["location_data_used", "weather_data_freshness", "confidence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location_data_used": obj.get("location_data_used"),
            "weather_data_freshness": obj.get("weather_data_freshness"),
