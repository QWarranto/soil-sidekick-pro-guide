...
class GetPlantingCalendarRequest(BaseModel):
    """
    GetPlantingCalendarRequest
    """ # noqa: E501
    county_fips: Annotated[str, Field(strict=True)]
    crop_type: StrictStr = Field(json_schema_extra={"examples": ["corn"]})
    __properties: ClassVar[List[str]] = ["county_fips", "crop_type"]
