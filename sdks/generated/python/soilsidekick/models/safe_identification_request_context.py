...
class SafeIdentificationRequestContext(BaseModel):
    """
    SafeIdentificationRequestContext
    """ # noqa: E501
    environment: Optional[StrictStr] = None
    purpose: Optional[StrictStr] = None
    growth_stage: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["environment", "purpose", "growth_stage"]
    ...
    def environment_validate_enum(cls, value):
        ...
        if value not in set(['wild', 'garden', 'indoor', 'agricultural']):
            raise ValueError("must be one of enum values ('wild', 'garden', 'indoor', 'agricultural')")
        return value
    ...
    def purpose_validate_enum(cls, value):
        ...
        if value not in set(['foraging', 'gardening', 'curiosity', 'pet_safety']):
            raise ValueError("must be one of enum values ('foraging', 'gardening', 'curiosity', 'pet_safety')")
        return value

    @field_validator('growth_stage')
    def growth_stage_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "growth_stage": obj.get("growth_stage")
        })
        return _obj
