...
class DynamicCareCareRecommendations(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "watering": DynamicCareCareRecommendationsWatering.from_dict(obj["watering"]) if obj.get("watering") is not None else None,
            "light": DynamicCareCareRecommendationsLight.from_dict(obj["light"]) if obj.get("light") is not None else None,
            "humidity": DynamicCareCareRecommendationsHumidity.from_dict(obj["humidity"]) if obj.get("humidity") is not None else None,
