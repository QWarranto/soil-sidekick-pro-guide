...
class CalculateCarbonCreditsRequest(BaseModel):
    ...
    soil_analysis_id: Optional[UUID] = Field(default=None, description="Reference to existing soil analysis")
    ...
    def verification_type_validate_enum(cls, value):
        ...
        if value not in set(['self_reported', 'third_party', 'satellite']):
