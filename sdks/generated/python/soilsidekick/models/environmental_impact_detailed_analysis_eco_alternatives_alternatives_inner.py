...
class EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner(BaseModel):
    """
    ...
    environmental_benefit: Optional[StrictStr] = None
    effectiveness_score: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["category", "alternative", "description", "environmental_benefit", "effectiveness_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "environmental_benefit": obj.get("environmental_benefit"),
            "effectiveness_score": obj.get("effectiveness_score")
        })
        return _obj
