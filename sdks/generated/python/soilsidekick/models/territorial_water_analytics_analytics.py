...
class TerritorialWaterAnalyticsAnalytics(BaseModel):
    """
    TerritorialWaterAnalyticsAnalytics
    """ # noqa: E501
    territorial_coverage: Optional[Dict[str, Any]] = None
    water_quality_metrics: Optional[Dict[str, Any]] = None
    regional_insights: Optional[Dict[str, Any]] = None
    compliance_status: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["territorial_coverage", "water_quality_metrics", "regional_insights", "compliance_status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "territorial_coverage": obj.get("territorial_coverage"),
            "water_quality_metrics": obj.get("water_quality_metrics"),
            "regional_insights": obj.get("regional_insights"),
