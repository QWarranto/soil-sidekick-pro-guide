...
class LeafEnginesCompatibilityData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "breakdown": LeafEnginesCompatibilityDataBreakdown.from_dict(obj["breakdown"]) if obj.get("breakdown") is not None else None,
            "recommendations": obj.get("recommendations"),
            "risk_level": obj.get("risk_level"),
            "metadata": LeafEnginesCompatibilityDataMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
