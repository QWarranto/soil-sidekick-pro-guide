...
class LeafenginesQueryRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "location": LeafenginesQueryRequestLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "plant": LeafenginesQueryRequestPlant.from_dict(obj["plant"]) if obj.get("plant") is not None else None,
            "options": LeafenginesQueryRequestOptions.from_dict(obj["options"]) if obj.get("options") is not None else None
        })
        return _obj
