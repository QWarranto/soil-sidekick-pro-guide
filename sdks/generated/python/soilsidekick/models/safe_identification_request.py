...
class SafeIdentificationRequest(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": obj.get("image"),
            "location": SafeIdentificationRequestLocation.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "context": SafeIdentificationRequestContext.from_dict(obj["context"]) if obj.get("context") is not None else None
        })
        return _obj
