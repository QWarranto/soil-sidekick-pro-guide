...
class EnvironmentalImpactDetailedAnalysisEcoAlternatives(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "alternatives": [EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner.from_dict(_item) for _item in obj["alternatives"]] if obj.get("alternatives") is not None else None
        })
        return _obj
