...
class VRTPrescriptionZonesInner(BaseModel):
    """
    VRTPrescriptionZonesInner
    """ # noqa: E501
    zone_id: Optional[StrictInt] = None
    application_rate: Optional[Union[StrictFloat, StrictInt]] = None
    geometry: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["zone_id", "application_rate", "geometry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "application_rate": obj.get("application_rate"),
