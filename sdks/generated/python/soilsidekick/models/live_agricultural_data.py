...
class LiveAgriculturalData(BaseModel):
    """
    ...
    data: Optional[LiveAgriculturalDataData] = None
    sources: Optional[List[StrictStr]] = None
    timestamp: Optional[datetime] = None
    cache_status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["county_fips", "county_name", "state_code", "data", "sources", "timestamp", "cache_status"]
    ...
    def cache_status_validate_enum(cls, value):
        ...
        if value not in set(['updated', 'fallback']):
            raise ValueError("must be one of enum values ('updated', 'fallback')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": LiveAgriculturalDataData.from_dict(obj["data"]) if obj.get("data") is not None else None,
