...
class WaterQuality(BaseModel):
    ...
    dissolved_oxygen: Optional[Union[StrictFloat, StrictInt]] = None
    turbidity: Optional[Union[StrictFloat, StrictInt]] = None
    nitrates: Optional[Union[StrictFloat, StrictInt]] = None
    phosphates: Optional[Union[StrictFloat, StrictInt]] = None
    contamination_risk: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["county_fips", "ph", "dissolved_oxygen", "turbidity", "nitrates", "phosphates", "contamination_risk"]

    @field_validator('contamination_risk')
    def contamination_risk_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ph": obj.get("ph"),
            "dissolved_oxygen": obj.get("dissolved_oxygen"),
            "turbidity": obj.get("turbidity"),
            "nitrates": obj.get("nitrates"),
            "phosphates": obj.get("phosphates"),
