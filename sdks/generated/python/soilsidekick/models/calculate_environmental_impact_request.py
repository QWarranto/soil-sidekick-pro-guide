...
class CalculateEnvironmentalImpactRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.proposed_treatments:
            for _item_proposed_treatments in self.proposed_treatments:
                if _item_proposed_treatments:
                    _items.append(_item_proposed_treatments.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "soil_data": CalculateEnvironmentalImpactRequestSoilData.from_dict(obj["soil_data"]) if obj.get("soil_data") is not None else None,
            "proposed_treatments": [CalculateEnvironmentalImpactRequestProposedTreatmentsInner.from_dict(_item) for _item in obj["proposed_treatments"]] if obj.get("proposed_treatments") is not None else None,
            "water_body_data": CalculateEnvironmentalImpactRequestWaterBodyData.from_dict(obj["water_body_data"]) if obj.get("water_body_data") is not None else None
        })
        return _obj
