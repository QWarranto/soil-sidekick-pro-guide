...
class CalculateEnvironmentalImpactRequestWaterBodyData(BaseModel):
    """
    CalculateEnvironmentalImpactRequestWaterBodyData
    """ # noqa: E501
    distance_miles: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["distance_miles"]
