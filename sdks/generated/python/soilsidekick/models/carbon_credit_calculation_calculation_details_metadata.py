...
class CarbonCreditCalculationCalculationDetailsMetadata(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["calculation_factors", "data_sources", "confidence_score"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calculation_factors": obj.get("calculation_factors"),
