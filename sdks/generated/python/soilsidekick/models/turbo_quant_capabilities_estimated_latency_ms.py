...
class TurboQuantCapabilitiesEstimatedLatencyMs(BaseModel):
    """
    TurboQuantCapabilitiesEstimatedLatencyMs
    """ # noqa: E501
    first_token: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [180]})
    per_token: Optional[StrictInt] = Field(default=None, json_schema_extra={"examples": [12]})
    __properties: ClassVar[List[str]] = ["first_token", "per_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TurboQuantCapabilitiesEstimatedLatencyMs from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TurboQuantCapabilitiesEstimatedLatencyMs from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "first_token": obj.get("first_token"),
            "per_token": obj.get("per_token")
        })
        return _obj
