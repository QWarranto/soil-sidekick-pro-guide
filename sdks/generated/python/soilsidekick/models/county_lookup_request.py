...
class CountyLookupRequest(BaseModel):
    ...
    CountyLookupRequest
    """ # noqa: E501
    term: Annotated[str, Field(min_length=2, strict=True, max_length=100)] = Field(description="Search term (county name, state, or FIPS)", json_schema_extra={"examples": ["Miami-Dade"]})
