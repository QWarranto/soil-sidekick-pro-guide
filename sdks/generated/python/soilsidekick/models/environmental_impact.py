...
class EnvironmentalImpact(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "impact_assessment": EnvironmentalImpactImpactAssessment.from_dict(obj["impact_assessment"]) if obj.get("impact_assessment") is not None else None,
            "detailed_analysis": EnvironmentalImpactDetailedAnalysis.from_dict(obj["detailed_analysis"]) if obj.get("detailed_analysis") is not None else None,
