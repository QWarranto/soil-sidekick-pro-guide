...
class SeasonalPlanningResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recommendations": SeasonalPlanningResponseRecommendations.from_dict(obj["recommendations"]) if obj.get("recommendations") is not None else None,
            "weatherData": SeasonalPlanningResponseWeatherData.from_dict(obj["weatherData"]) if obj.get("weatherData") is not None else None,
