...
class BeginnerGuidance(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detailed_explanation": BeginnerGuidanceDetailedExplanation.from_dict(obj["detailed_explanation"]) if obj.get("detailed_explanation") is not None else None,
            "encouragement": obj.get("encouragement"),
            "related_questions": obj.get("related_questions"),
            "confidence": obj.get("confidence"),
            "metadata": BeginnerGuidanceMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
