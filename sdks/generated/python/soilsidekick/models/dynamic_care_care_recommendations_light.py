...
class DynamicCareCareRecommendationsLight(BaseModel):
    """
    DynamicCareCareRecommendationsLight
    """ # noqa: E501
    current_assessment: Optional[StrictStr] = None
    adjustment_needed: Optional[StrictBool] = None
    recommendation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["current_assessment", "adjustment_needed", "recommendation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "current_assessment": obj.get("current_assessment"),
            "adjustment_needed": obj.get("adjustment_needed"),
