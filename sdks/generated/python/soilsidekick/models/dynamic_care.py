...
class DynamicCare(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "plant": DynamicCarePlant.from_dict(obj["plant"]) if obj.get("plant") is not None else None,
            "current_conditions": DynamicCareCurrentConditions.from_dict(obj["current_conditions"]) if obj.get("current_conditions") is not None else None,
            "care_recommendations": DynamicCareCareRecommendations.from_dict(obj["care_recommendations"]) if obj.get("care_recommendations") is not None else None,
            "warnings": obj.get("warnings"),
            "metadata": DynamicCareMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
