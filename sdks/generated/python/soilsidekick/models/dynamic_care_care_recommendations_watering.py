...
class DynamicCareCareRecommendationsWatering(BaseModel):
    """
    DynamicCareCareRecommendationsWatering
    """ # noqa: E501
    action: Optional[StrictStr] = None
    reasoning: Optional[StrictStr] = None
    next_check_days: Optional[StrictInt] = None
    amount_guidance: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["action", "reasoning", "next_check_days", "amount_guidance"]
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['water_now', 'wait', 'check_soil', 'reduce_frequency']):
            raise ValueError("must be one of enum values ('water_now', 'wait', 'check_soil', 'reduce_frequency')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "next_check_days": obj.get("next_check_days"),
            "amount_guidance": obj.get("amount_guidance")
        })
        return _obj
