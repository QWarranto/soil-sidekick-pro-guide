...
class CountyLookup200Response(BaseModel):
    """
    CountyLookup200Response
    """ # noqa: E501
    counties: Optional[List[County]] = None
    __properties: ClassVar[List[str]] = ["counties"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in counties (list)
        _items = []
        if self.counties:
            for _item_counties in self.counties:
                if _item_counties:
                    _items.append(_item_counties.to_dict())
            _dict['counties'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counties": [County.from_dict(_item) for _item in obj["counties"]] if obj.get("counties") is not None else None
        })
        return _obj
