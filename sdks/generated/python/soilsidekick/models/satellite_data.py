...
class SatelliteData(BaseModel):
    ...
    SatelliteData
    """ # noqa: E501
    ndvi: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Normalized Difference Vegetation Index")
    evi: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Enhanced Vegetation Index")
    soil_moisture: Optional[Union[StrictFloat, StrictInt]] = None
    temperature: Optional[Union[StrictFloat, StrictInt]] = None
    cloud_cover: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["ndvi", "evi", "soil_moisture", "temperature", "cloud_cover"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ndvi": obj.get("ndvi"),
            "evi": obj.get("evi"),
            "soil_moisture": obj.get("soil_moisture"),
