...
from soilsidekick.api_response import ApiResponse, T as ApiResponseT
import soilsidekick.models
from soilsidekick import rest
from soilsidekick.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(soilsidekick.models, klass)
