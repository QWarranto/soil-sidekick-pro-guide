...
class TestDynamicCareRequestContainerDetails(unittest.TestCase):
    """DynamicCareRequestContainerDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareRequestContainerDetails:
        """Test DynamicCareRequestContainerDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareRequestContainerDetails`
        """
        model = DynamicCareRequestContainerDetails()
        if include_optional:
            return DynamicCareRequestContainerDetails(
                type = 'terracotta',
                size_inches = 1.337,
                has_drainage = True
            )
    ...
    def testDynamicCareRequestContainerDetails(self):
        """Test DynamicCareRequestContainerDetails"""
