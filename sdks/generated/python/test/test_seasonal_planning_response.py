...
class TestSeasonalPlanningResponse(unittest.TestCase):
    """SeasonalPlanningResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonalPlanningResponse:
        """Test SeasonalPlanningResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonalPlanningResponse`
        """
        model = SeasonalPlanningResponse()
        if include_optional:
            return SeasonalPlanningResponse(
                success = True,
                recommendations = soilsidekick.models.seasonal_planning_response_recommendations.SeasonalPlanningResponse_recommendations(
                    seasonal_tasks = [
                        None
                        ], 
                    ...
                    timing_guidance = soilsidekick.models.timing_guidance.timing_guidance(), ),
                weather_data = soilsidekick.models.seasonal_planning_response_weather_data.SeasonalPlanningResponse_weatherData(
                    current_season = '', 
                    temperature = '', 
                    rainfall = '', 
                    frost_dates = soilsidekick.models.frost_dates.frostDates(), 
                    growing_season = '', 
                    zone = '', ),
                model_used = ''
            )
    ...
    def testSeasonalPlanningResponse(self):
        """Test SeasonalPlanningResponse"""
