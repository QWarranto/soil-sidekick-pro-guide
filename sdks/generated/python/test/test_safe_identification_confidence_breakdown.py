...
class TestSafeIdentificationConfidenceBreakdown(unittest.TestCase):
    """SafeIdentificationConfidenceBreakdown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationConfidenceBreakdown:
        """Test SafeIdentificationConfidenceBreakdown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationConfidenceBreakdown`
        """
        model = SafeIdentificationConfidenceBreakdown()
        if include_optional:
            return SafeIdentificationConfidenceBreakdown(
                visual_match = 1.337,
    ...
    def testSafeIdentificationConfidenceBreakdown(self):
        """Test SafeIdentificationConfidenceBreakdown"""
