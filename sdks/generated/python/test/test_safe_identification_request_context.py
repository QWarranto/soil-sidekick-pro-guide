...
class TestSafeIdentificationRequestContext(unittest.TestCase):
    """SafeIdentificationRequestContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationRequestContext:
        """Test SafeIdentificationRequestContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationRequestContext`
        """
        model = SafeIdentificationRequestContext()
        if include_optional:
            return SafeIdentificationRequestContext(
                environment = 'wild',
                purpose = 'foraging',
    ...
    def testSafeIdentificationRequestContext(self):
        """Test SafeIdentificationRequestContext"""
