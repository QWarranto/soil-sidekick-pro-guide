...
class TestCalculateCarbonCreditsRequest(unittest.TestCase):
    """CalculateCarbonCreditsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateCarbonCreditsRequest:
        """Test CalculateCarbonCreditsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateCarbonCreditsRequest`
        """
        model = CalculateCarbonCreditsRequest()
        if include_optional:
            return CalculateCarbonCreditsRequest(
                field_name = '',
                field_size_acres = 0.1,
                soil_organic_matter = 1.337,
                soil_analysis_id = '',
    ...
    def testCalculateCarbonCreditsRequest(self):
        """Test CalculateCarbonCreditsRequest"""
