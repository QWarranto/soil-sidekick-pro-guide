...
class TestWaterQuality(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WaterQuality:
        """Test WaterQuality
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaterQuality`
        """
        model = WaterQuality()
        if include_optional:
            return WaterQuality(
