...
class TestVisualCropAnalysisRequestLocation(unittest.TestCase):
    """VisualCropAnalysisRequestLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualCropAnalysisRequestLocation:
        """Test VisualCropAnalysisRequestLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualCropAnalysisRequestLocation`
        """
        model = VisualCropAnalysisRequestLocation()
        if include_optional:
            return VisualCropAnalysisRequestLocation(
                county_fips = '',
                county_name = '',
                state_code = ''
            )
    ...
    def testVisualCropAnalysisRequestLocation(self):
        """Test VisualCropAnalysisRequestLocation"""
