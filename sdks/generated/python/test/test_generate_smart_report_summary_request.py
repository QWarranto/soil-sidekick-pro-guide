...
class TestGenerateSmartReportSummaryRequest(unittest.TestCase):
    """GenerateSmartReportSummaryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateSmartReportSummaryRequest:
        """Test GenerateSmartReportSummaryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateSmartReportSummaryRequest`
        """
        model = GenerateSmartReportSummaryRequest()
        if include_optional:
            return GenerateSmartReportSummaryRequest(
                report_type = 'soil',
                report_data = None
            )
        else:
    ...
    def testGenerateSmartReportSummaryRequest(self):
        """Test GenerateSmartReportSummaryRequest"""
