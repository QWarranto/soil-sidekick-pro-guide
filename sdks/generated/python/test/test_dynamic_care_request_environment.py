...
class TestDynamicCareRequestEnvironment(unittest.TestCase):
    """DynamicCareRequestEnvironment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareRequestEnvironment:
        """Test DynamicCareRequestEnvironment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareRequestEnvironment`
        """
        model = DynamicCareRequestEnvironment()
        if include_optional:
            return DynamicCareRequestEnvironment(
    ...
    def testDynamicCareRequestEnvironment(self):
        """Test DynamicCareRequestEnvironment"""
