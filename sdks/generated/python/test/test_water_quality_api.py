...
class TestWaterQualityApi(unittest.TestCase):
    """WaterQualityApi unit test stubs"""

    def setUp(self) -> None:
        self.api = WaterQualityApi()

    def tearDown(self) -> None:
        pass

    def test_get_territorial_water_analytics(self) -> None:
        """Test case for get_territorial_water_analytics

        Get territorial water analytics
        """
        pass

    def test_get_water_quality(self) -> None:
        """Test case for get_water_quality
