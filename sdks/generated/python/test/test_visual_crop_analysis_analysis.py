...
class TestVisualCropAnalysisAnalysis(unittest.TestCase):
    """VisualCropAnalysisAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualCropAnalysisAnalysis:
        """Test VisualCropAnalysisAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualCropAnalysisAnalysis`
        """
        model = VisualCropAnalysisAnalysis()
        if include_optional:
            return VisualCropAnalysisAnalysis(
                analysis_type = '',
                confidence = 1.337,
                findings = soilsidekick.models.findings.findings(),
                recommendations = [
                    ''
                    ],
                severity = 'low'
    ...
    def testVisualCropAnalysisAnalysis(self):
        """Test VisualCropAnalysisAnalysis"""
