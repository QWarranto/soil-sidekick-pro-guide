...
class TestCalculateEnvironmentalImpactRequestWaterBodyData(unittest.TestCase):
    """CalculateEnvironmentalImpactRequestWaterBodyData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEnvironmentalImpactRequestWaterBodyData:
        """Test CalculateEnvironmentalImpactRequestWaterBodyData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEnvironmentalImpactRequestWaterBodyData`
        """
        model = CalculateEnvironmentalImpactRequestWaterBodyData()
        if include_optional:
            return CalculateEnvironmentalImpactRequestWaterBodyData(
    ...
    def testCalculateEnvironmentalImpactRequestWaterBodyData(self):
        """Test CalculateEnvironmentalImpactRequestWaterBodyData"""
