...
class TestLeafEnginesCompatibilityDataMetadata(unittest.TestCase):
    """LeafEnginesCompatibilityDataMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafEnginesCompatibilityDataMetadata:
        """Test LeafEnginesCompatibilityDataMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafEnginesCompatibilityDataMetadata`
        """
        model = LeafEnginesCompatibilityDataMetadata()
        if include_optional:
            return LeafEnginesCompatibilityDataMetadata(
                location = '',
    ...
    def testLeafEnginesCompatibilityDataMetadata(self):
        """Test LeafEnginesCompatibilityDataMetadata"""
