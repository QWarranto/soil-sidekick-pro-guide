...
class TestTurboQuantCapabilitiesEstimatedLatencyMs(unittest.TestCase):
    """TurboQuantCapabilitiesEstimatedLatencyMs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TurboQuantCapabilitiesEstimatedLatencyMs:
        """Test TurboQuantCapabilitiesEstimatedLatencyMs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TurboQuantCapabilitiesEstimatedLatencyMs`
        """
        model = TurboQuantCapabilitiesEstimatedLatencyMs()
        if include_optional:
            return TurboQuantCapabilitiesEstimatedLatencyMs(
                first_token = 180,
                per_token = 12
            )
        else:
    ...
    def testTurboQuantCapabilitiesEstimatedLatencyMs(self):
        """Test TurboQuantCapabilitiesEstimatedLatencyMs"""
