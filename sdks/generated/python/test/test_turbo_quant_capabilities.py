...
class TestTurboQuantCapabilities(unittest.TestCase):
    """TurboQuantCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TurboQuantCapabilities:
        """Test TurboQuantCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TurboQuantCapabilities`
        """
        model = TurboQuantCapabilities()
        if include_optional:
            return TurboQuantCapabilities(
                ...
                estimated_latency_ms = soilsidekick.models.turbo_quant_capabilities_estimated_latency_ms.TurboQuantCapabilities_estimated_latency_ms(
                    first_token = 180, 
                    per_token = 12, ),
                runtime_tier = 'webgpu'
            )
    ...
    def testTurboQuantCapabilities(self):
        """Test TurboQuantCapabilities"""
