...
class TestGetSeasonalPlanningAssistantRequest(unittest.TestCase):
    """GetSeasonalPlanningAssistantRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSeasonalPlanningAssistantRequest:
        """Test GetSeasonalPlanningAssistantRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSeasonalPlanningAssistantRequest`
        """
        model = GetSeasonalPlanningAssistantRequest()
        if include_optional:
            return GetSeasonalPlanningAssistantRequest(
                location = soilsidekick.models.get_seasonal_planning_assistant_request_location.getSeasonalPlanningAssistant_request_location(
                    county_fips = '', 
                    state_code = '', 
                    county_name = '', ),
                soil_data = None,
                planning_type = 'spring_planting',
                crop_preferences = [
                    ''
                    ],
                timeframe = ''
    ...
    def testGetSeasonalPlanningAssistantRequest(self):
        """Test GetSeasonalPlanningAssistantRequest"""
