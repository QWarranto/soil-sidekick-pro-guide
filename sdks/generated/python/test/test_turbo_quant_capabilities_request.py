...
class TestTurboQuantCapabilitiesRequest(unittest.TestCase):
    """TurboQuantCapabilitiesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TurboQuantCapabilitiesRequest:
        """Test TurboQuantCapabilitiesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TurboQuantCapabilitiesRequest`
        """
        model = TurboQuantCapabilitiesRequest()
        if include_optional:
            return TurboQuantCapabilitiesRequest(
                device_memory_gb = 4,
                has_webgpu = True,
                platform = 'mobile'
            )
    ...
    def testTurboQuantCapabilitiesRequest(self):
        """Test TurboQuantCapabilitiesRequest"""
