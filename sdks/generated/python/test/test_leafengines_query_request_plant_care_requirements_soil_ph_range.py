...
class TestLeafenginesQueryRequestPlantCareRequirementsSoilPhRange(unittest.TestCase):
    """LeafenginesQueryRequestPlantCareRequirementsSoilPhRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafenginesQueryRequestPlantCareRequirementsSoilPhRange:
        """Test LeafenginesQueryRequestPlantCareRequirementsSoilPhRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafenginesQueryRequestPlantCareRequirementsSoilPhRange`
        """
        model = LeafenginesQueryRequestPlantCareRequirementsSoilPhRange()
        if include_optional:
            return LeafenginesQueryRequestPlantCareRequirementsSoilPhRange(
                min = 1.337,
                max = 1.337
            )
        else:
    ...
    def testLeafenginesQueryRequestPlantCareRequirementsSoilPhRange(self):
        """Test LeafenginesQueryRequestPlantCareRequirementsSoilPhRange"""
