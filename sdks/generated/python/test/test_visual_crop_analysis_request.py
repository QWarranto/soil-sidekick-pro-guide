...
class TestVisualCropAnalysisRequest(unittest.TestCase):
    """VisualCropAnalysisRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualCropAnalysisRequest:
        """Test VisualCropAnalysisRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualCropAnalysisRequest`
        """
        model = VisualCropAnalysisRequest()
        if include_optional:
            return VisualCropAnalysisRequest(
                image = '',
                analysis_type = 'pest_detection',
                location = soilsidekick.models.visual_crop_analysis_request_location.visualCropAnalysis_request_location(
                    county_fips = '', 
                    county_name = '', 
                    state_code = '', ),
                crop_type = ''
    ...
    def testVisualCropAnalysisRequest(self):
        """Test VisualCropAnalysisRequest"""
