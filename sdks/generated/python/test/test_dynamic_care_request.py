...
class TestDynamicCareRequest(unittest.TestCase):
    """DynamicCareRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareRequest:
        """Test DynamicCareRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareRequest`
        """
        model = DynamicCareRequest()
        if include_optional:
            return DynamicCareRequest(
                plant_species = 'Monstera deliciosa',
                location = soilsidekick.models.dynamic_care_request_location.dynamicCare_request_location(
                    county_fips = '04807', 
                    state_code = '', 
                    indoor = True, ),
                environment = soilsidekick.models.dynamic_care_request_environment.dynamicCare_request_environment(
                    light_exposure = 'full_sun', 
                    humidity_level = 'low', ),
                container_details = soilsidekick.models.dynamic_care_request_container_details.dynamicCare_request_container_details(
                    type = 'terracotta', 
                    size_inches = 1.337, 
                    has_drainage = True, ),
                soil_type = 'potting_mix',
                last_watered = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date()
            )
        else:
            return DynamicCareRequest(
                plant_species = 'Monstera deliciosa',
    ...
    def testDynamicCareRequest(self):
        """Test DynamicCareRequest"""
