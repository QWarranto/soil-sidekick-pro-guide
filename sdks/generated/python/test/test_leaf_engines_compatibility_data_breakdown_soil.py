...
class TestLeafEnginesCompatibilityDataBreakdownSoil(unittest.TestCase):
    """LeafEnginesCompatibilityDataBreakdownSoil unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafEnginesCompatibilityDataBreakdownSoil:
        """Test LeafEnginesCompatibilityDataBreakdownSoil
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafEnginesCompatibilityDataBreakdownSoil`
        """
        model = LeafEnginesCompatibilityDataBreakdownSoil()
        if include_optional:
            return LeafEnginesCompatibilityDataBreakdownSoil(
                score = 1.337,
                factors = [
                    ''
                    ],
    ...
    def testLeafEnginesCompatibilityDataBreakdownSoil(self):
        """Test LeafEnginesCompatibilityDataBreakdownSoil"""
