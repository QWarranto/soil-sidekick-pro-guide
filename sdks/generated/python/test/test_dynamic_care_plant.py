...
class TestDynamicCarePlant(unittest.TestCase):
    """DynamicCarePlant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCarePlant:
        """Test DynamicCarePlant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCarePlant`
        """
        model = DynamicCarePlant()
        if include_optional:
            return DynamicCarePlant(
                common_name = '',
                scientific_name = '',
