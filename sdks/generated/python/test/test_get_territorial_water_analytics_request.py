...
class TestGetTerritorialWaterAnalyticsRequest(unittest.TestCase):
    """GetTerritorialWaterAnalyticsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTerritorialWaterAnalyticsRequest:
        """Test GetTerritorialWaterAnalyticsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTerritorialWaterAnalyticsRequest`
        """
        model = GetTerritorialWaterAnalyticsRequest()
        if include_optional:
            return GetTerritorialWaterAnalyticsRequest(
                territory_type = 'state',
                epa_region = '',
                date_range = soilsidekick.models.get_territorial_water_analytics_request_date_range.getTerritorialWaterAnalytics_request_date_range(
    ...
    def testGetTerritorialWaterAnalyticsRequest(self):
        """Test GetTerritorialWaterAnalyticsRequest"""
