...
class TestSafeIdentificationRequestLocation(unittest.TestCase):
    """SafeIdentificationRequestLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationRequestLocation:
        """Test SafeIdentificationRequestLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationRequestLocation`
        """
        model = SafeIdentificationRequestLocation()
        if include_optional:
            return SafeIdentificationRequestLocation(
                county_fips = '04807',
                state_code = '',
    ...
    def testSafeIdentificationRequestLocation(self):
        """Test SafeIdentificationRequestLocation"""
