...
class TestLeafenginesQueryRequestOptions(unittest.TestCase):
    """LeafenginesQueryRequestOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafenginesQueryRequestOptions:
        """Test LeafenginesQueryRequestOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafenginesQueryRequestOptions`
        """
        model = LeafenginesQueryRequestOptions()
        if include_optional:
            return LeafenginesQueryRequestOptions(
    ...
    def testLeafenginesQueryRequestOptions(self):
        """Test LeafenginesQueryRequestOptions"""
