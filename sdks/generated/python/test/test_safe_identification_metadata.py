...
class TestSafeIdentificationMetadata(unittest.TestCase):
    """SafeIdentificationMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationMetadata:
        """Test SafeIdentificationMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationMetadata`
        """
        model = SafeIdentificationMetadata()
        if include_optional:
            return SafeIdentificationMetadata(
                analysis_id = '',
    ...
    def testSafeIdentificationMetadata(self):
        """Test SafeIdentificationMetadata"""
