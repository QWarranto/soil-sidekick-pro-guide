...
class TestSafeIdentificationIdentificationPrimaryMatch(unittest.TestCase):
    """SafeIdentificationIdentificationPrimaryMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationIdentificationPrimaryMatch:
        """Test SafeIdentificationIdentificationPrimaryMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationIdentificationPrimaryMatch`
        """
        model = SafeIdentificationIdentificationPrimaryMatch()
        if include_optional:
            return SafeIdentificationIdentificationPrimaryMatch(
                common_name = '',
                scientific_name = '',
                confidence = 1.337,
                family = ''
    ...
    def testSafeIdentificationIdentificationPrimaryMatch(self):
        """Test SafeIdentificationIdentificationPrimaryMatch"""
