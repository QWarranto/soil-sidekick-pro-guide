...
class TestBeginnerGuidanceDetailedExplanation(unittest.TestCase):
    """BeginnerGuidanceDetailedExplanation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidanceDetailedExplanation:
        """Test BeginnerGuidanceDetailedExplanation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidanceDetailedExplanation`
        """
        model = BeginnerGuidanceDetailedExplanation()
        if include_optional:
            return BeginnerGuidanceDetailedExplanation(
                technical_term = '',
                plain_english = '',
                common_causes = [
                    ''
    ...
    def testBeginnerGuidanceDetailedExplanation(self):
        """Test BeginnerGuidanceDetailedExplanation"""
