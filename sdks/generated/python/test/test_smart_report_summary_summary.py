...
class TestSmartReportSummarySummary(unittest.TestCase):
    """SmartReportSummarySummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartReportSummarySummary:
        """Test SmartReportSummarySummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartReportSummarySummary`
        """
        model = SmartReportSummarySummary()
        if include_optional:
            return SmartReportSummarySummary(
                executive_summary = '',
                key_findings = [
                    ''
                    ],
    ...
    def testSmartReportSummarySummary(self):
        """Test SmartReportSummarySummary"""
