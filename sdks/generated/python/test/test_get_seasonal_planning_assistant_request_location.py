...
class TestGetSeasonalPlanningAssistantRequestLocation(unittest.TestCase):
    """GetSeasonalPlanningAssistantRequestLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSeasonalPlanningAssistantRequestLocation:
        """Test GetSeasonalPlanningAssistantRequestLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSeasonalPlanningAssistantRequestLocation`
        """
        model = GetSeasonalPlanningAssistantRequestLocation()
        if include_optional:
            return GetSeasonalPlanningAssistantRequestLocation(
                county_fips = '',
                state_code = '',
                county_name = ''
            )
    ...
    def testGetSeasonalPlanningAssistantRequestLocation(self):
        """Test GetSeasonalPlanningAssistantRequestLocation"""
