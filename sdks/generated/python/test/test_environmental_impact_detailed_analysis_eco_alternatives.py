...
class TestEnvironmentalImpactDetailedAnalysisEcoAlternatives(unittest.TestCase):
    """EnvironmentalImpactDetailedAnalysisEcoAlternatives unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentalImpactDetailedAnalysisEcoAlternatives:
        """Test EnvironmentalImpactDetailedAnalysisEcoAlternatives
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentalImpactDetailedAnalysisEcoAlternatives`
        """
        model = EnvironmentalImpactDetailedAnalysisEcoAlternatives()
        if include_optional:
            return EnvironmentalImpactDetailedAnalysisEcoAlternatives(
                alternatives = [
    ...
    def testEnvironmentalImpactDetailedAnalysisEcoAlternatives(self):
        """Test EnvironmentalImpactDetailedAnalysisEcoAlternatives"""
