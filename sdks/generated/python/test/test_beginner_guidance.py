...
class TestBeginnerGuidance(unittest.TestCase):
    """BeginnerGuidance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidance:
        """Test BeginnerGuidance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidance`
        """
        model = BeginnerGuidance()
        if include_optional:
            return BeginnerGuidance(
                ...
                what_to_do_now = '',
                why_this_happens = '',
                detailed_explanation = soilsidekick.models.beginner_guidance_detailed_explanation.BeginnerGuidance_detailed_explanation(
                    technical_term = '', 
                    plain_english = '', 
                    common_causes = [
                        ''
                ...
                confidence = 1.337,
                metadata = soilsidekick.models.beginner_guidance_metadata.BeginnerGuidance_metadata(
