...
class TestEnvironmentalImpactImpactAssessment(unittest.TestCase):
    """EnvironmentalImpactImpactAssessment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentalImpactImpactAssessment:
        """Test EnvironmentalImpactImpactAssessment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentalImpactImpactAssessment`
        """
        model = EnvironmentalImpactImpactAssessment()
        if include_optional:
            return EnvironmentalImpactImpactAssessment(
    ...
    def testEnvironmentalImpactImpactAssessment(self):
        """Test EnvironmentalImpactImpactAssessment"""
