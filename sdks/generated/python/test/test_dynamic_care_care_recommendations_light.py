...
class TestDynamicCareCareRecommendationsLight(unittest.TestCase):
    """DynamicCareCareRecommendationsLight unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareCareRecommendationsLight:
        """Test DynamicCareCareRecommendationsLight
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareCareRecommendationsLight`
        """
        model = DynamicCareCareRecommendationsLight()
        if include_optional:
            return DynamicCareCareRecommendationsLight(
                current_assessment = '',
    ...
    def testDynamicCareCareRecommendationsLight(self):
        """Test DynamicCareCareRecommendationsLight"""
