...
class TestDynamicCareRequestLocation(unittest.TestCase):
    """DynamicCareRequestLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareRequestLocation:
        """Test DynamicCareRequestLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareRequestLocation`
        """
        model = DynamicCareRequestLocation()
        if include_optional:
            return DynamicCareRequestLocation(
                county_fips = '04807',
                state_code = '',
                indoor = True
            )
    ...
    def testDynamicCareRequestLocation(self):
        """Test DynamicCareRequestLocation"""
