...
class TestGetSoilDataRequest(unittest.TestCase):
    """GetSoilDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSoilDataRequest:
        """Test GetSoilDataRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSoilDataRequest`
        """
        model = GetSoilDataRequest()
        if include_optional:
            return GetSoilDataRequest(
                county_fips = '12345'
            )
        else:
            return GetSoilDataRequest(
    ...
    def testGetSoilDataRequest(self):
        """Test GetSoilDataRequest"""
