...
class TestBeginnerGuidanceRequestLocation(unittest.TestCase):
    """BeginnerGuidanceRequestLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidanceRequestLocation:
        """Test BeginnerGuidanceRequestLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidanceRequestLocation`
        """
        model = BeginnerGuidanceRequestLocation()
        if include_optional:
            return BeginnerGuidanceRequestLocation(
                county_fips = '',
                indoor = True
            )
        else:
    ...
    def testBeginnerGuidanceRequestLocation(self):
        """Test BeginnerGuidanceRequestLocation"""
