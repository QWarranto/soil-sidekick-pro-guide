...
class TestCalculateEnvironmentalImpactRequestSoilData(unittest.TestCase):
    """CalculateEnvironmentalImpactRequestSoilData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEnvironmentalImpactRequestSoilData:
        """Test CalculateEnvironmentalImpactRequestSoilData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEnvironmentalImpactRequestSoilData`
        """
        model = CalculateEnvironmentalImpactRequestSoilData()
        if include_optional:
            return CalculateEnvironmentalImpactRequestSoilData(
                ph_level = 1.337,
    ...
    def testCalculateEnvironmentalImpactRequestSoilData(self):
        """Test CalculateEnvironmentalImpactRequestSoilData"""
