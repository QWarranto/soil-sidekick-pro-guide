...
class TestDynamicCareCareRecommendations(unittest.TestCase):
    """DynamicCareCareRecommendations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareCareRecommendations:
        """Test DynamicCareCareRecommendations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareCareRecommendations`
        """
        model = DynamicCareCareRecommendations()
        if include_optional:
            return DynamicCareCareRecommendations(
    ...
    def testDynamicCareCareRecommendations(self):
        """Test DynamicCareCareRecommendations"""
