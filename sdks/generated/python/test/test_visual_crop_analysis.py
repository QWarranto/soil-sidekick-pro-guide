...
class TestVisualCropAnalysis(unittest.TestCase):
    """VisualCropAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VisualCropAnalysis:
        """Test VisualCropAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VisualCropAnalysis`
        """
        model = VisualCropAnalysis()
        if include_optional:
            return VisualCropAnalysis(
                success = True,
                analysis = soilsidekick.models.visual_crop_analysis_analysis.VisualCropAnalysis_analysis(
                    analysis_type = '', 
                    confidence = 1.337, 
    ...
    def testVisualCropAnalysis(self):
        """Test VisualCropAnalysis"""
