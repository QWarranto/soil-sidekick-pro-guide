...
class TestSafeIdentificationSafetyAnalysis(unittest.TestCase):
    """SafeIdentificationSafetyAnalysis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationSafetyAnalysis:
        """Test SafeIdentificationSafetyAnalysis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationSafetyAnalysis`
        """
        model = SafeIdentificationSafetyAnalysis()
        if include_optional:
            return SafeIdentificationSafetyAnalysis(
                toxicity_level = 'safe',
                toxic_to = [
                    ''
                    ],
    ...
    def testSafeIdentificationSafetyAnalysis(self):
        """Test SafeIdentificationSafetyAnalysis"""
