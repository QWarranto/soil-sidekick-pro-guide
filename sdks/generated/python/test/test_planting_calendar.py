...
class TestPlantingCalendar(unittest.TestCase):
    """PlantingCalendar unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlantingCalendar:
        """Test PlantingCalendar
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlantingCalendar`
        """
        model = PlantingCalendar()
        if include_optional:
            return PlantingCalendar(
                crop_type = '',
                optimal_planting_window = soilsidekick.models.get_territorial_water_analytics_request_date_range.getTerritorialWaterAnalytics_request_date_range(
