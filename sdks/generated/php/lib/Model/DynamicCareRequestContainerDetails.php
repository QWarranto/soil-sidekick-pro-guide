...
/**
 * DynamicCareRequestContainerDetails Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class DynamicCareRequestContainerDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'dynamicCare_request_container_details';
    ...
    public const TYPE_TERRACOTTA = 'terracotta';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('size_inches', $data ?? [], null);
    ...
    {
        return $this->container['size_inches'];
    }

    /**
     * Sets size_inches
     *
     * @param float|null $size_inches size_inches
     *
     * @return self
     */
    public function setSizeInches($size_inches)
    {
        if (is_null($size_inches)) {
            throw new \InvalidArgumentException('non-nullable size_inches cannot be null');
        }
        $this->container['size_inches'] = $size_inches;
