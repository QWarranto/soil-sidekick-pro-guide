...
/**
 * LeafEnginesCompatibilityDataBreakdownSoil Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class LeafEnginesCompatibilityDataBreakdownSoil implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LeafEnginesCompatibility_data_breakdown_soil';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('concerns', $data ?? [], null);
    }
     ...
     * Sets factors
     *
     * @param string[]|null $factors factors
     *
     * @return self
     */
    ...
    {
        return $this->container['concerns'];
    }

    /**
     * Sets concerns
     *
     * @param string[]|null $concerns concerns
     *
     * @return self
     */
    ...
    {
        if (is_null($concerns)) {
            throw new \InvalidArgumentException('non-nullable concerns cannot be null');
        }
        $this->container['concerns'] = $concerns;
