...
/**
 * SafeIdentificationRequestLocation Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class SafeIdentificationRequestLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'safeIdentification_request_location';
    ...
    protected static $openAPITypes = [
        'county_fips' => 'string',
        'state_code' => 'string',
        'coordinates' => '\SoilSidekick\Model\SafeIdentificationRequestLocationCoordinates'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['county_fips']) && !preg_match("/^[0-9]{5}$/", $this->container['county_fips'])) {
    ...
    public function setCountyFips($county_fips)
    {
        ...
        if ((!preg_match("/^[0-9]{5}$/", ObjectSerializer::toString($county_fips)))) {
            throw new \InvalidArgumentException("invalid value for \$county_fips when calling SafeIdentificationRequestLocation., must conform to the pattern /^[0-9]{5}$/.");
        }
    ...
    public function setStateCode($state_code)
    {
        ...
        if ((mb_strlen($state_code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state_code when calling SafeIdentificationRequestLocation., must be smaller than or equal to 2.');
        }
     ...
     * Gets coordinates
     *
     * @return \SoilSidekick\Model\SafeIdentificationRequestLocationCoordinates|null
     */
     ...
     * Sets coordinates
     *
     * @param \SoilSidekick\Model\SafeIdentificationRequestLocationCoordinates|null $coordinates coordinates
     *
     * @return self
     */
