...
/**
 * GetPlantingCalendarRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GetPlantingCalendarRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getPlantingCalendar_request';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['crop_type'] === null) {
            $invalidProperties[] = "'crop_type' can't be null";
        }
    ...
    public function setCountyFips($county_fips)
    {
        ...
        if ((!preg_match("/^[0-9]{5}$/", ObjectSerializer::toString($county_fips)))) {
            throw new \InvalidArgumentException("invalid value for \$county_fips when calling GetPlantingCalendarRequest., must conform to the pattern /^[0-9]{5}$/.");
        }
