...
/**
 * SafeIdentificationRequestContext Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class SafeIdentificationRequestContext implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'safeIdentification_request_context';
    ...
    public const ENVIRONMENT_WILD = 'wild';
    public const ENVIRONMENT_GARDEN = 'garden';
    public const ENVIRONMENT_INDOOR = 'indoor';
    public const ENVIRONMENT_AGRICULTURAL = 'agricultural';
    public const PURPOSE_FORAGING = 'foraging';
    public const PURPOSE_GARDENING = 'gardening';
    public const PURPOSE_CURIOSITY = 'curiosity';
    public const PURPOSE_PET_SAFETY = 'pet_safety';
    public const GROWTH_STAGE_SEEDLING = 'seedling';
    public const GROWTH_STAGE_JUVENILE = 'juvenile';
    public const GROWTH_STAGE_MATURE = 'mature';
    public const GROWTH_STAGE_FLOWERING = 'flowering';
    public const GROWTH_STAGE_FRUITING = 'fruiting';
    ...
    {
        return [
            self::ENVIRONMENT_WILD,
            self::ENVIRONMENT_GARDEN,
            self::ENVIRONMENT_INDOOR,
            self::ENVIRONMENT_AGRICULTURAL,
        ];
    }
    ...
    {
        return [
            self::PURPOSE_FORAGING,
            self::PURPOSE_GARDENING,
            self::PURPOSE_CURIOSITY,
            self::PURPOSE_PET_SAFETY,
        ];
    }
     ...
     * @return string[]
     */
    public function getGrowthStageAllowableValues()
    {
        return [
            self::GROWTH_STAGE_SEEDLING,
            self::GROWTH_STAGE_JUVENILE,
            self::GROWTH_STAGE_MATURE,
            self::GROWTH_STAGE_FLOWERING,
            self::GROWTH_STAGE_FRUITING,
        ];
    }
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('growth_stage', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getGrowthStageAllowableValues();
        if (!is_null($this->container['growth_stage']) && !in_array($this->container['growth_stage'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'growth_stage', must be one of '%s'",
                $this->container['growth_stage'],
                implode("', '", $allowedValues)
            );
        }
    ...
    {
        return $this->container['growth_stage'];
    }

    /**
     * Sets growth_stage
     *
     * @param string|null $growth_stage growth_stage
     *
     * @return self
     */
    public function setGrowthStage($growth_stage)
    {
        if (is_null($growth_stage)) {
            throw new \InvalidArgumentException('non-nullable growth_stage cannot be null');
        }
        $allowedValues = $this->getGrowthStageAllowableValues();
        if (!in_array($growth_stage, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'growth_stage', must be one of '%s'",
                    $growth_stage,
        ...
        $this->container['growth_stage'] = $growth_stage;
