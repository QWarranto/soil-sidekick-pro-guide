...
/**
 * TurboQuantCapabilitiesEstimatedLatencyMs Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class TurboQuantCapabilitiesEstimatedLatencyMs implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TurboQuantCapabilities_estimated_latency_ms';
    ...
    protected static $setters = [
        'first_token' => 'setFirstToken',
        'per_token' => 'setPerToken'
    ];
    ...
    protected static $getters = [
        'first_token' => 'getFirstToken',
        'per_token' => 'getPerToken'
    ];
    ...
    {
        $this->setIfExists('first_token', $data ?? [], null);
        $this->setIfExists('per_token', $data ?? [], null);
    }
    ...
    {
        return $this->container['first_token'];
    }

    /**
     * Sets first_token
     *
     * @param int|null $first_token first_token
     *
     * @return self
     */
    public function setFirstToken($first_token)
    {
        if (is_null($first_token)) {
            throw new \InvalidArgumentException('non-nullable first_token cannot be null');
        }
        $this->container['first_token'] = $first_token;
     ...
     * @return int|null
     */
    public function getPerToken()
    {
        return $this->container['per_token'];
    }

    /**
     * Sets per_token
     *
     * @param int|null $per_token per_token
     *
     * @return self
     */
    public function setPerToken($per_token)
    {
        if (is_null($per_token)) {
            throw new \InvalidArgumentException('non-nullable per_token cannot be null');
        }
        $this->container['per_token'] = $per_token;
