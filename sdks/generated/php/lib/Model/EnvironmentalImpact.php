...
/**
 * EnvironmentalImpact Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class EnvironmentalImpact implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EnvironmentalImpact';
    ...
    protected static $openAPITypes = [
        'impact_assessment' => '\SoilSidekick\Model\EnvironmentalImpactImpactAssessment',
        'detailed_analysis' => '\SoilSidekick\Model\EnvironmentalImpactDetailedAnalysis',
    ...
    protected static $setters = [
        'impact_assessment' => 'setImpactAssessment',
        'detailed_analysis' => 'setDetailedAnalysis',
    ...
    protected static $getters = [
        'impact_assessment' => 'getImpactAssessment',
        'detailed_analysis' => 'getDetailedAnalysis',
    ...
    {
        $this->setIfExists('impact_assessment', $data ?? [], null);
        $this->setIfExists('detailed_analysis', $data ?? [], null);
    ...
    /**
     * Gets impact_assessment
     *
     * @return \SoilSidekick\Model\EnvironmentalImpactImpactAssessment|null
     */
    public function getImpactAssessment()
    {
        return $this->container['impact_assessment'];
    }

    /**
     * Sets impact_assessment
     *
     * @param \SoilSidekick\Model\EnvironmentalImpactImpactAssessment|null $impact_assessment impact_assessment
     *
     * @return self
     */
    public function setImpactAssessment($impact_assessment)
    {
        if (is_null($impact_assessment)) {
            throw new \InvalidArgumentException('non-nullable impact_assessment cannot be null');
        }
        $this->container['impact_assessment'] = $impact_assessment;

        return $this;
    }

    /**
     * Gets detailed_analysis
     *
     * @return \SoilSidekick\Model\EnvironmentalImpactDetailedAnalysis|null
     */
    public function getDetailedAnalysis()
    {
        return $this->container['detailed_analysis'];
    }

    /**
     * Sets detailed_analysis
     *
     * @param \SoilSidekick\Model\EnvironmentalImpactDetailedAnalysis|null $detailed_analysis detailed_analysis
     *
     * @return self
     */
    public function setDetailedAnalysis($detailed_analysis)
    {
        if (is_null($detailed_analysis)) {
            throw new \InvalidArgumentException('non-nullable detailed_analysis cannot be null');
        }
        $this->container['detailed_analysis'] = $detailed_analysis;
