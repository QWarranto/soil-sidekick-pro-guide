...
/**
 * GenerateSmartReportSummaryRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GenerateSmartReportSummaryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'generateSmartReportSummary_request';
    ...
    public const REPORT_TYPE_SOIL = 'soil';
    public const REPORT_TYPE_WATER_QUALITY = 'water_quality';
    ...
    {
        return [
            self::REPORT_TYPE_SOIL,
            self::REPORT_TYPE_WATER_QUALITY,
        ];
    }
     ...
     * Sets report_data
     *
     * @param object $report_data Report data to summarize
     *
     * @return self
     */
    public function setReportData($report_data)
    {
        if (is_null($report_data)) {
            throw new \InvalidArgumentException('non-nullable report_data cannot be null');
        }
