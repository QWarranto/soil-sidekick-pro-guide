...
/**
 * GetSoilDataRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GetSoilDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'getSoilData_request';
     ...
     * Sets county_fips
     *
     * @param string $county_fips 5-digit FIPS code
     *
     * @return self
     */
    public function setCountyFips($county_fips)
    {
        ...
        if ((!preg_match("/^[0-9]{5}$/", ObjectSerializer::toString($county_fips)))) {
            throw new \InvalidArgumentException("invalid value for \$county_fips when calling GetSoilDataRequest., must conform to the pattern /^[0-9]{5}$/.");
        }
