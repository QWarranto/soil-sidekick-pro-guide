...
/**
 * CarbonCreditCalculation Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class CarbonCreditCalculation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CarbonCreditCalculation';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'credit_record' => '\SoilSidekick\Model\CarbonCreditCalculationCreditRecord',
        'calculation_details' => '\SoilSidekick\Model\CarbonCreditCalculationCalculationDetails'
    ];
    ...
    protected static $setters = [
        'success' => 'setSuccess',
        'credit_record' => 'setCreditRecord',
        'calculation_details' => 'setCalculationDetails'
    ];
    ...
    protected static $getters = [
        'success' => 'getSuccess',
        'credit_record' => 'getCreditRecord',
        'calculation_details' => 'getCalculationDetails'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('credit_record', $data ?? [], null);
        $this->setIfExists('calculation_details', $data ?? [], null);
    }
     ...
     * Gets credit_record
     *
     * @return \SoilSidekick\Model\CarbonCreditCalculationCreditRecord|null
     */
    public function getCreditRecord()
    {
        return $this->container['credit_record'];
    }

    /**
     * Sets credit_record
     *
     * @param \SoilSidekick\Model\CarbonCreditCalculationCreditRecord|null $credit_record credit_record
     *
     * @return self
     */
    public function setCreditRecord($credit_record)
    {
        if (is_null($credit_record)) {
            throw new \InvalidArgumentException('non-nullable credit_record cannot be null');
        }
        $this->container['credit_record'] = $credit_record;

        return $this;
    }

    /**
     * Gets calculation_details
     *
     * @return \SoilSidekick\Model\CarbonCreditCalculationCalculationDetails|null
     */
    public function getCalculationDetails()
    {
        return $this->container['calculation_details'];
    }

    /**
     * Sets calculation_details
     *
     * @param \SoilSidekick\Model\CarbonCreditCalculationCalculationDetails|null $calculation_details calculation_details
     *
     * @return self
     */
    public function setCalculationDetails($calculation_details)
    {
        if (is_null($calculation_details)) {
            throw new \InvalidArgumentException('non-nullable calculation_details cannot be null');
        }
        $this->container['calculation_details'] = $calculation_details;
