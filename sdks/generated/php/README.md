...
For more information, please visit [https://soilsidekickpro.com/support](https://soilsidekickpro.com/support).
...
*TurboQuantApi* | [**turboQuantCapabilities**](docs/Api/TurboQuantApi.md#turboquantcapabilities) | **POST** /turbo-quant-capabilities | Query TurboQuant device capabilities
...
- [TurboQuantCapabilities](docs/Model/TurboQuantCapabilities.md)
- [TurboQuantCapabilitiesEstimatedLatencyMs](docs/Model/TurboQuantCapabilitiesEstimatedLatencyMs.md)
- [TurboQuantCapabilitiesRequest](docs/Model/TurboQuantCapabilitiesRequest.md)
