...
/**
 * API tests for CarbonApi
 */
@Disabled
public class CarbonApiTest {

    private final CarbonApi api = new CarbonApi();
     ...
     */
    @Test
    public void calculateCarbonCreditsTest() throws ApiException {
        CalculateCarbonCreditsRequest calculateCarbonCreditsRequest = null;
        CarbonCreditCalculation response = 
        api.calculateCarbonCredits(calculateCarbonCreditsRequest);
