...
/**
 * API tests for LeafEnginesApi
 */
@Disabled
public class LeafEnginesApiTest {

    private final LeafEnginesApi api = new LeafEnginesApi();
     ...
     */
    @Test
    public void leafenginesQueryTest() throws ApiException {
        LeafenginesQueryRequest leafenginesQueryRequest = null;
        Integer xTqContextMode = null;
        String xTqKvCacheHint = null;
        String xTqModelTier = null;
        LeafEnginesCompatibility response = 
        api.leafenginesQuery(leafenginesQueryRequest, xTqContextMode, xTqKvCacheHint, xTqModelTier);
