...
/**
 * API tests for GeographicApi
 */
@Disabled
public class GeographicApiTest {

    private final GeographicApi api = new GeographicApi();
     ...
     */
    @Test
    public void countyLookupTest() throws ApiException {
        CountyLookupRequest countyLookupRequest = null;
        CountyLookup200Response response = 
        api.countyLookup(countyLookupRequest);
