...
/**
 * API tests for TurboQuantApi
 */
@Disabled
public class TurboQuantApiTest {

    private final TurboQuantApi api = new TurboQuantApi();
     ...
     */
    @Test
    public void turboQuantCapabilitiesTest() throws ApiException {
        TurboQuantCapabilitiesRequest turboQuantCapabilitiesRequest = null;
        Integer xTqContextMode = null;
        String xTqKvCacheHint = null;
        String xTqModelTier = null;
        TurboQuantCapabilities response = 
        api.turboQuantCapabilities(turboQuantCapabilitiesRequest, xTqContextMode, xTqKvCacheHint, xTqModelTier);
