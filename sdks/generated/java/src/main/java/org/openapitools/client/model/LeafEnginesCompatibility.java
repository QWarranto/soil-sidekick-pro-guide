...
public class LeafEnginesCompatibility {
  ...
  public LeafEnginesCompatibility success(@javax.annotation.Nullable Boolean success) {
  ...
  public LeafEnginesCompatibility data(@javax.annotation.Nullable LeafEnginesCompatibilityData data) {
    this.data = data;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DATA, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable LeafEnginesCompatibilityData data) {
    this.data = data;
  }


  public LeafEnginesCompatibility usage(@javax.annotation.Nullable LeafEnginesCompatibilityUsage usage) {
    this.usage = usage;
    return this;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_USAGE, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUsage(@javax.annotation.Nullable LeafEnginesCompatibilityUsage usage) {
    this.usage = usage;
  }
