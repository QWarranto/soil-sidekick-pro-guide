 ...
 */
@JsonPropertyOrder({
  CountyLookup200Response.JSON_PROPERTY_COUNTIES
})
...
public class CountyLookup200Response {
  public static final String JSON_PROPERTY_COUNTIES = "counties";
  @javax.annotation.Nullable
  private List<County> counties = new ArrayList<>();

  public CountyLookup200Response() { 
  }

  public CountyLookup200Response counties(@javax.annotation.Nullable List<County> counties) {
    this.counties = counties;
    return this;
  }

  public CountyLookup200Response addCountiesItem(County countiesItem) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_COUNTIES, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_COUNTIES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCounties(@javax.annotation.Nullable List<County> counties) {
    this.counties = counties;
  }


  /**
   * Return true if this countyLookup_200_response object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CountyLookup200Response countyLookup200Response = (CountyLookup200Response) o;
    return Objects.equals(this.counties, countyLookup200Response.counties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CountyLookup200Response {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `counties` to the URL query string
    if (getCounties() != null) {
      for (int i = 0; i < getCounties().size(); i++) {
        if (getCounties().get(i) != null) {
          joiner.add(getCounties().get(i).toUrlQueryString(String.format(java.util.Locale.ROOT, "%scounties%s%s", prefix, suffix,
