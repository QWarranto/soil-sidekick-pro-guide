...
public class CalculateEnvironmentalImpactRequestProposedTreatmentsInner {
  ...
  public enum TypeEnum {
    NITROGEN_FERTILIZER(String.valueOf("nitrogen_fertilizer")),
    
    PHOSPHORUS_FERTILIZER(String.valueOf("phosphorus_fertilizer")),
  ...
  public CalculateEnvironmentalImpactRequestProposedTreatmentsInner type(@javax.annotation.Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
