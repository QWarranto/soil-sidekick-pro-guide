 ...
 */
@JsonPropertyOrder({
  DynamicCareRequestLocation.JSON_PROPERTY_COUNTY_FIPS,
  DynamicCareRequestLocation.JSON_PROPERTY_STATE_CODE,
  DynamicCareRequestLocation.JSON_PROPERTY_INDOOR
})
...
public class DynamicCareRequestLocation {
  ...
  public DynamicCareRequestLocation() { 
  }

  public DynamicCareRequestLocation countyFips(@javax.annotation.Nonnull String countyFips) {
  ...
  public DynamicCareRequestLocation stateCode(@javax.annotation.Nullable String stateCode) {
  ...
  public DynamicCareRequestLocation indoor(@javax.annotation.Nullable Boolean indoor) {
    this.indoor = indoor;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_INDOOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(value = JSON_PROPERTY_INDOOR, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIndoor(@javax.annotation.Nullable Boolean indoor) {
    this.indoor = indoor;
  }


  /**
   * Return true if this dynamicCare_request_location object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DynamicCareRequestLocation dynamicCareRequestLocation = (DynamicCareRequestLocation) o;
    return Objects.equals(this.countyFips, dynamicCareRequestLocation.countyFips) &&
        Objects.equals(this.stateCode, dynamicCareRequestLocation.stateCode) &&
        Objects.equals(this.indoor, dynamicCareRequestLocation.indoor);
  }

  @Override
  public int hashCode() {
    return Objects.hash(countyFips, stateCode, indoor);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class DynamicCareRequestLocation {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `indoor` to the URL query string
    if (getIndoor() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sindoor%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getIndoor()))));
    }
