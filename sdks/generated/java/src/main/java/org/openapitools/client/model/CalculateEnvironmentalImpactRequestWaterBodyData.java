 ...
 */
@JsonPropertyOrder({
  CalculateEnvironmentalImpactRequestWaterBodyData.JSON_PROPERTY_DISTANCE_MILES
})
...
public class CalculateEnvironmentalImpactRequestWaterBodyData {
  public static final String JSON_PROPERTY_DISTANCE_MILES = "distance_miles";
  @javax.annotation.Nullable
  private BigDecimal distanceMiles;

  public CalculateEnvironmentalImpactRequestWaterBodyData() { 
  }

  public CalculateEnvironmentalImpactRequestWaterBodyData distanceMiles(@javax.annotation.Nullable BigDecimal distanceMiles) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(value = JSON_PROPERTY_DISTANCE_MILES, required = false)
  ...
  @JsonProperty(value = JSON_PROPERTY_DISTANCE_MILES, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setDistanceMiles(@javax.annotation.Nullable BigDecimal distanceMiles) {
    this.distanceMiles = distanceMiles;
  }


  /**
   * Return true if this calculateEnvironmentalImpact_request_water_body_data object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CalculateEnvironmentalImpactRequestWaterBodyData calculateEnvironmentalImpactRequestWaterBodyData = (CalculateEnvironmentalImpactRequestWaterBodyData) o;
    return Objects.equals(this.distanceMiles, calculateEnvironmentalImpactRequestWaterBodyData.distanceMiles);
  }

  @Override
  public int hashCode() {
    return Objects.hash(distanceMiles);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CalculateEnvironmentalImpactRequestWaterBodyData {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `distance_miles` to the URL query string
    if (getDistanceMiles() != null) {
      joiner.add(String.format(java.util.Locale.ROOT, "%sdistance_miles%s=%s", prefix, suffix, ApiClient.urlEncode(ApiClient.valueToString(getDistanceMiles()))));
    }
