...
public class AIAnalysisRecommendationsInner {
  ...
  public AIAnalysisRecommendationsInner title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public AIAnalysisRecommendationsInner description(@javax.annotation.Nullable String description) {
  ...
  public AIAnalysisRecommendationsInner priority(@javax.annotation.Nullable PriorityEnum priority) {
