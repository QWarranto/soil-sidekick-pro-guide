...
> ApiResponse<TerritorialWaterAnalytics> getTerritorialWaterAnalyticsWithHttpInfo(getTerritorialWaterAnalyticsRequest)
...
> WaterQuality getWaterQuality(getSoilDataRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            WaterQuality result = apiInstance.getWaterQuality(getSoilDataRequest);
            System.out.println(result);
        } catch (ApiException e) {
...
> ApiResponse<WaterQuality> getWaterQualityWithHttpInfo(getSoilDataRequest)
...
public class Example {
    public static void main(String[] args) {
        ...
        GetSoilDataRequest getSoilDataRequest = new GetSoilDataRequest(); // GetSoilDataRequest | 
        try {
            ApiResponse<WaterQuality> response = apiInstance.getWaterQualityWithHttpInfo(getSoilDataRequest);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
