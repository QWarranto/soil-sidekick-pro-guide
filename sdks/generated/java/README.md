...
- Build date: 2026-06-18T17:15:53.094617-04:00[America/New_York]
...
```groovy
compile "com.soilsidekick:soilsidekick-sdk:3.0.0"
```
...
- `target/soilsidekick-sdk-3.0.0.jar`
- `target/lib/*.jar`
...
*TurboQuantApi* | [**turboQuantCapabilities**](docs/TurboQuantApi.md#turboQuantCapabilities) | **POST** /turbo-quant-capabilities | Query TurboQuant device capabilities
*TurboQuantApi* | [**turboQuantCapabilitiesWithHttpInfo**](docs/TurboQuantApi.md#turboQuantCapabilitiesWithHttpInfo) | **POST** /turbo-quant-capabilities | Query TurboQuant device capabilities
