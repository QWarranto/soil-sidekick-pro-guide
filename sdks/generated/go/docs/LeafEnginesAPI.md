...
> LeafEnginesCompatibility LeafenginesQuery(ctx).LeafenginesQueryRequest(leafenginesQueryRequest).XTqContextMode(xTqContextMode).XTqKvCacheHint(xTqKvCacheHint).XTqModelTier(xTqModelTier).Execute()
...
func main() {
	...
	resp, r, err := apiClient.LeafEnginesAPI.LeafenginesQuery(context.Background()).LeafenginesQueryRequest(leafenginesQueryRequest).XTqContextMode(xTqContextMode).XTqKvCacheHint(xTqKvCacheHint).XTqModelTier(xTqModelTier).Execute()
	if err != nil {
