...
// checks if the SafeIdentificationRequestLocation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SafeIdentificationRequestLocation{}

// SafeIdentificationRequestLocation struct for SafeIdentificationRequestLocation
type SafeIdentificationRequestLocation struct {
	CountyFips *string `json:"county_fips,omitempty" validate:"regexp=^[0-9]{5}$"`
	StateCode *string `json:"state_code,omitempty"`
	Coordinates *SafeIdentificationRequestLocationCoordinates `json:"coordinates,omitempty"`
}
...
func NewSafeIdentificationRequestLocation() *SafeIdentificationRequestLocation {
	this := SafeIdentificationRequestLocation{}
	return &this
}
...
func (o *SafeIdentificationRequestLocation) GetCoordinates() SafeIdentificationRequestLocationCoordinates {
	if o == nil || IsNil(o.Coordinates) {
		var ret SafeIdentificationRequestLocationCoordinates
		return ret
	}
...
// SetCoordinates gets a reference to the given SafeIdentificationRequestLocationCoordinates and assigns it to the Coordinates field.
func (o *SafeIdentificationRequestLocation) SetCoordinates(v SafeIdentificationRequestLocationCoordinates) {
	o.Coordinates = &v
}

func (o SafeIdentificationRequestLocation) MarshalJSON() ([]byte, error) {
...
func (o SafeIdentificationRequestLocation) ToMap() (map[string]interface{}, error) {
...
type NullableSafeIdentificationRequestLocation struct {
	value *SafeIdentificationRequestLocation
	isSet bool
}

func (v NullableSafeIdentificationRequestLocation) Get() *SafeIdentificationRequestLocation {
	return v.value
}

func (v *NullableSafeIdentificationRequestLocation) Set(val *SafeIdentificationRequestLocation) {
	v.value = val
	v.isSet = true
}

func (v NullableSafeIdentificationRequestLocation) IsSet() bool {
	return v.isSet
}

func (v *NullableSafeIdentificationRequestLocation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSafeIdentificationRequestLocation(val *SafeIdentificationRequestLocation) *NullableSafeIdentificationRequestLocation {
	return &NullableSafeIdentificationRequestLocation{value: val, isSet: true}
}

func (v NullableSafeIdentificationRequestLocation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSafeIdentificationRequestLocation) UnmarshalJSON(src []byte) error {
	v.isSet = true
