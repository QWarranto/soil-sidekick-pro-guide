...
// GeographicAPIService GeographicAPI service
type GeographicAPIService service

type ApiCountyLookupRequest struct {
	ctx context.Context
	ApiService *GeographicAPIService
	countyLookupRequest *CountyLookupRequest
}

func (r ApiCountyLookupRequest) CountyLookupRequest(countyLookupRequest CountyLookupRequest) ApiCountyLookupRequest {
	r.countyLookupRequest = &countyLookupRequest
	return r
}

func (r ApiCountyLookupRequest) Execute() (*CountyLookup200Response, *http.Response, error) {
	return r.ApiService.CountyLookupExecute(r)
}

/*
CountyLookup Search for counties

Search counties by name, state, or FIPS code

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiCountyLookupRequest
*/
func (a *GeographicAPIService) CountyLookup(ctx context.Context) ApiCountyLookupRequest {
	return ApiCountyLookupRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *GeographicAPIService) CountyLookupExecute(r ApiCountyLookupRequest) (*CountyLookup200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CountyLookup200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GeographicAPIService.CountyLookup")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/county-lookup"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.countyLookupRequest == nil {
		return localVarReturnValue, nil, reportError("countyLookupRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.countyLookupRequest
	if r.ctx != nil {
