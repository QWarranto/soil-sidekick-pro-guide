...
module SoilSidekick
  class DynamicCareRequest < ApiModelBase
    # Common or scientific plant name
    attr_accessor :plant_species
    ...
    attr_accessor :soil_type

    # Date plant was last watered
    attr_accessor :last_watered
    ...
    def self.openapi_types
      {
        ...
        :'container_details' => :'DynamicCareRequestContainerDetails',
        :'soil_type' => :'String',
        :'last_watered' => :'Date'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'plant_species')
        self.plant_species = attributes[:'plant_species']
      else
        self.plant_species = nil
      end
      ...
      if attributes.key?(:'container_details')
        self.container_details = attributes[:'container_details']
      end

      if attributes.key?(:'soil_type')
        self.soil_type = attributes[:'soil_type']
      end

      if attributes.key?(:'last_watered')
        self.last_watered = attributes[:'last_watered']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @plant_species.nil?
        invalid_properties.push('invalid value for "plant_species", plant_species cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @plant_species.nil?
      return false if @location.nil?
      soil_type_validator = EnumAttributeValidator.new('String', ["potting_mix", "succulent_mix", "orchid_bark", "garden_soil", "sandy", "clay"])
      return false unless soil_type_validator.valid?(@soil_type)
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] plant_species Value to be assigned
    def plant_species=(plant_species)
      if plant_species.nil?
        fail ArgumentError, 'plant_species cannot be nil'
      end
    ...
    # @param [Object] soil_type Object to be assigned
    def soil_type=(soil_type)
      validator = EnumAttributeValidator.new('String', ["potting_mix", "succulent_mix", "orchid_bark", "garden_soil", "sandy", "clay"])
      unless validator.valid?(soil_type)
        fail ArgumentError, "invalid value for \"soil_type\", must be one of #{validator.allowable_values}."
      end
      @soil_type = soil_type
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          plant_species == o.plant_species &&
          location == o.location &&
          environment == o.environment &&
          container_details == o.container_details &&
          soil_type == o.soil_type &&
          last_watered == o.last_watered
    end
    ...
    def hash
      [plant_species, location, environment, container_details, soil_type, last_watered].hash
    end
