...
module SoilSidekick
  class TurboQuantCapabilitiesRequest < ApiModelBase
    # Device RAM in GB
    attr_accessor :device_memory_gb

    # Whether WebGPU is available
    attr_accessor :has_webgpu
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::TurboQuantCapabilitiesRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::TurboQuantCapabilitiesRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'device_memory_gb')
        self.device_memory_gb = attributes[:'device_memory_gb']
      end

      if attributes.key?(:'has_webgpu')
        self.has_webgpu = attributes[:'has_webgpu']
      end
    ...
    def valid?
      ...
      platform_validator = EnumAttributeValidator.new('String', ["mobile", "tablet", "desktop", "server"])
    ...
    def platform=(platform)
      validator = EnumAttributeValidator.new('String', ["mobile", "tablet", "desktop", "server"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          device_memory_gb == o.device_memory_gb &&
          has_webgpu == o.has_webgpu &&
          platform == o.platform
    end
    ...
    def hash
      [device_memory_gb, has_webgpu, platform].hash
    end
