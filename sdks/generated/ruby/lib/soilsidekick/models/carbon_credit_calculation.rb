...
module SoilSidekick
  class CarbonCreditCalculation < ApiModelBase
    attr_accessor :success

    attr_accessor :credit_record

    attr_accessor :calculation_details
    ...
    def self.openapi_types
      {
        :'success' => :'Boolean',
        :'credit_record' => :'CarbonCreditCalculationCreditRecord',
        :'calculation_details' => :'CarbonCreditCalculationCalculationDetails'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::CarbonCreditCalculation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::CarbonCreditCalculation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credit_record')
        self.credit_record = attributes[:'credit_record']
      end

      if attributes.key?(:'calculation_details')
        self.calculation_details = attributes[:'calculation_details']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          calculation_details == o.calculation_details
    end
    ...
    def hash
      [success, credit_record, calculation_details].hash
    end
