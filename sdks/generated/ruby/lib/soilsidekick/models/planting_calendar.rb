...
module SoilSidekick
  class PlantingCalendar < ApiModelBase
    attr_accessor :crop_type

    attr_accessor :optimal_planting_window

    attr_accessor :climate_factors

    attr_accessor :soil_factors
    ...
    def self.openapi_types
      {
        :'crop_type' => :'String',
        :'optimal_planting_window' => :'GetTerritorialWaterAnalyticsRequestDateRange',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::PlantingCalendar` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::PlantingCalendar`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'crop_type')
        self.crop_type = attributes[:'crop_type']
      end

      if attributes.key?(:'optimal_planting_window')
        self.optimal_planting_window = attributes[:'optimal_planting_window']
      end

      if attributes.key?(:'climate_factors')
        self.climate_factors = attributes[:'climate_factors']
      end

      if attributes.key?(:'soil_factors')
        self.soil_factors = attributes[:'soil_factors']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          optimal_planting_window == o.optimal_planting_window &&
          climate_factors == o.climate_factors &&
          soil_factors == o.soil_factors &&
    ...
    def hash
      [crop_type, optimal_planting_window, climate_factors, soil_factors, recommendations].hash
    end
