  ...
  class BeginnerGuidance < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'detailed_explanation' => :'BeginnerGuidanceDetailedExplanation',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::BeginnerGuidance` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::BeginnerGuidance`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'simple_answer')
        self.simple_answer = attributes[:'simple_answer']
      end

      if attributes.key?(:'what_to_do_now')
        self.what_to_do_now = attributes[:'what_to_do_now']
      end

      if attributes.key?(:'why_this_happens')
        self.why_this_happens = attributes[:'why_this_happens']
      end

      if attributes.key?(:'detailed_explanation')
        self.detailed_explanation = attributes[:'detailed_explanation']
      end

      if attributes.key?(:'encouragement')
        self.encouragement = attributes[:'encouragement']
      end

      if attributes.key?(:'related_questions')
        if (value = attributes[:'related_questions']).is_a?(Array)
          self.related_questions = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          simple_answer == o.simple_answer &&
          what_to_do_now == o.what_to_do_now &&
          why_this_happens == o.why_this_happens &&
          detailed_explanation == o.detailed_explanation &&
          encouragement == o.encouragement &&
          related_questions == o.related_questions &&
    ...
    def hash
      [success, simple_answer, what_to_do_now, why_this_happens, detailed_explanation, encouragement, related_questions, confidence, metadata].hash
    end
