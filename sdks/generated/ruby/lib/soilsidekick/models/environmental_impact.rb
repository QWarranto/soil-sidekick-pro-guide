...
module SoilSidekick
  class EnvironmentalImpact < ApiModelBase
    attr_accessor :impact_assessment

    attr_accessor :detailed_analysis
    ...
    def self.openapi_types
      {
        :'impact_assessment' => :'EnvironmentalImpactImpactAssessment',
        :'detailed_analysis' => :'EnvironmentalImpactDetailedAnalysis',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::EnvironmentalImpact` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::EnvironmentalImpact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'impact_assessment')
        self.impact_assessment = attributes[:'impact_assessment']
      end

      if attributes.key?(:'detailed_analysis')
        self.detailed_analysis = attributes[:'detailed_analysis']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          impact_assessment == o.impact_assessment &&
    ...
    def hash
      [impact_assessment, detailed_analysis, recommendations].hash
    end
