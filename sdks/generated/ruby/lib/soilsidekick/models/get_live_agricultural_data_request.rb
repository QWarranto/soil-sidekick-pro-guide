...
module SoilSidekick
  class GetLiveAgriculturalDataRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::GetLiveAgriculturalDataRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::GetLiveAgriculturalDataRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'data_types')
        if (value = attributes[:'data_types']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @data_types.nil?
        invalid_properties.push('invalid value for "data_types", data_types cannot be nil.')
      end
      ...
      if @county_name.nil?
        invalid_properties.push('invalid value for "county_name", county_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @county_name.nil?
      true
    end
    ...
    def county_name=(county_name)
      if county_name.nil?
        fail ArgumentError, 'county_name cannot be nil'
      end
    ...
    def hash
      [county_fips, data_types, state_code, county_name].hash
    end
