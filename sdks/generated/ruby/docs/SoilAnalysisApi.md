...
> <PlantingCalendar> get_planting_calendar(get_planting_calendar_request, opts)
...
begin
  # Get planting calendar recommendations
  result = api_instance.get_planting_calendar(get_planting_calendar_request, opts)
  p result
rescue SoilSidekick::ApiError => e
...
> <Array(<PlantingCalendar>, Integer, Hash)> get_planting_calendar_with_http_info(get_planting_calendar_request, opts)

```ruby
begin
  # Get planting calendar recommendations
  data, status_code, headers = api_instance.get_planting_calendar_with_http_info(get_planting_calendar_request, opts)
  p status_code # => 2xx
  p headers # => { ... }
