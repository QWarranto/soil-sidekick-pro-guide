...
# Unit tests for SoilSidekick::LeafEnginesCompatibilityDataBreakdownSoil
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibilityDataBreakdownSoil do
  #let(:instance) { SoilSidekick::LeafEnginesCompatibilityDataBreakdownSoil.new }

  describe 'test an instance of LeafEnginesCompatibilityDataBreakdownSoil' do
    it 'should create an instance of LeafEnginesCompatibilityDataBreakdownSoil' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibilityDataBreakdownSoil)
    end
  end
  ...
  describe 'test attribute "concerns"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
