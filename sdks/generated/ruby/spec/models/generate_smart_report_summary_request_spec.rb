...
# Unit tests for SoilSidekick::GenerateSmartReportSummaryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GenerateSmartReportSummaryRequest do
  #let(:instance) { SoilSidekick::GenerateSmartReportSummaryRequest.new }

  describe 'test an instance of GenerateSmartReportSummaryRequest' do
    it 'should create an instance of GenerateSmartReportSummaryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GenerateSmartReportSummaryRequest)
    end
  end
  ...
  describe 'test attribute "report_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["soil", "water_quality"])
  ...
  describe 'test attribute "report_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
