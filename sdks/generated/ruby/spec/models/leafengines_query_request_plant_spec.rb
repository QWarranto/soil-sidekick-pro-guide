...
# Unit tests for SoilSidekick::LeafenginesQueryRequestPlant
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequestPlant do
  #let(:instance) { SoilSidekick::LeafenginesQueryRequestPlant.new }

  describe 'test an instance of LeafenginesQueryRequestPlant' do
    it 'should create an instance of LeafenginesQueryRequestPlant' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequestPlant)
    end
  end
  ...
  describe 'test attribute "plant_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "care_requirements"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
