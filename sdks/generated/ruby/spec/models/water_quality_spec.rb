...
# Unit tests for SoilSidekick::WaterQuality
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::WaterQuality do
  #let(:instance) { SoilSidekick::WaterQuality.new }

  describe 'test an instance of WaterQuality' do
    it 'should create an instance of WaterQuality' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::WaterQuality)
    end
  end
  ...
  describe 'test attribute "dissolved_oxygen"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "turbidity"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "nitrates"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "phosphates"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "contamination_risk"' do
    it 'should work' do
      ...
      #   expect { instance.contamination_risk = value }.not_to raise_error
      # end
    end
  end
