...
# Unit tests for SoilSidekick::LeafEnginesCompatibilityUsage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibilityUsage do
  #let(:instance) { SoilSidekick::LeafEnginesCompatibilityUsage.new }

  describe 'test an instance of LeafEnginesCompatibilityUsage' do
    it 'should create an instance of LeafEnginesCompatibilityUsage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibilityUsage)
    end
  end
