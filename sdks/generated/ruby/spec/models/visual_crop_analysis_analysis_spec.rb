...
# Unit tests for SoilSidekick::VisualCropAnalysisAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VisualCropAnalysisAnalysis do
  #let(:instance) { SoilSidekick::VisualCropAnalysisAnalysis.new }

  describe 'test an instance of VisualCropAnalysisAnalysis' do
    it 'should create an instance of VisualCropAnalysisAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VisualCropAnalysisAnalysis)
    end
  end
