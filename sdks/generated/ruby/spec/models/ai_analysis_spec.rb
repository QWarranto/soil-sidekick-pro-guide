...
# Unit tests for SoilSidekick::AIAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::AIAnalysis do
  #let(:instance) { SoilSidekick::AIAnalysis.new }

  describe 'test an instance of AIAnalysis' do
    it 'should create an instance of AIAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::AIAnalysis)
    end
  end
