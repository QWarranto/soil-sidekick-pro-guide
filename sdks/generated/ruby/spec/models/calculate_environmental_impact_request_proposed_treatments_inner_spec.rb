...
# Unit tests for SoilSidekick::CalculateEnvironmentalImpactRequestProposedTreatmentsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::CalculateEnvironmentalImpactRequestProposedTreatmentsInner do
  #let(:instance) { SoilSidekick::CalculateEnvironmentalImpactRequestProposedTreatmentsInner.new }

  describe 'test an instance of CalculateEnvironmentalImpactRequestProposedTreatmentsInner' do
    it 'should create an instance of CalculateEnvironmentalImpactRequestProposedTreatmentsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::CalculateEnvironmentalImpactRequestProposedTreatmentsInner)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["nitrogen_fertilizer", "phosphorus_fertilizer", "pesticide"])
