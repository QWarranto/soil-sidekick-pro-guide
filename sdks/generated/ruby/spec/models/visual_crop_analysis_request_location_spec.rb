...
# Unit tests for SoilSidekick::VisualCropAnalysisRequestLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VisualCropAnalysisRequestLocation do
  #let(:instance) { SoilSidekick::VisualCropAnalysisRequestLocation.new }

  describe 'test an instance of VisualCropAnalysisRequestLocation' do
    it 'should create an instance of VisualCropAnalysisRequestLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VisualCropAnalysisRequestLocation)
    end
  end
