...
# Unit tests for SoilSidekick::LiveAgriculturalData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LiveAgriculturalData do
  #let(:instance) { SoilSidekick::LiveAgriculturalData.new }

  describe 'test an instance of LiveAgriculturalData' do
    it 'should create an instance of LiveAgriculturalData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LiveAgriculturalData)
    end
  end
  ...
  describe 'test attribute "cache_status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["updated", "fallback"])
