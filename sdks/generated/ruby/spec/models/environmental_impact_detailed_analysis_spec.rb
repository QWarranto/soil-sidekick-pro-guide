...
# Unit tests for SoilSidekick::EnvironmentalImpactDetailedAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::EnvironmentalImpactDetailedAnalysis do
  #let(:instance) { SoilSidekick::EnvironmentalImpactDetailedAnalysis.new }

  describe 'test an instance of EnvironmentalImpactDetailedAnalysis' do
    it 'should create an instance of EnvironmentalImpactDetailedAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::EnvironmentalImpactDetailedAnalysis)
    end
  end

  describe 'test attribute "runoff_risk"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "contamination_assessment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "eco_alternatives"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "carbon_analysis"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "biodiversity_assessment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
