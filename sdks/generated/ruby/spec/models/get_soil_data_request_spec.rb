...
# Unit tests for SoilSidekick::GetSoilDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetSoilDataRequest do
  #let(:instance) { SoilSidekick::GetSoilDataRequest.new }

  describe 'test an instance of GetSoilDataRequest' do
    it 'should create an instance of GetSoilDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetSoilDataRequest)
    end
  end
