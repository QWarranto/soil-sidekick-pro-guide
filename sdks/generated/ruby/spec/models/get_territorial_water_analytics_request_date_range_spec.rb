...
# Unit tests for SoilSidekick::GetTerritorialWaterAnalyticsRequestDateRange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetTerritorialWaterAnalyticsRequestDateRange do
  #let(:instance) { SoilSidekick::GetTerritorialWaterAnalyticsRequestDateRange.new }

  describe 'test an instance of GetTerritorialWaterAnalyticsRequestDateRange' do
    it 'should create an instance of GetTerritorialWaterAnalyticsRequestDateRange' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetTerritorialWaterAnalyticsRequestDateRange)
    end
  end
