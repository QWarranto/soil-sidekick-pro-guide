...
# Unit tests for SoilSidekick::LeafEnginesCompatibilityDataBreakdown
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibilityDataBreakdown do
  #let(:instance) { SoilSidekick::LeafEnginesCompatibilityDataBreakdown.new }

  describe 'test an instance of LeafEnginesCompatibilityDataBreakdown' do
    it 'should create an instance of LeafEnginesCompatibilityDataBreakdown' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibilityDataBreakdown)
    end
  end

  describe 'test attribute "soil"' do
    it 'should work' do
  ...
  describe 'test attribute "climate"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
