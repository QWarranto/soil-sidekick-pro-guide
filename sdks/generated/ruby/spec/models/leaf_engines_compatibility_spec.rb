...
# Unit tests for SoilSidekick::LeafEnginesCompatibility
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibility do
  #let(:instance) { SoilSidekick::LeafEnginesCompatibility.new }

  describe 'test an instance of LeafEnginesCompatibility' do
    it 'should create an instance of LeafEnginesCompatibility' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibility)
    end
  end
