...
# Unit tests for SoilSidekick::GenerateVRTPrescriptionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GenerateVRTPrescriptionRequest do
  #let(:instance) { SoilSidekick::GenerateVRTPrescriptionRequest.new }

  describe 'test an instance of GenerateVRTPrescriptionRequest' do
    it 'should create an instance of GenerateVRTPrescriptionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GenerateVRTPrescriptionRequest)
    end
  end
  ...
  describe 'test attribute "application_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["fertilizer", "seed", "pesticide"])
