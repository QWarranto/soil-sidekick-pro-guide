...
# Unit tests for SoilSidekick::GetSeasonalPlanningAssistantRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetSeasonalPlanningAssistantRequest do
  #let(:instance) { SoilSidekick::GetSeasonalPlanningAssistantRequest.new }

  describe 'test an instance of GetSeasonalPlanningAssistantRequest' do
    it 'should create an instance of GetSeasonalPlanningAssistantRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetSeasonalPlanningAssistantRequest)
    end
  end
  ...
  describe 'test attribute "planning_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["spring_planting", "fall_harvest", "winter_prep", "year_round"])
      # validator.allowable_values.each do |value|
      #   expect { instance.planning_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "crop_preferences"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
