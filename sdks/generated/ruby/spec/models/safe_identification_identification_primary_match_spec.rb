...
# Unit tests for SoilSidekick::SafeIdentificationIdentificationPrimaryMatch
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::SafeIdentificationIdentificationPrimaryMatch do
  #let(:instance) { SoilSidekick::SafeIdentificationIdentificationPrimaryMatch.new }

  describe 'test an instance of SafeIdentificationIdentificationPrimaryMatch' do
    it 'should create an instance of SafeIdentificationIdentificationPrimaryMatch' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::SafeIdentificationIdentificationPrimaryMatch)
    end
  end
