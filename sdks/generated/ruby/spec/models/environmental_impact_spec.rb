...
# Unit tests for SoilSidekick::EnvironmentalImpact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::EnvironmentalImpact do
  #let(:instance) { SoilSidekick::EnvironmentalImpact.new }

  describe 'test an instance of EnvironmentalImpact' do
    it 'should create an instance of EnvironmentalImpact' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::EnvironmentalImpact)
    end
  end

  describe 'test attribute "impact_assessment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "detailed_analysis"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
