...
# Unit tests for SoilSidekick::LiveAgriculturalDataData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LiveAgriculturalDataData do
  #let(:instance) { SoilSidekick::LiveAgriculturalDataData.new }

  describe 'test an instance of LiveAgriculturalDataData' do
    it 'should create an instance of LiveAgriculturalDataData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LiveAgriculturalDataData)
    end
  end
  ...
  describe 'test attribute "crop"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "environmental"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
