...
# Unit tests for SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternatives
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternatives do
  #let(:instance) { SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternatives.new }

  describe 'test an instance of EnvironmentalImpactDetailedAnalysisEcoAlternatives' do
    it 'should create an instance of EnvironmentalImpactDetailedAnalysisEcoAlternatives' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternatives)
    end
  end
