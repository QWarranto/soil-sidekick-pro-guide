...
# Unit tests for SoilSidekick::LeafenginesQueryRequestOptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequestOptions do
  #let(:instance) { SoilSidekick::LeafenginesQueryRequestOptions.new }

  describe 'test an instance of LeafenginesQueryRequestOptions' do
    it 'should create an instance of LeafenginesQueryRequestOptions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequestOptions)
    end
  end

  describe 'test attribute "include_satellite_data"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "include_water_quality"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "include_recommendations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
