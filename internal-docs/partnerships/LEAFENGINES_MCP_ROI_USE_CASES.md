...
> 🟢 **Now on the [GitHub MCP Registry](https://github.com/mcp)** — Discoverable natively in Claude Desktop, Cursor, and every registry-aware MCP client. Search "LeafEngines" in your client, or add via `npx -y @ancientwhispers54/leafengines-mcp-server`.
