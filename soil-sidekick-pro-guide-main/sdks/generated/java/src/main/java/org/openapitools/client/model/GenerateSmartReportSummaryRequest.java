...
public class GenerateSmartReportSummaryRequest {
  ...
  public GenerateSmartReportSummaryRequest reportType(ReportTypeEnum reportType) {
  ...
  **/
  ...
  public GenerateSmartReportSummaryRequest reportData(Object reportData) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_REPORT_DATA)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getReportType() != null) {
      joiner.add(String.format("%sreportType%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getReportType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `reportData` to the URL query string
    if (getReportData() != null) {
      joiner.add(String.format("%sreportData%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getReportData()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
