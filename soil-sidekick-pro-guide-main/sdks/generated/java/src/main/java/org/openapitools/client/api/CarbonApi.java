...
public class CarbonApi {
   ...
   */
  public CarbonCreditCalculation calculateCarbonCredits(CalculateCarbonCreditsRequest calculateCarbonCreditsRequest) throws ApiException {
    ApiResponse<CarbonCreditCalculation> localVarResponse = calculateCarbonCreditsWithHttpInfo(calculateCarbonCreditsRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CarbonCreditCalculation> calculateCarbonCreditsWithHttpInfo(CalculateCarbonCreditsRequest calculateCarbonCreditsRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = calculateCarbonCreditsRequestBuilder(calculateCarbonCreditsRequest);
    try {
      ...
      try {
        ...
        return new ApiResponse<CarbonCreditCalculation>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CarbonCreditCalculation>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder calculateCarbonCreditsRequestBuilder(CalculateCarbonCreditsRequest calculateCarbonCreditsRequest) throws ApiException {
