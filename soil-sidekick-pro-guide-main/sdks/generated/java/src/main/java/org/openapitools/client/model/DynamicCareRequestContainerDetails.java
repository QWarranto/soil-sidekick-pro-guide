...
public class DynamicCareRequestContainerDetails {
  ...
  public DynamicCareRequestContainerDetails type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public DynamicCareRequestContainerDetails sizeInches(BigDecimal sizeInches) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SIZE_INCHES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_SIZE_INCHES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSizeInches(BigDecimal sizeInches) {
    this.sizeInches = sizeInches;
  }


  public DynamicCareRequestContainerDetails hasDrainage(Boolean hasDrainage) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_HAS_DRAINAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getSizeInches() != null) {
      joiner.add(String.format("%ssize_inches%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSizeInches()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `has_drainage` to the URL query string
    if (getHasDrainage() != null) {
      joiner.add(String.format("%shas_drainage%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getHasDrainage()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
