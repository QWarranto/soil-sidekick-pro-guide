...
public class LeafenginesQueryRequest {
  ...
  public LeafenginesQueryRequest location(LeafenginesQueryRequestLocation location) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_LOCATION)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLocation(LeafenginesQueryRequestLocation location) {
    this.location = location;
  }


  public LeafenginesQueryRequest plant(LeafenginesQueryRequestPlant plant) {
    this.plant = plant;
    return this;
  }
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_PLANT)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setPlant(LeafenginesQueryRequestPlant plant) {
    this.plant = plant;
  }


  public LeafenginesQueryRequest options(LeafenginesQueryRequestOptions options) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOptions(LeafenginesQueryRequestOptions options) {
    this.options = options;
  }
