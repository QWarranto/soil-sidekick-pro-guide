...
public class CalculateEnvironmentalImpactRequestWaterBodyData {
  ...
  public CalculateEnvironmentalImpactRequestWaterBodyData distanceMiles(BigDecimal distanceMiles) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_DISTANCE_MILES)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDistanceMiles() != null) {
      joiner.add(String.format("%sdistance_miles%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getDistanceMiles()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
