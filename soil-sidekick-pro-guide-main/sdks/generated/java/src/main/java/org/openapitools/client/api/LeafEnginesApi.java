...
public class LeafEnginesApi {
   ...
   */
  public LeafEnginesCompatibility leafenginesQuery(LeafenginesQueryRequest leafenginesQueryRequest) throws ApiException {
    ApiResponse<LeafEnginesCompatibility> localVarResponse = leafenginesQueryWithHttpInfo(leafenginesQueryRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<LeafEnginesCompatibility> leafenginesQueryWithHttpInfo(LeafenginesQueryRequest leafenginesQueryRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = leafenginesQueryRequestBuilder(leafenginesQueryRequest);
    try {
      ...
      try {
        ...
        return new ApiResponse<LeafEnginesCompatibility>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<LeafEnginesCompatibility>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder leafenginesQueryRequestBuilder(LeafenginesQueryRequest leafenginesQueryRequest) throws ApiException {
