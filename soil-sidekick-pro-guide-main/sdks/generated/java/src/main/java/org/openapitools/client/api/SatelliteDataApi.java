...
public class SatelliteDataApi {
   ...
   */
  public SatelliteData getSatelliteData(GetSatelliteDataRequest getSatelliteDataRequest) throws ApiException {
    ApiResponse<SatelliteData> localVarResponse = getSatelliteDataWithHttpInfo(getSatelliteDataRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<SatelliteData> getSatelliteDataWithHttpInfo(GetSatelliteDataRequest getSatelliteDataRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getSatelliteDataRequestBuilder(getSatelliteDataRequest);
    try {
      ...
      try {
        ...
        return new ApiResponse<SatelliteData>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<SatelliteData>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getSatelliteDataRequestBuilder(GetSatelliteDataRequest getSatelliteDataRequest) throws ApiException {
