...
public class GenerateVRTPrescriptionRequest {
  ...
  public GenerateVRTPrescriptionRequest fieldId(UUID fieldId) {
  ...
  **/
  ...
  public GenerateVRTPrescriptionRequest applicationType(ApplicationTypeEnum applicationType) {
  ...
  **/
  ...
  public GenerateVRTPrescriptionRequest soilAnalysisId(UUID soilAnalysisId) {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getFieldId() != null) {
      joiner.add(String.format("%sfield_id%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getFieldId()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }

    // add `application_type` to the URL query string
    if (getApplicationType() != null) {
      joiner.add(String.format("%sapplication_type%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getApplicationType()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
