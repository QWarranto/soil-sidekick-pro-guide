...
public class SmartReportSummary {
  ...
  public SmartReportSummary success(Boolean success) {
  ...
  **/
  ...
  public SmartReportSummary summary(SmartReportSummarySummary summary) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_SUMMARY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSummary(SmartReportSummarySummary summary) {
    this.summary = summary;
  }


  public SmartReportSummary modelUsed(String modelUsed) {
