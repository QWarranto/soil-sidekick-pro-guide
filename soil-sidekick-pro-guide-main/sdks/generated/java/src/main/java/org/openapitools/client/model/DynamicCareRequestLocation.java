...
public class DynamicCareRequestLocation {
  ...
  public DynamicCareRequestLocation countyFips(String countyFips) {
  ...
  **/
  ...
  public DynamicCareRequestLocation stateCode(String stateCode) {
  ...
  **/
  ...
  public DynamicCareRequestLocation indoor(Boolean indoor) {
    this.indoor = indoor;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_INDOOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getIndoor() != null) {
      joiner.add(String.format("%sindoor%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIndoor()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
