...
/**
 * Preferred model tier for TurboQuant optimization. - starter: Gemma 2B on 1GB+ devices - professional: Gemma 7B on 4GB+ devices - enterprise: Bitnet 70B/100B on 8GB+/12GB+ devices 
 */
public enum TQModelTier {
  ...
  @JsonCreator
  public static TQModelTier fromValue(String value) {
    for (TQModelTier b : TQModelTier.values()) {
