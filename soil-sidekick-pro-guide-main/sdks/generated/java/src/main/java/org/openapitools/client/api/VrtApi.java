...
public class VrtApi {
   ...
   */
  public VRTPrescription generateVRTPrescription(GenerateVRTPrescriptionRequest generateVRTPrescriptionRequest) throws ApiException {
    ApiResponse<VRTPrescription> localVarResponse = generateVRTPrescriptionWithHttpInfo(generateVRTPrescriptionRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<VRTPrescription> generateVRTPrescriptionWithHttpInfo(GenerateVRTPrescriptionRequest generateVRTPrescriptionRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = generateVRTPrescriptionRequestBuilder(generateVRTPrescriptionRequest);
    try {
      ...
      try {
        ...
        return new ApiResponse<VRTPrescription>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<VRTPrescription>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder generateVRTPrescriptionRequestBuilder(GenerateVRTPrescriptionRequest generateVRTPrescriptionRequest) throws ApiException {
