...
public class GeographicApi {
   ...
   */
  public CountyLookup200Response countyLookup(CountyLookupRequest countyLookupRequest) throws ApiException {
    ApiResponse<CountyLookup200Response> localVarResponse = countyLookupWithHttpInfo(countyLookupRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<CountyLookup200Response> countyLookupWithHttpInfo(CountyLookupRequest countyLookupRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = countyLookupRequestBuilder(countyLookupRequest);
    try {
      ...
      try {
        ...
        return new ApiResponse<CountyLookup200Response>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<CountyLookup200Response>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder countyLookupRequestBuilder(CountyLookupRequest countyLookupRequest) throws ApiException {
