...
/**
 * TurboQuant KV cache compression hint. - none: Standard 16-bit KV cache - 3bit: TurboQuant 3-bit compression (6x memory reduction) 
 */
public enum TQKVCacheHint {
  ...
  @JsonCreator
  public static TQKVCacheHint fromValue(String value) {
    for (TQKVCacheHint b : TQKVCacheHint.values()) {
