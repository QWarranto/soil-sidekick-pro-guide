...
public class EnvironmentalImpactDetailedAnalysisRunoffRisk {
  ...
  public EnvironmentalImpactDetailedAnalysisRunoffRisk score(BigDecimal score) {
    this.score = score;
    return this;
  }
  ...
  **/
  ...
  public EnvironmentalImpactDetailedAnalysisRunoffRisk riskLevel(RiskLevelEnum riskLevel) {
  ...
  **/
  ...
  public EnvironmentalImpactDetailedAnalysisRunoffRisk contributingFactors(Object contributingFactors) {
  ...
  **/
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_CONTRIBUTING_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_CONTRIBUTING_FACTORS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setContributingFactors(Object contributingFactors) {
    this.contributingFactors = contributingFactors;
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getContributingFactors() != null) {
      joiner.add(String.format("%scontributing_factors%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getContributingFactors()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
