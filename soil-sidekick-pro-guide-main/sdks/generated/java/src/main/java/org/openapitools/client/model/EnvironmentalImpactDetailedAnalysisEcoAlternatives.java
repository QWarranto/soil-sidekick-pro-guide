...
public class EnvironmentalImpactDetailedAnalysisEcoAlternatives {
  ...
  private List<EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner> alternatives;

  public EnvironmentalImpactDetailedAnalysisEcoAlternatives() { 
  }

  public EnvironmentalImpactDetailedAnalysisEcoAlternatives alternatives(List<EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner> alternatives) {
  ...
  **/
  ...
  @JsonProperty(JSON_PROPERTY_ALTERNATIVES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAlternatives(List<EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner> alternatives) {
    this.alternatives = alternatives;
  }
    ...
    if (getAlternatives() != null) {
      for (int i = 0; i < getAlternatives().size(); i++) {
        if (getAlternatives().get(i) != null) {
          joiner.add(getAlternatives().get(i).toUrlQueryString(String.format("%salternatives%s%s", prefix, suffix,
