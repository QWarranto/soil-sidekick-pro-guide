...
public class GetLiveAgriculturalDataRequest {
  ...
  public GetLiveAgriculturalDataRequest countyFips(String countyFips) {
  ...
  **/
  ...
  public GetLiveAgriculturalDataRequest dataTypes(List<DataTypesEnum> dataTypes) {
  ...
  **/
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_DATA_TYPES)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  public GetLiveAgriculturalDataRequest stateCode(String stateCode) {
  ...
  **/
  ...
  public GetLiveAgriculturalDataRequest countyName(String countyName) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getDataTypes() != null) {
      for (int i = 0; i < getDataTypes().size(); i++) {
        joiner.add(String.format("%sdata_types%s%s=%s", prefix, suffix,
            "".equals(suffix) ? "" : String.format("%s%d%s", containerPrefix, i, containerSuffix),
            URLEncoder.encode(String.valueOf(getDataTypes().get(i)), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
      }
    }
