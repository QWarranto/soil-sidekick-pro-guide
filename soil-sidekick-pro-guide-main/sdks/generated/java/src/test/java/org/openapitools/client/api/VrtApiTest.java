...
/**
 * API tests for VrtApi
 */
@Ignore
public class VrtApiTest {

    private final VrtApi api = new VrtApi();
     ...
     */
    @Test
    public void generateVRTPrescriptionTest() throws ApiException {
        GenerateVRTPrescriptionRequest generateVRTPrescriptionRequest = null;
        VRTPrescription response = 
        api.generateVRTPrescription(generateVRTPrescriptionRequest);
