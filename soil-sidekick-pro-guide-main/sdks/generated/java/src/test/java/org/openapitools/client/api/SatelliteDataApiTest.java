...
/**
 * API tests for SatelliteDataApi
 */
@Ignore
public class SatelliteDataApiTest {

    private final SatelliteDataApi api = new SatelliteDataApi();
     ...
     */
    @Test
    public void getSatelliteDataTest() throws ApiException {
        GetSatelliteDataRequest getSatelliteDataRequest = null;
        SatelliteData response = 
        api.getSatelliteData(getSatelliteDataRequest);
