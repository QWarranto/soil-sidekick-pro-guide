...
/**
 * API tests for WaterQualityApi
 */
@Ignore
public class WaterQualityApiTest {

    private final WaterQualityApi api = new WaterQualityApi();
     ...
     */
    @Test
    public void getTerritorialWaterAnalyticsTest() throws ApiException {
        GetTerritorialWaterAnalyticsRequest getTerritorialWaterAnalyticsRequest = null;
        TerritorialWaterAnalytics response = 
        api.getTerritorialWaterAnalytics(getTerritorialWaterAnalyticsRequest);
     ...
     */
    @Test
    public void getWaterQualityTest() throws ApiException {
        GetWaterQualityRequest getWaterQualityRequest = null;
        WaterQuality response = 
        api.getWaterQuality(getWaterQualityRequest);
