...
**detailed_explanation** | [**\SoilSidekick\Model\BeginnerGuidanceDetailedExplanation**](BeginnerGuidanceDetailedExplanation.md) |  | [optional]
**encouragement** | **string** | Supportive message for the user | [optional]
**related_questions** | **string[]** | Common follow-up questions | [optional]
**confidence** | **float** | Confidence in the guidance (0-100) | [optional]
**metadata** | [**\SoilSidekick\Model\BeginnerGuidanceMetadata**](BeginnerGuidanceMetadata.md) |  | [optional]
