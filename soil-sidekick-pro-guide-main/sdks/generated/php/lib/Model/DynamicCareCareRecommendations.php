...
/**
 * DynamicCareCareRecommendations Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class DynamicCareCareRecommendations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicCare_care_recommendations';
    ...
    protected static $openAPITypes = [
        'watering' => '\SoilSidekick\Model\DynamicCareCareRecommendationsWatering',
        'light' => '\SoilSidekick\Model\DynamicCareCareRecommendationsLight',
        'humidity' => '\SoilSidekick\Model\DynamicCareCareRecommendationsHumidity',
    ...
    protected static $setters = [
        ...
        'seasonal_notes' => 'setSeasonalNotes'
    ];
    ...
    protected static $getters = [
        ...
        'seasonal_notes' => 'getSeasonalNotes'
    ];
    ...
    {
        $this->setIfExists('watering', $data ?? [], null);
        $this->setIfExists('light', $data ?? [], null);
        $this->setIfExists('humidity', $data ?? [], null);
        $this->setIfExists('seasonal_notes', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets watering
     *
     * @return \SoilSidekick\Model\DynamicCareCareRecommendationsWatering|null
     */
    public function getWatering()
    {
        return $this->container['watering'];
    }

    /**
     * Sets watering
     *
     * @param \SoilSidekick\Model\DynamicCareCareRecommendationsWatering|null $watering watering
     *
     * @return self
     */
    ...
    {
        if (is_null($watering)) {
            throw new \InvalidArgumentException('non-nullable watering cannot be null');
        }
        $this->container['watering'] = $watering;
     ...
     * Gets light
     *
     * @return \SoilSidekick\Model\DynamicCareCareRecommendationsLight|null
     */
     ...
     * Sets light
     *
     * @param \SoilSidekick\Model\DynamicCareCareRecommendationsLight|null $light light
     *
     * @return self
     */
     ...
     * Gets humidity
     *
     * @return \SoilSidekick\Model\DynamicCareCareRecommendationsHumidity|null
     */
     ...
     * Sets humidity
     *
     * @param \SoilSidekick\Model\DynamicCareCareRecommendationsHumidity|null $humidity humidity
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getSeasonalNotes()
    {
        return $this->container['seasonal_notes'];
    }

    /**
     * Sets seasonal_notes
     *
     * @param string|null $seasonal_notes Season-specific care adjustments
     *
     * @return self
     */
    public function setSeasonalNotes($seasonal_notes)
    {
        if (is_null($seasonal_notes)) {
            throw new \InvalidArgumentException('non-nullable seasonal_notes cannot be null');
        }
        $this->container['seasonal_notes'] = $seasonal_notes;
