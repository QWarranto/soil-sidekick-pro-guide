...
/**
 * GenerateVRTPrescriptionRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GenerateVRTPrescriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'generateVRTPrescription_request';
    ...
    public const APPLICATION_TYPE_FERTILIZER = 'fertilizer';
    public const APPLICATION_TYPE_SEED = 'seed';
    public const APPLICATION_TYPE_PESTICIDE = 'pesticide';
    ...
    {
        return [
            self::APPLICATION_TYPE_FERTILIZER,
            self::APPLICATION_TYPE_SEED,
            self::APPLICATION_TYPE_PESTICIDE,
        ];
    }
    ...
    */
     ...
     *
     * @param string|null $soil_analysis_id soil_analysis_id
     *
     * @return self
     */
