...
/**
 * LiveAgriculturalDataData Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class LiveAgriculturalDataData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LiveAgriculturalData_data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('environmental', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets weather
     *
     * @param object|null $weather weather
     *
     * @return self
     */
     ...
     * Sets environmental
     *
     * @param object|null $environmental environmental
     *
     * @return self
     */
    public function setEnvironmental($environmental)
    {
        if (is_null($environmental)) {
            throw new \InvalidArgumentException('non-nullable environmental cannot be null');
        }
