...
/**
 * SeasonalPlanningResponseRecommendations Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class SeasonalPlanningResponseRecommendations implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SeasonalPlanningResponse_recommendations';
    ...
    protected static array $openAPINullables = [
        'seasonal_tasks' => false,
        'crop_recommendations' => false,
        'timing_guidance' => false
    ];
    ...
    protected static $setters = [
        'seasonal_tasks' => 'setSeasonalTasks',
        'crop_recommendations' => 'setCropRecommendations',
        'timing_guidance' => 'setTimingGuidance'
    ];
    ...
    protected static $getters = [
        'seasonal_tasks' => 'getSeasonalTasks',
        'crop_recommendations' => 'getCropRecommendations',
        'timing_guidance' => 'getTimingGuidance'
    ];
    ...
    {
        $this->setIfExists('seasonal_tasks', $data ?? [], null);
        $this->setIfExists('crop_recommendations', $data ?? [], null);
        $this->setIfExists('timing_guidance', $data ?? [], null);
    }
    ...
    */
     ...
     * @return object[]|null
     */
    public function getSeasonalTasks()
    {
        return $this->container['seasonal_tasks'];
    }

    /**
     * Sets seasonal_tasks
     *
     * @param object[]|null $seasonal_tasks seasonal_tasks
     *
     * @return self
     */
    public function setSeasonalTasks($seasonal_tasks)
    {
        if (is_null($seasonal_tasks)) {
            throw new \InvalidArgumentException('non-nullable seasonal_tasks cannot be null');
        }
        $this->container['seasonal_tasks'] = $seasonal_tasks;

        return $this;
    }

    /**
     * Gets crop_recommendations
     *
     * @return string[]|null
     */
    public function getCropRecommendations()
    {
        return $this->container['crop_recommendations'];
    }

    /**
     * Sets crop_recommendations
     *
     * @param string[]|null $crop_recommendations crop_recommendations
     *
     * @return self
     */
    public function setCropRecommendations($crop_recommendations)
    {
        if (is_null($crop_recommendations)) {
            throw new \InvalidArgumentException('non-nullable crop_recommendations cannot be null');
        }
        $this->container['crop_recommendations'] = $crop_recommendations;

        return $this;
    }

    /**
     * Gets timing_guidance
     *
     * @return object|null
     */
    public function getTimingGuidance()
    {
        return $this->container['timing_guidance'];
    }

    /**
     * Sets timing_guidance
     *
     * @param object|null $timing_guidance timing_guidance
     *
     * @return self
     */
    public function setTimingGuidance($timing_guidance)
    {
        if (is_null($timing_guidance)) {
            throw new \InvalidArgumentException('non-nullable timing_guidance cannot be null');
        }
        $this->container['timing_guidance'] = $timing_guidance;
