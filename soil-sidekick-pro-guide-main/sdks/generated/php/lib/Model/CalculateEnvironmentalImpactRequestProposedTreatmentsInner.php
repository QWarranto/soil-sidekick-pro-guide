...
/**
 * CalculateEnvironmentalImpactRequestProposedTreatmentsInner Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class CalculateEnvironmentalImpactRequestProposedTreatmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'calculateEnvironmentalImpact_request_proposed_treatments_inner';
    ...
    public const TYPE_NITROGEN_FERTILIZER = 'nitrogen_fertilizer';
    public const TYPE_PHOSPHORUS_FERTILIZER = 'phosphorus_fertilizer';
    ...
    {
        return [
            self::TYPE_NITROGEN_FERTILIZER,
            self::TYPE_PHOSPHORUS_FERTILIZER,
            self::TYPE_PESTICIDE,
        ];
    }
