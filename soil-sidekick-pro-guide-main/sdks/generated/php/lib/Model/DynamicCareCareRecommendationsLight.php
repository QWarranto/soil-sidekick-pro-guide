...
/**
 * DynamicCareCareRecommendationsLight Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class DynamicCareCareRecommendationsLight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicCare_care_recommendations_light';
    ...
    protected static $setters = [
        'current_assessment' => 'setCurrentAssessment',
        'adjustment_needed' => 'setAdjustmentNeeded',
    ...
    protected static $getters = [
        'current_assessment' => 'getCurrentAssessment',
        'adjustment_needed' => 'getAdjustmentNeeded',
    ...
    {
        $this->setIfExists('current_assessment', $data ?? [], null);
        $this->setIfExists('adjustment_needed', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets current_assessment
     *
     * @return string|null
     */
    public function getCurrentAssessment()
    {
        return $this->container['current_assessment'];
    }

    /**
     * Sets current_assessment
     *
     * @param string|null $current_assessment current_assessment
     *
     * @return self
     */
    public function setCurrentAssessment($current_assessment)
    {
        if (is_null($current_assessment)) {
            throw new \InvalidArgumentException('non-nullable current_assessment cannot be null');
        }
        $this->container['current_assessment'] = $current_assessment;

        return $this;
    }

    /**
     * Gets adjustment_needed
     *
     * @return bool|null
     */
    public function getAdjustmentNeeded()
    {
        return $this->container['adjustment_needed'];
    }

    /**
     * Sets adjustment_needed
     *
     * @param bool|null $adjustment_needed adjustment_needed
     *
     * @return self
     */
    public function setAdjustmentNeeded($adjustment_needed)
    {
        if (is_null($adjustment_needed)) {
            throw new \InvalidArgumentException('non-nullable adjustment_needed cannot be null');
        }
        $this->container['adjustment_needed'] = $adjustment_needed;
     ...
     * Sets recommendation
     *
     * @param string|null $recommendation recommendation
     *
     * @return self
     */
