...
/**
 * GetAgriculturalIntelligenceRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GetAgriculturalIntelligenceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getAgriculturalIntelligence_request';
    ...
    public const ANALYSIS_TYPE_CROP_RECOMMENDATION = 'crop_recommendation';
    public const ANALYSIS_TYPE_YIELD_PREDICTION = 'yield_prediction';
    public const ANALYSIS_TYPE_PEST_ANALYSIS = 'pest_analysis';
    ...
    {
        return [
            self::ANALYSIS_TYPE_CROP_RECOMMENDATION,
            self::ANALYSIS_TYPE_YIELD_PREDICTION,
            self::ANALYSIS_TYPE_PEST_ANALYSIS,
        ];
    }
    ...
    */
    ...
    public function setCountyFips($county_fips)
    {
        ...
        if ((!preg_match("/^[0-9]{5}$/", ObjectSerializer::toString($county_fips)))) {
            throw new \InvalidArgumentException("invalid value for \$county_fips when calling GetAgriculturalIntelligenceRequest., must conform to the pattern /^[0-9]{5}$/.");
        }
