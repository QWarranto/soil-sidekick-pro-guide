...
/**
 * SeasonalPlanningResponse Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class SeasonalPlanningResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SeasonalPlanningResponse';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'recommendations' => '\SoilSidekick\Model\SeasonalPlanningResponseRecommendations',
        'weather_data' => '\SoilSidekick\Model\SeasonalPlanningResponseWeatherData',
        'model_used' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('weather_data', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \SoilSidekick\Model\SeasonalPlanningResponseRecommendations|null
     */
     ...
     *
     * @param \SoilSidekick\Model\SeasonalPlanningResponseRecommendations|null $recommendations recommendations
     *
     * @return self
     */
     ...
     * Gets weather_data
     *
     * @return \SoilSidekick\Model\SeasonalPlanningResponseWeatherData|null
     */
    public function getWeatherData()
    {
        return $this->container['weather_data'];
    }

    /**
     * Sets weather_data
     *
     * @param \SoilSidekick\Model\SeasonalPlanningResponseWeatherData|null $weather_data weather_data
     *
     * @return self
     */
    public function setWeatherData($weather_data)
    {
        if (is_null($weather_data)) {
            throw new \InvalidArgumentException('non-nullable weather_data cannot be null');
        }
        $this->container['weather_data'] = $weather_data;
     ...
     * Sets model_used
     *
     * @param string|null $model_used model_used
     *
     * @return self
     */
