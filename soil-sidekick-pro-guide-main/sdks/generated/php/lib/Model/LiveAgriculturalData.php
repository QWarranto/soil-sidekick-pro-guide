...
/**
 * LiveAgriculturalData Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class LiveAgriculturalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LiveAgriculturalData';
    ...
    protected static $openAPITypes = [
        ...
        'county_name' => 'string',
        'state_code' => 'string',
        'data' => '\SoilSidekick\Model\LiveAgriculturalDataData',
        'sources' => 'string[]',
        'timestamp' => '\DateTime',
        'cache_status' => 'string'
    ];
    ...
    public const CACHE_STATUS_UPDATED = 'updated';
    public const CACHE_STATUS_FALLBACK = 'fallback';
    ...
    {
        return [
            self::CACHE_STATUS_UPDATED,
            self::CACHE_STATUS_FALLBACK,
        ];
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCacheStatusAllowableValues();
        if (!is_null($this->container['cache_status']) && !in_array($this->container['cache_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'cache_status', must be one of '%s'",
                $this->container['cache_status'],
     ...
     * Gets data
     *
     * @return \SoilSidekick\Model\LiveAgriculturalDataData|null
     */
     ...
     * Sets data
     *
     * @param \SoilSidekick\Model\LiveAgriculturalDataData|null $data data
     *
     * @return self
     */
    ...
    public function setCacheStatus($cache_status)
    {
        if (is_null($cache_status)) {
            throw new \InvalidArgumentException('non-nullable cache_status cannot be null');
        }
        $allowedValues = $this->getCacheStatusAllowableValues();
        if (!in_array($cache_status, $allowedValues, true)) {
