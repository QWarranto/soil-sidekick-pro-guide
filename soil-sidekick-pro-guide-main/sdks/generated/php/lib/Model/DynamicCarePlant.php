...
/**
 * DynamicCarePlant Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class DynamicCarePlant implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicCare_plant';
    ...
    protected static $setters = [
        ...
        'care_difficulty' => 'setCareDifficulty'
    ];
    ...
    protected static $getters = [
        ...
        'care_difficulty' => 'getCareDifficulty'
    ];
    ...
    public const CARE_DIFFICULTY_EASY = 'easy';
    public const CARE_DIFFICULTY_MODERATE = 'moderate';
    public const CARE_DIFFICULTY_CHALLENGING = 'challenging';
     ...
     * @return string[]
     */
    public function getCareDifficultyAllowableValues()
    {
        return [
            self::CARE_DIFFICULTY_EASY,
            self::CARE_DIFFICULTY_MODERATE,
            self::CARE_DIFFICULTY_CHALLENGING,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('care_difficulty', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getCareDifficultyAllowableValues();
        if (!is_null($this->container['care_difficulty']) && !in_array($this->container['care_difficulty'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'care_difficulty', must be one of '%s'",
                $this->container['care_difficulty'],
    ...
    /**
     * Gets care_difficulty
     *
     * @return string|null
     */
    public function getCareDifficulty()
    {
        return $this->container['care_difficulty'];
    }

    /**
     * Sets care_difficulty
     *
     * @param string|null $care_difficulty care_difficulty
     *
     * @return self
     */
    public function setCareDifficulty($care_difficulty)
    {
        if (is_null($care_difficulty)) {
            throw new \InvalidArgumentException('non-nullable care_difficulty cannot be null');
        }
        $allowedValues = $this->getCareDifficultyAllowableValues();
        if (!in_array($care_difficulty, $allowedValues, true)) {
        ...
        $this->container['care_difficulty'] = $care_difficulty;
