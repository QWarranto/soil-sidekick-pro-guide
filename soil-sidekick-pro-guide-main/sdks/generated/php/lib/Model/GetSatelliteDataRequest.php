...
/**
 * GetSatelliteDataRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class GetSatelliteDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getSatelliteData_request';
    ...
    */
    ...
    public function setLatitude($latitude)
    {
        ...
        if (($latitude > 90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling GetSatelliteDataRequest., must be smaller than or equal to 90.');
        }
        if (($latitude < -90)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling GetSatelliteDataRequest., must be bigger than or equal to -90.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (($longitude > 180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling GetSatelliteDataRequest., must be smaller than or equal to 180.');
        }
        if (($longitude < -180)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling GetSatelliteDataRequest., must be bigger than or equal to -180.');
        }
