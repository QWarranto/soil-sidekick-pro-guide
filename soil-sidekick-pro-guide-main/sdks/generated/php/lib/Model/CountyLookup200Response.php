...
/**
 * CountyLookup200Response Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class CountyLookup200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'countyLookup_200_response';
    ...
    protected static $openAPITypes = [
        'counties' => '\SoilSidekick\Model\County[]'
    ];
    ...
    {
        $this->setIfExists('counties', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets counties
     *
     * @return \SoilSidekick\Model\County[]|null
     */
     ...
     * Sets counties
     *
     * @param \SoilSidekick\Model\County[]|null $counties counties
     *
     * @return self
     */
    ...
    {
        if (is_null($counties)) {
            throw new \InvalidArgumentException('non-nullable counties cannot be null');
        }
