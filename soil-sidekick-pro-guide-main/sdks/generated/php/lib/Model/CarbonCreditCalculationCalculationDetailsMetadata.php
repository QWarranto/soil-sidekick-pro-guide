...
/**
 * CarbonCreditCalculationCalculationDetailsMetadata Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class CarbonCreditCalculationCalculationDetailsMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CarbonCreditCalculation_calculation_details_metadata';
    ...
    protected static $setters = [
        'calculation_factors' => 'setCalculationFactors',
    ...
    protected static $getters = [
        'calculation_factors' => 'getCalculationFactors',
    ...
    {
        $this->setIfExists('calculation_factors', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets calculation_factors
     *
     * @return object|null
     */
    public function getCalculationFactors()
    {
        return $this->container['calculation_factors'];
    }

    /**
     * Sets calculation_factors
     *
     * @param object|null $calculation_factors calculation_factors
     *
     * @return self
     */
    public function setCalculationFactors($calculation_factors)
    {
        if (is_null($calculation_factors)) {
            throw new \InvalidArgumentException('non-nullable calculation_factors cannot be null');
        }
        $this->container['calculation_factors'] = $calculation_factors;
     ...
     * Sets data_sources
     *
     * @param string[]|null $data_sources data_sources
     *
     * @return self
     */
