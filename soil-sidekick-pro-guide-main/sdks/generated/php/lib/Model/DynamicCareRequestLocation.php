...
/**
 * DynamicCareRequestLocation Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class DynamicCareRequestLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'dynamicCare_request_location';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('indoor', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCountyFips($county_fips)
    {
        ...
        if ((!preg_match("/^[0-9]{5}$/", ObjectSerializer::toString($county_fips)))) {
            throw new \InvalidArgumentException("invalid value for \$county_fips when calling DynamicCareRequestLocation., must conform to the pattern /^[0-9]{5}$/.");
        }
    ...
    {
        return $this->container['indoor'];
    }

    /**
     * Sets indoor
     *
     * @param bool|null $indoor Whether the plant is indoors
     *
     * @return self
     */
    ...
    {
        if (is_null($indoor)) {
            throw new \InvalidArgumentException('non-nullable indoor cannot be null');
        }
        $this->container['indoor'] = $indoor;
