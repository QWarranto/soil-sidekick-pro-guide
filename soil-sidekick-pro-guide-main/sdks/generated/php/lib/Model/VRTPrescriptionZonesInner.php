...
/**
 * VRTPrescriptionZonesInner Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class VRTPrescriptionZonesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VRTPrescription_zones_inner';
    ...
    protected static $setters = [
        'zone_id' => 'setZoneId',
        'application_rate' => 'setApplicationRate',
    ...
    protected static $getters = [
        'zone_id' => 'getZoneId',
        'application_rate' => 'getApplicationRate',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('application_rate', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets application_rate
     *
     * @return float|null
     */
    public function getApplicationRate()
    {
        return $this->container['application_rate'];
    }

    /**
     * Sets application_rate
     *
     * @param float|null $application_rate application_rate
     *
     * @return self
     */
    public function setApplicationRate($application_rate)
    {
        if (is_null($application_rate)) {
            throw new \InvalidArgumentException('non-nullable application_rate cannot be null');
        }
        $this->container['application_rate'] = $application_rate;
