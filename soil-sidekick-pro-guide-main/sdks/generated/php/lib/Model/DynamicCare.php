 ...
 */
class DynamicCare implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DynamicCare';
    ...
    protected static $openAPITypes = [
        'success' => 'bool',
        'plant' => '\SoilSidekick\Model\DynamicCarePlant',
        'current_conditions' => '\SoilSidekick\Model\DynamicCareCurrentConditions',
        'care_recommendations' => '\SoilSidekick\Model\DynamicCareCareRecommendations',
        'warnings' => 'string[]',
        'metadata' => '\SoilSidekick\Model\DynamicCareMetadata'
    ];
    ...
    protected static $setters = [
        'success' => 'setSuccess',
        'plant' => 'setPlant',
        'current_conditions' => 'setCurrentConditions',
        'care_recommendations' => 'setCareRecommendations',
    ...
    protected static $getters = [
        'success' => 'getSuccess',
        'plant' => 'getPlant',
        'current_conditions' => 'getCurrentConditions',
        'care_recommendations' => 'getCareRecommendations',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('current_conditions', $data ?? [], null);
        $this->setIfExists('care_recommendations', $data ?? [], null);
    ...
    */
     ...
     * Gets plant
     *
     * @return \SoilSidekick\Model\DynamicCarePlant|null
     */
     ...
     * Sets plant
     *
     * @param \SoilSidekick\Model\DynamicCarePlant|null $plant plant
     *
     * @return self
     */
    ...
    /**
     * Gets current_conditions
     *
     * @return \SoilSidekick\Model\DynamicCareCurrentConditions|null
     */
    public function getCurrentConditions()
    {
        return $this->container['current_conditions'];
    }

    /**
     * Sets current_conditions
     *
     * @param \SoilSidekick\Model\DynamicCareCurrentConditions|null $current_conditions current_conditions
     *
     * @return self
     */
    public function setCurrentConditions($current_conditions)
    {
        if (is_null($current_conditions)) {
            throw new \InvalidArgumentException('non-nullable current_conditions cannot be null');
        }
        $this->container['current_conditions'] = $current_conditions;

        return $this;
    }

    /**
     * Gets care_recommendations
     *
     * @return \SoilSidekick\Model\DynamicCareCareRecommendations|null
     */
    public function getCareRecommendations()
    {
        return $this->container['care_recommendations'];
    }

    /**
     * Sets care_recommendations
     *
     * @param \SoilSidekick\Model\DynamicCareCareRecommendations|null $care_recommendations care_recommendations
     *
     * @return self
     */
    public function setCareRecommendations($care_recommendations)
    {
        if (is_null($care_recommendations)) {
            throw new \InvalidArgumentException('non-nullable care_recommendations cannot be null');
        }
        $this->container['care_recommendations'] = $care_recommendations;
     ...
     * Sets warnings
     *
     * @param string[]|null $warnings Any urgent care warnings
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \SoilSidekick\Model\DynamicCareMetadata|null
     */
     ...
     * Sets metadata
     *
     * @param \SoilSidekick\Model\DynamicCareMetadata|null $metadata metadata
     *
     * @return self
     */
