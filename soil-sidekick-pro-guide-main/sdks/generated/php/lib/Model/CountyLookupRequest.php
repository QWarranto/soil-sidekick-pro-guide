...
/**
 * CountyLookupRequest Class Doc Comment
 *
 * @category Class
 * @package  SoilSidekick
 * @author   OpenAPI Generator team
 ...
 */
class CountyLookupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'countyLookup_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['term']) > 100)) {
            $invalidProperties[] = "invalid value for 'term', the character length must be smaller than or equal to 100.";
        }
     ...
     * Sets term
     *
     * @param string $term Search term (county name, state, or FIPS)
     *
     * @return self
     */
    public function setTerm($term)
    {
        ...
        if ((mb_strlen($term) > 100)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CountyLookupRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($term) < 2)) {
            throw new \InvalidArgumentException('invalid length for $term when calling CountyLookupRequest., must be bigger than or equal to 2.');
        }
