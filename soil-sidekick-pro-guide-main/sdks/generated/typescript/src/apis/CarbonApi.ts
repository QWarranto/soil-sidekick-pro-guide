...
import {
    CalculateCarbonCreditsRequestFromJSON,
    CalculateCarbonCreditsRequestToJSON,
    CarbonCreditCalculationFromJSON,
    CarbonCreditCalculationToJSON,
} from '../models/index';
...
export class CarbonApi extends runtime.BaseAPI {
     ...
     */
    async calculateCarbonCreditsRaw(requestParameters: CalculateCarbonCreditsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CarbonCreditCalculation>> {
        if (requestParameters.calculateCarbonCreditsRequest === null || requestParameters.calculateCarbonCreditsRequest === undefined) {
            throw new runtime.RequiredError('calculateCarbonCreditsRequest','Required parameter requestParameters.calculateCarbonCreditsRequest was null or undefined when calling calculateCarbonCredits.');
        }
        ...
        const response = await this.request({
            ...
            body: CalculateCarbonCreditsRequestToJSON(requestParameters.calculateCarbonCreditsRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CarbonCreditCalculationFromJSON(jsonValue));
    }
     ...
     * Calculate carbon credits
     */
    async calculateCarbonCredits(requestParameters: CalculateCarbonCreditsOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CarbonCreditCalculation> {
        const response = await this.calculateCarbonCreditsRaw(requestParameters, initOverrides);
