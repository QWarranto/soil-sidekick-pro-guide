...
import {
    GetSatelliteDataRequestFromJSON,
    GetSatelliteDataRequestToJSON,
    SatelliteDataFromJSON,
    SatelliteDataToJSON,
} from '../models/index';
...
export class SatelliteDataApi extends runtime.BaseAPI {
     ...
     */
    async getSatelliteDataRaw(requestParameters: GetSatelliteDataOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SatelliteData>> {
        if (requestParameters.getSatelliteDataRequest === null || requestParameters.getSatelliteDataRequest === undefined) {
            throw new runtime.RequiredError('getSatelliteDataRequest','Required parameter requestParameters.getSatelliteDataRequest was null or undefined when calling getSatelliteData.');
        }
     ...
     * Get satellite environmental data
     */
    async getSatelliteData(requestParameters: GetSatelliteDataOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SatelliteData> {
        const response = await this.getSatelliteDataRaw(requestParameters, initOverrides);
