...
import {
    CountyLookup200ResponseFromJSON,
    CountyLookup200ResponseToJSON,
    CountyLookupRequestFromJSON,
    CountyLookupRequestToJSON,
} from '../models/index';
 ...
 * 
 */
export class GeographicApi extends runtime.BaseAPI {

    /**
     * Search counties by name, state, or FIPS code
     * Search for counties
     */
    async countyLookupRaw(requestParameters: CountyLookupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CountyLookup200Response>> {
        if (requestParameters.countyLookupRequest === null || requestParameters.countyLookupRequest === undefined) {
            throw new runtime.RequiredError('countyLookupRequest','Required parameter requestParameters.countyLookupRequest was null or undefined when calling countyLookup.');
        }
        ...
        const response = await this.request({
            ...
            body: CountyLookupRequestToJSON(requestParameters.countyLookupRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CountyLookup200ResponseFromJSON(jsonValue));
    }
     ...
     * Search for counties
     */
    async countyLookup(requestParameters: CountyLookupOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CountyLookup200Response> {
        const response = await this.countyLookupRaw(requestParameters, initOverrides);
