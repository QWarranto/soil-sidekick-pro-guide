...
import {
    CalculateEnvironmentalImpactRequestFromJSON,
    CalculateEnvironmentalImpactRequestToJSON,
 ...
 * 
 */
export class EnvironmentalApi extends runtime.BaseAPI {

    /**
     * Assess environmental impact including runoff risk, contamination, and eco-friendly alternatives
     * Calculate environmental impact
     */
    async calculateEnvironmentalImpactRaw(requestParameters: CalculateEnvironmentalImpactOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EnvironmentalImpact>> {
        if (requestParameters.calculateEnvironmentalImpactRequest === null || requestParameters.calculateEnvironmentalImpactRequest === undefined) {
            throw new runtime.RequiredError('calculateEnvironmentalImpactRequest','Required parameter requestParameters.calculateEnvironmentalImpactRequest was null or undefined when calling calculateEnvironmentalImpact.');
        }
        ...
        const response = await this.request({
            ...
            body: CalculateEnvironmentalImpactRequestToJSON(requestParameters.calculateEnvironmentalImpactRequest),
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => EnvironmentalImpactFromJSON(jsonValue));
    }
     ...
     * Calculate environmental impact
     */
    async calculateEnvironmentalImpact(requestParameters: CalculateEnvironmentalImpactOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EnvironmentalImpact> {
        const response = await this.calculateEnvironmentalImpactRaw(requestParameters, initOverrides);
