 ...
 */
export function instanceOfLeafenginesQueryRequestLocation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LeafenginesQueryRequestLocationFromJSON(json: any): LeafenginesQueryRequestLocation {
    return LeafenginesQueryRequestLocationFromJSONTyped(json, false);
}

export function LeafenginesQueryRequestLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafenginesQueryRequestLocation {
...
export function LeafenginesQueryRequestLocationToJSON(value?: LeafenginesQueryRequestLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
