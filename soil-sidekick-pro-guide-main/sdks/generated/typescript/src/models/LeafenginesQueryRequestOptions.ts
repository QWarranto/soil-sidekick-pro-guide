 ...
 */
export function instanceOfLeafenginesQueryRequestOptions(value: object): boolean {
    let isInstance = true;
...
export function LeafenginesQueryRequestOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafenginesQueryRequestOptions {
    ...
    return {
        ...
        'includeSatelliteData': !exists(json, 'include_satellite_data') ? undefined : json['include_satellite_data'],
        'includeWaterQuality': !exists(json, 'include_water_quality') ? undefined : json['include_water_quality'],
        'includeRecommendations': !exists(json, 'include_recommendations') ? undefined : json['include_recommendations'],
    };
}

export function LeafenginesQueryRequestOptionsToJSON(value?: LeafenginesQueryRequestOptions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
