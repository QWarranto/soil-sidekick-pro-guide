 ...
 * 
 * @export
 * @interface SafeIdentificationRequestLocationCoordinates
 */
export interface SafeIdentificationRequestLocationCoordinates {
    /**
     * 
     * @type {number}
     * @memberof SafeIdentificationRequestLocationCoordinates
     */
    latitude?: number;
    /**
     * 
...
/**
 * Check if a given object implements the SafeIdentificationRequestLocationCoordinates interface.
 */
export function instanceOfSafeIdentificationRequestLocationCoordinates(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationRequestLocationCoordinatesFromJSON(json: any): SafeIdentificationRequestLocationCoordinates {
    return SafeIdentificationRequestLocationCoordinatesFromJSONTyped(json, false);
}

export function SafeIdentificationRequestLocationCoordinatesFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationRequestLocationCoordinates {
...
export function SafeIdentificationRequestLocationCoordinatesToJSON(value?: SafeIdentificationRequestLocationCoordinates | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
