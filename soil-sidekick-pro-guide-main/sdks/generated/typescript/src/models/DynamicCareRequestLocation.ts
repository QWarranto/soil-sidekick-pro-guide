 ...
 * 
 * @export
 * @interface DynamicCareRequestLocation
 */
export interface DynamicCareRequestLocation {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareRequestLocation
     */
    countyFips: string;
    /**
     * 
...
/**
 * Check if a given object implements the DynamicCareRequestLocation interface.
 */
export function instanceOfDynamicCareRequestLocation(value: object): boolean {
    let isInstance = true;
...
export function DynamicCareRequestLocationFromJSON(json: any): DynamicCareRequestLocation {
    return DynamicCareRequestLocationFromJSONTyped(json, false);
}

export function DynamicCareRequestLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareRequestLocation {
...
export function DynamicCareRequestLocationToJSON(value?: DynamicCareRequestLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
