 ...
 */
export function instanceOfEnvironmentalImpactDetailedAnalysis(value: object): boolean {
    let isInstance = true;
...
export function EnvironmentalImpactDetailedAnalysisFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentalImpactDetailedAnalysis {
    ...
    return {
        ...
        'runoffRisk': !exists(json, 'runoff_risk') ? undefined : EnvironmentalImpactDetailedAnalysisRunoffRiskFromJSON(json['runoff_risk']),
        'contaminationAssessment': !exists(json, 'contamination_assessment') ? undefined : json['contamination_assessment'],
        'ecoAlternatives': !exists(json, 'eco_alternatives') ? undefined : EnvironmentalImpactDetailedAnalysisEcoAlternativesFromJSON(json['eco_alternatives']),
        'carbonAnalysis': !exists(json, 'carbon_analysis') ? undefined : json['carbon_analysis'],
        'biodiversityAssessment': !exists(json, 'biodiversity_assessment') ? undefined : json['biodiversity_assessment'],
    };
}

export function EnvironmentalImpactDetailedAnalysisToJSON(value?: EnvironmentalImpactDetailedAnalysis | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
