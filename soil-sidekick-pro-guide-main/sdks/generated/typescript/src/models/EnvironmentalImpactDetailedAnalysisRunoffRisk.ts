 ...
 * 
 * @export
 * @interface EnvironmentalImpactDetailedAnalysisRunoffRisk
 */
export interface EnvironmentalImpactDetailedAnalysisRunoffRisk {
    /**
     * 
     * @type {number}
     * @memberof EnvironmentalImpactDetailedAnalysisRunoffRisk
     */
    score?: number;
    /**
     * 
     ...
     * @memberof EnvironmentalImpactDetailedAnalysisRunoffRisk
     */
    riskLevel?: EnvironmentalImpactDetailedAnalysisRunoffRiskRiskLevelEnum;
    /**
     * 
     * @type {object}
     * @memberof EnvironmentalImpactDetailedAnalysisRunoffRisk
 ...
 * @export
 */
export const EnvironmentalImpactDetailedAnalysisRunoffRiskRiskLevelEnum = {
    Low: 'low',
    Medium: 'medium',
    High: 'high'
} as const;
export type EnvironmentalImpactDetailedAnalysisRunoffRiskRiskLevelEnum = typeof EnvironmentalImpactDetailedAnalysisRunoffRiskRiskLevelEnum[keyof typeof EnvironmentalImpactDetailedAnalysisRunoffRiskRiskLevelEnum];


/**
 * Check if a given object implements the EnvironmentalImpactDetailedAnalysisRunoffRisk interface.
 */
export function instanceOfEnvironmentalImpactDetailedAnalysisRunoffRisk(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function EnvironmentalImpactDetailedAnalysisRunoffRiskFromJSON(json: any): EnvironmentalImpactDetailedAnalysisRunoffRisk {
    return EnvironmentalImpactDetailedAnalysisRunoffRiskFromJSONTyped(json, false);
}

export function EnvironmentalImpactDetailedAnalysisRunoffRiskFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentalImpactDetailedAnalysisRunoffRisk {
    ...
    return {
        ...
        'contributingFactors': !exists(json, 'contributing_factors') ? undefined : json['contributing_factors'],
    };
}

export function EnvironmentalImpactDetailedAnalysisRunoffRiskToJSON(value?: EnvironmentalImpactDetailedAnalysisRunoffRisk | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'contributing_factors': value.contributingFactors,
    };
}
