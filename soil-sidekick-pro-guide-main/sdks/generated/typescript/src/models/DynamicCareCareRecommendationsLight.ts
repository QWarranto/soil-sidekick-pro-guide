 ...
 * 
 * @export
 * @interface DynamicCareCareRecommendationsLight
 */
export interface DynamicCareCareRecommendationsLight {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareCareRecommendationsLight
     */
...
/**
 * Check if a given object implements the DynamicCareCareRecommendationsLight interface.
 */
export function instanceOfDynamicCareCareRecommendationsLight(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareCareRecommendationsLightFromJSON(json: any): DynamicCareCareRecommendationsLight {
    return DynamicCareCareRecommendationsLightFromJSONTyped(json, false);
}

export function DynamicCareCareRecommendationsLightFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareCareRecommendationsLight {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'currentAssessment': !exists(json, 'current_assessment') ? undefined : json['current_assessment'],
        'adjustmentNeeded': !exists(json, 'adjustment_needed') ? undefined : json['adjustment_needed'],
        'recommendation': !exists(json, 'recommendation') ? undefined : json['recommendation'],
    };
}

export function DynamicCareCareRecommendationsLightToJSON(value?: DynamicCareCareRecommendationsLight | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'current_assessment': value.currentAssessment,
        'adjustment_needed': value.adjustmentNeeded,
