 ...
 * - starter: Gemma 2B on 1GB+ devices
 * - professional: Gemma 7B on 4GB+ devices
 * - enterprise: Bitnet 70B/100B on 8GB+/12GB+ devices
 * 
 * @export
 */
export const TQModelTier = {
    Starter: 'starter',
    Professional: 'professional',
    Enterprise: 'enterprise'
} as const;
export type TQModelTier = typeof TQModelTier[keyof typeof TQModelTier];


export function TQModelTierFromJSON(json: any): TQModelTier {
    return TQModelTierFromJSONTyped(json, false);
}

export function TQModelTierFromJSONTyped(json: any, ignoreDiscriminator: boolean): TQModelTier {
    return json as TQModelTier;
}

export function TQModelTierToJSON(value?: TQModelTier | null): any {
    return value as any;
}
