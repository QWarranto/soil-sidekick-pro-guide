 ...
 * @export
 */
export const GetLiveAgriculturalDataRequestDataTypesEnum = {
    Weather: 'weather',
    Soil: 'soil',
    Crop: 'crop',
 ...
 */
export function instanceOfGetLiveAgriculturalDataRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "countyFips" in value;
    isInstance = isInstance && "dataTypes" in value;
    isInstance = isInstance && "stateCode" in value;
    isInstance = isInstance && "countyName" in value;

    return isInstance;
}

export function GetLiveAgriculturalDataRequestFromJSON(json: any): GetLiveAgriculturalDataRequest {
    return GetLiveAgriculturalDataRequestFromJSONTyped(json, false);
}

export function GetLiveAgriculturalDataRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetLiveAgriculturalDataRequest {
...
export function GetLiveAgriculturalDataRequestToJSON(value?: GetLiveAgriculturalDataRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
