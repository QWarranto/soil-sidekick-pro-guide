 ...
 * 
 * @export
 * @interface BeginnerGuidanceRequestLocation
 */
export interface BeginnerGuidanceRequestLocation {
    /**
     * 
     * @type {string}
     * @memberof BeginnerGuidanceRequestLocation
     */
    countyFips?: string;
    /**
     * 
...
/**
 * Check if a given object implements the BeginnerGuidanceRequestLocation interface.
 */
export function instanceOfBeginnerGuidanceRequestLocation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BeginnerGuidanceRequestLocationFromJSON(json: any): BeginnerGuidanceRequestLocation {
    return BeginnerGuidanceRequestLocationFromJSONTyped(json, false);
}

export function BeginnerGuidanceRequestLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeginnerGuidanceRequestLocation {
    ...
    return {
        ...
        'indoor': !exists(json, 'indoor') ? undefined : json['indoor'],
    };
}

export function BeginnerGuidanceRequestLocationToJSON(value?: BeginnerGuidanceRequestLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
