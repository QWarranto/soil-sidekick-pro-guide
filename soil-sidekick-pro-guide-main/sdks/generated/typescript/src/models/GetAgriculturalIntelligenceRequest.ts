 ...
 * @export
 */
export const GetAgriculturalIntelligenceRequestAnalysisTypeEnum = {
 ...
 */
export function instanceOfGetAgriculturalIntelligenceRequest(value: object): boolean {
    let isInstance = true;
...
export function GetAgriculturalIntelligenceRequestFromJSON(json: any): GetAgriculturalIntelligenceRequest {
    return GetAgriculturalIntelligenceRequestFromJSONTyped(json, false);
}

export function GetAgriculturalIntelligenceRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetAgriculturalIntelligenceRequest {
...
export function GetAgriculturalIntelligenceRequestToJSON(value?: GetAgriculturalIntelligenceRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
