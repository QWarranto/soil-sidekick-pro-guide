 ...
 * 
 * @export
 * @interface BeginnerGuidanceRequestPlantContext
 */
export interface BeginnerGuidanceRequestPlantContext {
    /**
     * Common plant name if known
     * @type {string}
     * @memberof BeginnerGuidanceRequestPlantContext
     */
    plantName?: string;
    /**
...
/**
 * Check if a given object implements the BeginnerGuidanceRequestPlantContext interface.
 */
export function instanceOfBeginnerGuidanceRequestPlantContext(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BeginnerGuidanceRequestPlantContextFromJSON(json: any): BeginnerGuidanceRequestPlantContext {
    return BeginnerGuidanceRequestPlantContextFromJSONTyped(json, false);
}

export function BeginnerGuidanceRequestPlantContextFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeginnerGuidanceRequestPlantContext {
...
export function BeginnerGuidanceRequestPlantContextToJSON(value?: BeginnerGuidanceRequestPlantContext | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
