...
import type { VisualCropAnalysisAnalysis } from './VisualCropAnalysisAnalysis';
import {
    VisualCropAnalysisAnalysisFromJSON,
    VisualCropAnalysisAnalysisFromJSONTyped,
    VisualCropAnalysisAnalysisToJSON,
} from './VisualCropAnalysisAnalysis';

/**
 * 
 * @export
 * @interface VisualCropAnalysis
 */
export interface VisualCropAnalysis {
    /**
     * 
     * @type {boolean}
     * @memberof VisualCropAnalysis
     */
    success?: boolean;
    /**
     * 
     * @type {VisualCropAnalysisAnalysis}
     * @memberof VisualCropAnalysis
     */
    analysis?: VisualCropAnalysisAnalysis;
    /**
     * 
     * @type {string}
     * @memberof VisualCropAnalysis
...
/**
 * Check if a given object implements the VisualCropAnalysis interface.
 */
export function instanceOfVisualCropAnalysis(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VisualCropAnalysisFromJSON(json: any): VisualCropAnalysis {
    return VisualCropAnalysisFromJSONTyped(json, false);
}

export function VisualCropAnalysisFromJSONTyped(json: any, ignoreDiscriminator: boolean): VisualCropAnalysis {
    ...
    return {
        ...
        'analysis': !exists(json, 'analysis') ? undefined : VisualCropAnalysisAnalysisFromJSON(json['analysis']),
        'analysisId': !exists(json, 'analysis_id') ? undefined : json['analysis_id'],
        'timestamp': !exists(json, 'timestamp') ? undefined : (new Date(json['timestamp'])),
    };
}

export function VisualCropAnalysisToJSON(value?: VisualCropAnalysis | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'analysis': VisualCropAnalysisAnalysisToJSON(value.analysis),
