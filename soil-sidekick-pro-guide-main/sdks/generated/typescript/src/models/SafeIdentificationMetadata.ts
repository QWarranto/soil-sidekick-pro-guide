 ...
 * 
 * @export
 * @interface SafeIdentificationMetadata
 */
export interface SafeIdentificationMetadata {
    /**
     * 
     * @type {string}
     ...
     * @memberof SafeIdentificationMetadata
     */
    environmentalDataUsed?: Array<string>;
}

/**
 * Check if a given object implements the SafeIdentificationMetadata interface.
 */
export function instanceOfSafeIdentificationMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationMetadataFromJSON(json: any): SafeIdentificationMetadata {
    return SafeIdentificationMetadataFromJSONTyped(json, false);
}

export function SafeIdentificationMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationMetadata {
    ...
    return {
        ...
        'environmentalDataUsed': !exists(json, 'environmental_data_used') ? undefined : json['environmental_data_used'],
    };
}

export function SafeIdentificationMetadataToJSON(value?: SafeIdentificationMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'environmental_data_used': value.environmentalDataUsed,
    };
}
