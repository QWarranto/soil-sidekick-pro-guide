...
import type { SeasonalPlanningResponseRecommendations } from './SeasonalPlanningResponseRecommendations';
import {
    SeasonalPlanningResponseRecommendationsFromJSON,
    SeasonalPlanningResponseRecommendationsFromJSONTyped,
    SeasonalPlanningResponseRecommendationsToJSON,
} from './SeasonalPlanningResponseRecommendations';
import type { SeasonalPlanningResponseWeatherData } from './SeasonalPlanningResponseWeatherData';
import {
    SeasonalPlanningResponseWeatherDataFromJSON,
    SeasonalPlanningResponseWeatherDataFromJSONTyped,
    SeasonalPlanningResponseWeatherDataToJSON,
} from './SeasonalPlanningResponseWeatherData';

/**
 * 
 * @export
 * @interface SeasonalPlanningResponse
 */
export interface SeasonalPlanningResponse {
    /**
     * 
     * @type {boolean}
     * @memberof SeasonalPlanningResponse
     */
    success?: boolean;
    /**
     * 
     * @type {SeasonalPlanningResponseRecommendations}
     * @memberof SeasonalPlanningResponse
     */
    recommendations?: SeasonalPlanningResponseRecommendations;
    /**
     * 
     * @type {SeasonalPlanningResponseWeatherData}
     * @memberof SeasonalPlanningResponse
     */
    weatherData?: SeasonalPlanningResponseWeatherData;
    /**
     * 
     * @type {string}
     * @memberof SeasonalPlanningResponse
...
/**
 * Check if a given object implements the SeasonalPlanningResponse interface.
 */
export function instanceOfSeasonalPlanningResponse(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SeasonalPlanningResponseFromJSON(json: any): SeasonalPlanningResponse {
    return SeasonalPlanningResponseFromJSONTyped(json, false);
}

export function SeasonalPlanningResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SeasonalPlanningResponse {
    ...
    return {
        ...
        'recommendations': !exists(json, 'recommendations') ? undefined : SeasonalPlanningResponseRecommendationsFromJSON(json['recommendations']),
        'weatherData': !exists(json, 'weatherData') ? undefined : SeasonalPlanningResponseWeatherDataFromJSON(json['weatherData']),
        'modelUsed': !exists(json, 'modelUsed') ? undefined : json['modelUsed'],
    };
}

export function SeasonalPlanningResponseToJSON(value?: SeasonalPlanningResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'recommendations': SeasonalPlanningResponseRecommendationsToJSON(value.recommendations),
        'weatherData': SeasonalPlanningResponseWeatherDataToJSON(value.weatherData),
