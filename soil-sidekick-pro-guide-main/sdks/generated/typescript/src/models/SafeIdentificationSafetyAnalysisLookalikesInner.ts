 ...
 * 
 * @export
 * @interface SafeIdentificationSafetyAnalysisLookalikesInner
 */
export interface SafeIdentificationSafetyAnalysisLookalikesInner {
    /**
     * 
     * @type {string}
     * @memberof SafeIdentificationSafetyAnalysisLookalikesInner
     */
    plantName?: string;
    /**
...
/**
 * Check if a given object implements the SafeIdentificationSafetyAnalysisLookalikesInner interface.
 */
export function instanceOfSafeIdentificationSafetyAnalysisLookalikesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationSafetyAnalysisLookalikesInnerFromJSON(json: any): SafeIdentificationSafetyAnalysisLookalikesInner {
    return SafeIdentificationSafetyAnalysisLookalikesInnerFromJSONTyped(json, false);
}

export function SafeIdentificationSafetyAnalysisLookalikesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationSafetyAnalysisLookalikesInner {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'plantName': !exists(json, 'plant_name') ? undefined : json['plant_name'],
        'visualSimilarity': !exists(json, 'visual_similarity') ? undefined : json['visual_similarity'],
        'toxicityLevel': !exists(json, 'toxicity_level') ? undefined : json['toxicity_level'],
        'distinguishingFeatures': !exists(json, 'distinguishing_features') ? undefined : json['distinguishing_features'],
    };
}

export function SafeIdentificationSafetyAnalysisLookalikesInnerToJSON(value?: SafeIdentificationSafetyAnalysisLookalikesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'visual_similarity': value.visualSimilarity,
        'toxicity_level': value.toxicityLevel,
        'distinguishing_features': value.distinguishingFeatures,
    };
}
