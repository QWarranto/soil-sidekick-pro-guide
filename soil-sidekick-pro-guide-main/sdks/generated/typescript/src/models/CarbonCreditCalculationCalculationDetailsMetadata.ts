 ...
 * 
 * @export
 * @interface CarbonCreditCalculationCalculationDetailsMetadata
 */
export interface CarbonCreditCalculationCalculationDetailsMetadata {
    /**
     * 
     * @type {object}
     * @memberof CarbonCreditCalculationCalculationDetailsMetadata
     */
...
/**
 * Check if a given object implements the CarbonCreditCalculationCalculationDetailsMetadata interface.
 */
export function instanceOfCarbonCreditCalculationCalculationDetailsMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CarbonCreditCalculationCalculationDetailsMetadataFromJSON(json: any): CarbonCreditCalculationCalculationDetailsMetadata {
    return CarbonCreditCalculationCalculationDetailsMetadataFromJSONTyped(json, false);
}

export function CarbonCreditCalculationCalculationDetailsMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CarbonCreditCalculationCalculationDetailsMetadata {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'calculationFactors': !exists(json, 'calculation_factors') ? undefined : json['calculation_factors'],
        'dataSources': !exists(json, 'data_sources') ? undefined : json['data_sources'],
        'confidenceScore': !exists(json, 'confidence_score') ? undefined : json['confidence_score'],
    };
}

export function CarbonCreditCalculationCalculationDetailsMetadataToJSON(value?: CarbonCreditCalculationCalculationDetailsMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'calculation_factors': value.calculationFactors,
