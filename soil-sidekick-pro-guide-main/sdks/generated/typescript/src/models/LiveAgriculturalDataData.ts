 ...
 */
export function instanceOfLiveAgriculturalDataData(value: object): boolean {
    let isInstance = true;
...
export function LiveAgriculturalDataDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): LiveAgriculturalDataData {
    ...
    return {
        ...
        'soil': !exists(json, 'soil') ? undefined : json['soil'],
        'crop': !exists(json, 'crop') ? undefined : json['crop'],
        'environmental': !exists(json, 'environmental') ? undefined : json['environmental'],
    };
}

export function LiveAgriculturalDataDataToJSON(value?: LiveAgriculturalDataData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
