 ...
 */
export function instanceOfSmartReportSummarySummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SmartReportSummarySummaryFromJSON(json: any): SmartReportSummarySummary {
    return SmartReportSummarySummaryFromJSONTyped(json, false);
}

export function SmartReportSummarySummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): SmartReportSummarySummary {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'executiveSummary': !exists(json, 'executive_summary') ? undefined : json['executive_summary'],
        'keyFindings': !exists(json, 'key_findings') ? undefined : json['key_findings'],
        'recommendations': !exists(json, 'recommendations') ? undefined : json['recommendations'],
        'riskAssessment': !exists(json, 'risk_assessment') ? undefined : json['risk_assessment'],
    };
}

export function SmartReportSummarySummaryToJSON(value?: SmartReportSummarySummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
