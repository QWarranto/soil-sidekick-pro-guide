 ...
 */
export function instanceOfTerritorialWaterAnalyticsAnalytics(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TerritorialWaterAnalyticsAnalyticsFromJSON(json: any): TerritorialWaterAnalyticsAnalytics {
    return TerritorialWaterAnalyticsAnalyticsFromJSONTyped(json, false);
}

export function TerritorialWaterAnalyticsAnalyticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerritorialWaterAnalyticsAnalytics {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'territorialCoverage': !exists(json, 'territorial_coverage') ? undefined : json['territorial_coverage'],
        'waterQualityMetrics': !exists(json, 'water_quality_metrics') ? undefined : json['water_quality_metrics'],
        'regionalInsights': !exists(json, 'regional_insights') ? undefined : json['regional_insights'],
        'complianceStatus': !exists(json, 'compliance_status') ? undefined : json['compliance_status'],
    };
}

export function TerritorialWaterAnalyticsAnalyticsToJSON(value?: TerritorialWaterAnalyticsAnalytics | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
