...
/**
 * Check if a given object implements the SatelliteData interface.
 */
export function instanceOfSatelliteData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SatelliteDataFromJSON(json: any): SatelliteData {
    return SatelliteDataFromJSONTyped(json, false);
}

export function SatelliteDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SatelliteData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'ndvi': !exists(json, 'ndvi') ? undefined : json['ndvi'],
        'evi': !exists(json, 'evi') ? undefined : json['evi'],
        'soilMoisture': !exists(json, 'soil_moisture') ? undefined : json['soil_moisture'],
        'temperature': !exists(json, 'temperature') ? undefined : json['temperature'],
        'cloudCover': !exists(json, 'cloud_cover') ? undefined : json['cloud_cover'],
    };
}

export function SatelliteDataToJSON(value?: SatelliteData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ndvi': value.ndvi,
        'evi': value.evi,
        'soil_moisture': value.soilMoisture,
