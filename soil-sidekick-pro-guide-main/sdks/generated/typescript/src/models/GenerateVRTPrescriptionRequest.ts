 ...
 * @export
 */
export const GenerateVRTPrescriptionRequestApplicationTypeEnum = {
 ...
 */
export function instanceOfGenerateVRTPrescriptionRequest(value: object): boolean {
    let isInstance = true;
...
export function GenerateVRTPrescriptionRequestFromJSON(json: any): GenerateVRTPrescriptionRequest {
    return GenerateVRTPrescriptionRequestFromJSONTyped(json, false);
}

export function GenerateVRTPrescriptionRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenerateVRTPrescriptionRequest {
    ...
    return {
        ...
        'soilAnalysisId': !exists(json, 'soil_analysis_id') ? undefined : json['soil_analysis_id'],
    };
}

export function GenerateVRTPrescriptionRequestToJSON(value?: GenerateVRTPrescriptionRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
