 ...
 * 
 * @export
 * @interface CalculateEnvironmentalImpactRequestWaterBodyData
 */
export interface CalculateEnvironmentalImpactRequestWaterBodyData {
    /**
     * 
     * @type {number}
     * @memberof CalculateEnvironmentalImpactRequestWaterBodyData
     */
    distanceMiles?: number;
}

/**
 * Check if a given object implements the CalculateEnvironmentalImpactRequestWaterBodyData interface.
 */
export function instanceOfCalculateEnvironmentalImpactRequestWaterBodyData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CalculateEnvironmentalImpactRequestWaterBodyDataFromJSON(json: any): CalculateEnvironmentalImpactRequestWaterBodyData {
    return CalculateEnvironmentalImpactRequestWaterBodyDataFromJSONTyped(json, false);
}

export function CalculateEnvironmentalImpactRequestWaterBodyDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CalculateEnvironmentalImpactRequestWaterBodyData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'distanceMiles': !exists(json, 'distance_miles') ? undefined : json['distance_miles'],
    };
}

export function CalculateEnvironmentalImpactRequestWaterBodyDataToJSON(value?: CalculateEnvironmentalImpactRequestWaterBodyData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
