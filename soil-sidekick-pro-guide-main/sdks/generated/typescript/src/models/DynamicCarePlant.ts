 ...
 * 
 * @export
 * @interface DynamicCarePlant
 */
export interface DynamicCarePlant {
    /**
     * 
     * @type {string}
     * @memberof DynamicCarePlant
     */
    commonName?: string;
    /**
     * 
     ...
     * @memberof DynamicCarePlant
     */
    careDifficulty?: DynamicCarePlantCareDifficultyEnum;
}
 ...
 * @export
 */
export const DynamicCarePlantCareDifficultyEnum = {
    Easy: 'easy',
    Moderate: 'moderate',
    Challenging: 'challenging'
} as const;
export type DynamicCarePlantCareDifficultyEnum = typeof DynamicCarePlantCareDifficultyEnum[keyof typeof DynamicCarePlantCareDifficultyEnum];


/**
 * Check if a given object implements the DynamicCarePlant interface.
 */
export function instanceOfDynamicCarePlant(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCarePlantFromJSON(json: any): DynamicCarePlant {
    return DynamicCarePlantFromJSONTyped(json, false);
}

export function DynamicCarePlantFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCarePlant {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'commonName': !exists(json, 'common_name') ? undefined : json['common_name'],
        'scientificName': !exists(json, 'scientific_name') ? undefined : json['scientific_name'],
        'careDifficulty': !exists(json, 'care_difficulty') ? undefined : json['care_difficulty'],
    };
}

export function DynamicCarePlantToJSON(value?: DynamicCarePlant | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'care_difficulty': value.careDifficulty,
    };
}
