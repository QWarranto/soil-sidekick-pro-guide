 ...
 */
export function instanceOfAIAnalysisRecommendationsInner(value: object): boolean {
    let isInstance = true;
...
export function AIAnalysisRecommendationsInnerToJSON(value?: AIAnalysisRecommendationsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
