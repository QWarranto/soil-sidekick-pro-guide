 ...
 * - none: Standard 16-bit KV cache
 * - 3bit: TurboQuant 3-bit compression (6x memory reduction)
 * 
 * @export
 */
export const TQKVCacheHint = {
    None: 'none',
    _3bit: '3bit'
} as const;
export type TQKVCacheHint = typeof TQKVCacheHint[keyof typeof TQKVCacheHint];


export function TQKVCacheHintFromJSON(json: any): TQKVCacheHint {
    return TQKVCacheHintFromJSONTyped(json, false);
}

export function TQKVCacheHintFromJSONTyped(json: any, ignoreDiscriminator: boolean): TQKVCacheHint {
    return json as TQKVCacheHint;
}

export function TQKVCacheHintToJSON(value?: TQKVCacheHint | null): any {
    return value as any;
}
