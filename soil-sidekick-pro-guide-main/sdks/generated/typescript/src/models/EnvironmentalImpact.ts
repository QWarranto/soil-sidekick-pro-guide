...
export function EnvironmentalImpactFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentalImpact {
    ...
    return {
        ...
        'impactAssessment': !exists(json, 'impact_assessment') ? undefined : EnvironmentalImpactImpactAssessmentFromJSON(json['impact_assessment']),
        'detailedAnalysis': !exists(json, 'detailed_analysis') ? undefined : EnvironmentalImpactDetailedAnalysisFromJSON(json['detailed_analysis']),
        'recommendations': !exists(json, 'recommendations') ? undefined : json['recommendations'],
    };
}

export function EnvironmentalImpactToJSON(value?: EnvironmentalImpact | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
