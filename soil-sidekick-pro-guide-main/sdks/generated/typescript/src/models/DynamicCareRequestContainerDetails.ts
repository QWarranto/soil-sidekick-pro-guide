 ...
 * 
 * @export
 * @interface DynamicCareRequestContainerDetails
 */
export interface DynamicCareRequestContainerDetails {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareRequestContainerDetails
     */
    type?: DynamicCareRequestContainerDetailsTypeEnum;
    /**
     * 
     * @type {number}
     * @memberof DynamicCareRequestContainerDetails
 ...
 * @export
 */
export const DynamicCareRequestContainerDetailsTypeEnum = {
...
export type DynamicCareRequestContainerDetailsTypeEnum = typeof DynamicCareRequestContainerDetailsTypeEnum[keyof typeof DynamicCareRequestContainerDetailsTypeEnum];


/**
 * Check if a given object implements the DynamicCareRequestContainerDetails interface.
 */
export function instanceOfDynamicCareRequestContainerDetails(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareRequestContainerDetailsFromJSON(json: any): DynamicCareRequestContainerDetails {
    return DynamicCareRequestContainerDetailsFromJSONTyped(json, false);
}

export function DynamicCareRequestContainerDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareRequestContainerDetails {
    ...
    return {
        ...
        'sizeInches': !exists(json, 'size_inches') ? undefined : json['size_inches'],
        'hasDrainage': !exists(json, 'has_drainage') ? undefined : json['has_drainage'],
    };
}

export function DynamicCareRequestContainerDetailsToJSON(value?: DynamicCareRequestContainerDetails | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'type': value.type,
        'size_inches': value.sizeInches,
        'has_drainage': value.hasDrainage,
    };
}
