 ...
 * 
 * @export
 * @interface BeginnerGuidanceMetadata
 */
export interface BeginnerGuidanceMetadata {
    /**
     * 
     * @type {string}
     * @memberof BeginnerGuidanceMetadata
     */
...
/**
 * Check if a given object implements the BeginnerGuidanceMetadata interface.
 */
export function instanceOfBeginnerGuidanceMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function BeginnerGuidanceMetadataFromJSON(json: any): BeginnerGuidanceMetadata {
    return BeginnerGuidanceMetadataFromJSONTyped(json, false);
}

export function BeginnerGuidanceMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): BeginnerGuidanceMetadata {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'expertiseLevelUsed': !exists(json, 'expertise_level_used') ? undefined : json['expertise_level_used'],
        'plantIdentified': !exists(json, 'plant_identified') ? undefined : json['plant_identified'],
        'environmentalContext': !exists(json, 'environmental_context') ? undefined : json['environmental_context'],
    };
}

export function BeginnerGuidanceMetadataToJSON(value?: BeginnerGuidanceMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'expertise_level_used': value.expertiseLevelUsed,
        'plant_identified': value.plantIdentified,
