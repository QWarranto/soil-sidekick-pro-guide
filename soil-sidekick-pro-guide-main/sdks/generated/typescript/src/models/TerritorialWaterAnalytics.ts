...
import {
    TerritorialWaterAnalyticsAnalyticsFromJSON,
    TerritorialWaterAnalyticsAnalyticsFromJSONTyped,
    TerritorialWaterAnalyticsAnalyticsToJSON,
} from './TerritorialWaterAnalyticsAnalytics';
 ...
 */
export function instanceOfTerritorialWaterAnalytics(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function TerritorialWaterAnalyticsFromJSON(json: any): TerritorialWaterAnalytics {
    return TerritorialWaterAnalyticsFromJSONTyped(json, false);
}

export function TerritorialWaterAnalyticsFromJSONTyped(json: any, ignoreDiscriminator: boolean): TerritorialWaterAnalytics {
    ...
    return {
        ...
        'analytics': !exists(json, 'analytics') ? undefined : TerritorialWaterAnalyticsAnalyticsFromJSON(json['analytics']),
        'generatedAt': !exists(json, 'generated_at') ? undefined : (new Date(json['generated_at'])),
    };
}

export function TerritorialWaterAnalyticsToJSON(value?: TerritorialWaterAnalytics | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
