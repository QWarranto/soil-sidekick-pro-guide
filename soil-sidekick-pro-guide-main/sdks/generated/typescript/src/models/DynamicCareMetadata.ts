 ...
 * 
 * @export
 * @interface DynamicCareMetadata
 */
export interface DynamicCareMetadata {
    /**
     * 
     * @type {boolean}
     * @memberof DynamicCareMetadata
     */
    locationDataUsed?: boolean;
    /**
     * 
     * @type {string}
     * @memberof DynamicCareMetadata
     */
    weatherDataFreshness?: string;
    /**
     * 
     * @type {number}
     * @memberof DynamicCareMetadata
...
/**
 * Check if a given object implements the DynamicCareMetadata interface.
 */
export function instanceOfDynamicCareMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareMetadataFromJSON(json: any): DynamicCareMetadata {
    return DynamicCareMetadataFromJSONTyped(json, false);
}

export function DynamicCareMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareMetadata {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'locationDataUsed': !exists(json, 'location_data_used') ? undefined : json['location_data_used'],
        'weatherDataFreshness': !exists(json, 'weather_data_freshness') ? undefined : json['weather_data_freshness'],
        'confidence': !exists(json, 'confidence') ? undefined : json['confidence'],
    };
}

export function DynamicCareMetadataToJSON(value?: DynamicCareMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'location_data_used': value.locationDataUsed,
        'weather_data_freshness': value.weatherDataFreshness,
