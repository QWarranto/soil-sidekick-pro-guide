...
import type { VRTPrescriptionZonesInner } from './VRTPrescriptionZonesInner';
import {
    VRTPrescriptionZonesInnerFromJSON,
    VRTPrescriptionZonesInnerFromJSONTyped,
    VRTPrescriptionZonesInnerToJSON,
} from './VRTPrescriptionZonesInner';

/**
 * 
 * @export
 * @interface VRTPrescription
 */
export interface VRTPrescription {
    /**
     * 
     * @type {string}
     * @memberof VRTPrescription
     */
    id?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<VRTPrescriptionZonesInner>}
     * @memberof VRTPrescription
     */
    zones?: Array<VRTPrescriptionZonesInner>;
}

/**
 * Check if a given object implements the VRTPrescription interface.
 */
export function instanceOfVRTPrescription(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VRTPrescriptionFromJSON(json: any): VRTPrescription {
    return VRTPrescriptionFromJSONTyped(json, false);
}

export function VRTPrescriptionFromJSONTyped(json: any, ignoreDiscriminator: boolean): VRTPrescription {
    ...
    return {
        ...
        'applicationType': !exists(json, 'application_type') ? undefined : json['application_type'],
        'zones': !exists(json, 'zones') ? undefined : ((json['zones'] as Array<any>).map(VRTPrescriptionZonesInnerFromJSON)),
    };
}

export function VRTPrescriptionToJSON(value?: VRTPrescription | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'zones': value.zones === undefined ? undefined : ((value.zones as Array<any>).map(VRTPrescriptionZonesInnerToJSON)),
    };
}
