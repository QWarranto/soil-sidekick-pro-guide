 ...
 */
export function instanceOfEnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner(value: object): boolean {
    let isInstance = true;
...
export function EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner {
    ...
    return {
        ...
        'environmentalBenefit': !exists(json, 'environmental_benefit') ? undefined : json['environmental_benefit'],
        'effectivenessScore': !exists(json, 'effectiveness_score') ? undefined : json['effectiveness_score'],
    };
}

export function EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInnerToJSON(value?: EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
