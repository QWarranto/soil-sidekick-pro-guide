...
import type { SafeIdentificationRequestContext } from './SafeIdentificationRequestContext';
import {
    SafeIdentificationRequestContextFromJSON,
    SafeIdentificationRequestContextFromJSONTyped,
    SafeIdentificationRequestContextToJSON,
} from './SafeIdentificationRequestContext';
import type { SafeIdentificationRequestLocation } from './SafeIdentificationRequestLocation';
import {
    SafeIdentificationRequestLocationFromJSON,
    SafeIdentificationRequestLocationFromJSONTyped,
    SafeIdentificationRequestLocationToJSON,
} from './SafeIdentificationRequestLocation';

/**
 * 
 * @export
 * @interface SafeIdentificationRequest
 */
export interface SafeIdentificationRequest {
    /**
     * Base64 encoded image or image URL
     * @type {string}
     * @memberof SafeIdentificationRequest
     */
    image: string;
    /**
     * 
     * @type {SafeIdentificationRequestLocation}
     * @memberof SafeIdentificationRequest
     */
    location?: SafeIdentificationRequestLocation;
    /**
     * 
     * @type {SafeIdentificationRequestContext}
     * @memberof SafeIdentificationRequest
     */
    context?: SafeIdentificationRequestContext;
}

/**
 * Check if a given object implements the SafeIdentificationRequest interface.
 */
export function instanceOfSafeIdentificationRequest(value: object): boolean {
    let isInstance = true;
...
export function SafeIdentificationRequestFromJSON(json: any): SafeIdentificationRequest {
    return SafeIdentificationRequestFromJSONTyped(json, false);
}

export function SafeIdentificationRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationRequest {
    ...
    return {
        ...
        'image': json['image'],
        'location': !exists(json, 'location') ? undefined : SafeIdentificationRequestLocationFromJSON(json['location']),
        'context': !exists(json, 'context') ? undefined : SafeIdentificationRequestContextFromJSON(json['context']),
    };
}

export function SafeIdentificationRequestToJSON(value?: SafeIdentificationRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'image': value.image,
        'location': SafeIdentificationRequestLocationToJSON(value.location),
        'context': SafeIdentificationRequestContextToJSON(value.context),
    };
}
