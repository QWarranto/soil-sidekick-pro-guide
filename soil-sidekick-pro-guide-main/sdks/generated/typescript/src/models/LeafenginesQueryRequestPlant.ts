 ...
 */
export function instanceOfLeafenginesQueryRequestPlant(value: object): boolean {
    let isInstance = true;
...
export function LeafenginesQueryRequestPlantFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafenginesQueryRequestPlant {
    ...
    return {
        ...
        'plantId': !exists(json, 'plant_id') ? undefined : json['plant_id'],
        'careRequirements': !exists(json, 'care_requirements') ? undefined : LeafenginesQueryRequestPlantCareRequirementsFromJSON(json['care_requirements']),
    };
}

export function LeafenginesQueryRequestPlantToJSON(value?: LeafenginesQueryRequestPlant | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
