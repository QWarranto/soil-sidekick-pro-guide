 ...
 */
export function instanceOfLeafEnginesCompatibilityUsage(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LeafEnginesCompatibilityUsageFromJSON(json: any): LeafEnginesCompatibilityUsage {
    return LeafEnginesCompatibilityUsageFromJSONTyped(json, false);
}

export function LeafEnginesCompatibilityUsageFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafEnginesCompatibilityUsage {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'creditsUsed': !exists(json, 'credits_used') ? undefined : json['credits_used'],
        'responseTimeMs': !exists(json, 'response_time_ms') ? undefined : json['response_time_ms'],
    };
}

export function LeafEnginesCompatibilityUsageToJSON(value?: LeafEnginesCompatibilityUsage | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
