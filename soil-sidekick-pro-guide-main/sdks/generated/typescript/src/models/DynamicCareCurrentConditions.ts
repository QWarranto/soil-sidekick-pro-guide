 ...
 * 
 * @export
 * @interface DynamicCareCurrentConditions
 */
export interface DynamicCareCurrentConditions {
    /**
     * 
     * @type {number}
     * @memberof DynamicCareCurrentConditions
     */
    temperatureF?: number;
    /**
     * 
...
/**
 * Check if a given object implements the DynamicCareCurrentConditions interface.
 */
export function instanceOfDynamicCareCurrentConditions(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareCurrentConditionsFromJSON(json: any): DynamicCareCurrentConditions {
    return DynamicCareCurrentConditionsFromJSONTyped(json, false);
}

export function DynamicCareCurrentConditionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareCurrentConditions {
    ...
    return {
        ...
        'humidityPercent': !exists(json, 'humidity_percent') ? undefined : json['humidity_percent'],
        'recentRainfallInches': !exists(json, 'recent_rainfall_inches') ? undefined : json['recent_rainfall_inches'],
        'season': !exists(json, 'season') ? undefined : json['season'],
        'daysSinceWatered': !exists(json, 'days_since_watered') ? undefined : json['days_since_watered'],
    };
}

export function DynamicCareCurrentConditionsToJSON(value?: DynamicCareCurrentConditions | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'temperature_f': value.temperatureF,
        'humidity_percent': value.humidityPercent,
        'recent_rainfall_inches': value.recentRainfallInches,
        'season': value.season,
        'days_since_watered': value.daysSinceWatered,
    };
}
