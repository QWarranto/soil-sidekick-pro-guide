...
import {
    LeafEnginesCompatibilityDataBreakdownSoilFromJSON,
    LeafEnginesCompatibilityDataBreakdownSoilFromJSONTyped,
    LeafEnginesCompatibilityDataBreakdownSoilToJSON,
} from './LeafEnginesCompatibilityDataBreakdownSoil';
 ...
 */
export function instanceOfLeafEnginesCompatibilityDataBreakdown(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LeafEnginesCompatibilityDataBreakdownFromJSON(json: any): LeafEnginesCompatibilityDataBreakdown {
    return LeafEnginesCompatibilityDataBreakdownFromJSONTyped(json, false);
}

export function LeafEnginesCompatibilityDataBreakdownFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafEnginesCompatibilityDataBreakdown {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'soil': !exists(json, 'soil') ? undefined : LeafEnginesCompatibilityDataBreakdownSoilFromJSON(json['soil']),
        'water': !exists(json, 'water') ? undefined : json['water'],
        'climate': !exists(json, 'climate') ? undefined : json['climate'],
    };
}

export function LeafEnginesCompatibilityDataBreakdownToJSON(value?: LeafEnginesCompatibilityDataBreakdown | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
