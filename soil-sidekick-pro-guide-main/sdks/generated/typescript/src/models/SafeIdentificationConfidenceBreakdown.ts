 ...
 * 
 * @export
 * @interface SafeIdentificationConfidenceBreakdown
 */
export interface SafeIdentificationConfidenceBreakdown {
    /**
     * 
     * @type {number}
     * @memberof SafeIdentificationConfidenceBreakdown
     */
    visualMatch?: number;
    /**
     * 
     ...
     * @memberof SafeIdentificationConfidenceBreakdown
     */
    growthStageAlignment?: number;
}

/**
 * Check if a given object implements the SafeIdentificationConfidenceBreakdown interface.
 */
export function instanceOfSafeIdentificationConfidenceBreakdown(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationConfidenceBreakdownFromJSON(json: any): SafeIdentificationConfidenceBreakdown {
    return SafeIdentificationConfidenceBreakdownFromJSONTyped(json, false);
}

export function SafeIdentificationConfidenceBreakdownFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationConfidenceBreakdown {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'visualMatch': !exists(json, 'visual_match') ? undefined : json['visual_match'],
        'environmentalContext': !exists(json, 'environmental_context') ? undefined : json['environmental_context'],
        'regionalPrevalence': !exists(json, 'regional_prevalence') ? undefined : json['regional_prevalence'],
        'growthStageAlignment': !exists(json, 'growth_stage_alignment') ? undefined : json['growth_stage_alignment'],
    };
}

export function SafeIdentificationConfidenceBreakdownToJSON(value?: SafeIdentificationConfidenceBreakdown | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'visual_match': value.visualMatch,
        'environmental_context': value.environmentalContext,
        'regional_prevalence': value.regionalPrevalence,
        'growth_stage_alignment': value.growthStageAlignment,
    };
}
