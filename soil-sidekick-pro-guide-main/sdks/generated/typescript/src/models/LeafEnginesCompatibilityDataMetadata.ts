 ...
 */
export function instanceOfLeafEnginesCompatibilityDataMetadata(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function LeafEnginesCompatibilityDataMetadataFromJSON(json: any): LeafEnginesCompatibilityDataMetadata {
    return LeafEnginesCompatibilityDataMetadataFromJSONTyped(json, false);
}

export function LeafEnginesCompatibilityDataMetadataFromJSONTyped(json: any, ignoreDiscriminator: boolean): LeafEnginesCompatibilityDataMetadata {
...
export function LeafEnginesCompatibilityDataMetadataToJSON(value?: LeafEnginesCompatibilityDataMetadata | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
