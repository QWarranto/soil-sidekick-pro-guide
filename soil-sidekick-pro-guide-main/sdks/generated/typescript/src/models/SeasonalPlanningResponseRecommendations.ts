 ...
 * 
 * @export
 * @interface SeasonalPlanningResponseRecommendations
 */
export interface SeasonalPlanningResponseRecommendations {
    /**
     * 
     * @type {Array<object>}
     * @memberof SeasonalPlanningResponseRecommendations
     */
    seasonalTasks?: Array<object>;
    /**
     * 
     * @type {Array<string>}
     * @memberof SeasonalPlanningResponseRecommendations
     */
    cropRecommendations?: Array<string>;
    /**
     * 
     * @type {object}
     * @memberof SeasonalPlanningResponseRecommendations
     */
    timingGuidance?: object;
}

/**
 * Check if a given object implements the SeasonalPlanningResponseRecommendations interface.
 */
export function instanceOfSeasonalPlanningResponseRecommendations(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SeasonalPlanningResponseRecommendationsFromJSON(json: any): SeasonalPlanningResponseRecommendations {
    return SeasonalPlanningResponseRecommendationsFromJSONTyped(json, false);
}

export function SeasonalPlanningResponseRecommendationsFromJSONTyped(json: any, ignoreDiscriminator: boolean): SeasonalPlanningResponseRecommendations {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'seasonalTasks': !exists(json, 'seasonal_tasks') ? undefined : json['seasonal_tasks'],
        'cropRecommendations': !exists(json, 'crop_recommendations') ? undefined : json['crop_recommendations'],
        'timingGuidance': !exists(json, 'timing_guidance') ? undefined : json['timing_guidance'],
    };
}

export function SeasonalPlanningResponseRecommendationsToJSON(value?: SeasonalPlanningResponseRecommendations | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'seasonal_tasks': value.seasonalTasks,
        'crop_recommendations': value.cropRecommendations,
        'timing_guidance': value.timingGuidance,
    };
}
