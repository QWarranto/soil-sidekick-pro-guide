 ...
 */
export function instanceOfCountyLookup200Response(value: object): boolean {
    let isInstance = true;
...
export function CountyLookup200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CountyLookup200Response {
    ...
    return {
        ...
        'counties': !exists(json, 'counties') ? undefined : ((json['counties'] as Array<any>).map(CountyFromJSON)),
    };
}

export function CountyLookup200ResponseToJSON(value?: CountyLookup200Response | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'counties': value.counties === undefined ? undefined : ((value.counties as Array<any>).map(CountyToJSON)),
    };
}
