 ...
 * 
 * @export
 * @interface DynamicCareRequestEnvironment
 */
export interface DynamicCareRequestEnvironment {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareRequestEnvironment
     */
    lightExposure?: DynamicCareRequestEnvironmentLightExposureEnum;
    /**
     * Approximate indoor humidity if applicable
     * @type {string}
     * @memberof DynamicCareRequestEnvironment
     */
    humidityLevel?: DynamicCareRequestEnvironmentHumidityLevelEnum;
}
 ...
 * @export
 */
export const DynamicCareRequestEnvironmentLightExposureEnum = {
    FullSun: 'full_sun',
...
export type DynamicCareRequestEnvironmentLightExposureEnum = typeof DynamicCareRequestEnvironmentLightExposureEnum[keyof typeof DynamicCareRequestEnvironmentLightExposureEnum];

/**
 * @export
 */
export const DynamicCareRequestEnvironmentHumidityLevelEnum = {
    Low: 'low',
    Medium: 'medium',
    High: 'high'
} as const;
export type DynamicCareRequestEnvironmentHumidityLevelEnum = typeof DynamicCareRequestEnvironmentHumidityLevelEnum[keyof typeof DynamicCareRequestEnvironmentHumidityLevelEnum];


/**
 * Check if a given object implements the DynamicCareRequestEnvironment interface.
 */
export function instanceOfDynamicCareRequestEnvironment(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareRequestEnvironmentFromJSON(json: any): DynamicCareRequestEnvironment {
    return DynamicCareRequestEnvironmentFromJSONTyped(json, false);
}

export function DynamicCareRequestEnvironmentFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareRequestEnvironment {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'lightExposure': !exists(json, 'light_exposure') ? undefined : json['light_exposure'],
        'humidityLevel': !exists(json, 'humidity_level') ? undefined : json['humidity_level'],
    };
}

export function DynamicCareRequestEnvironmentToJSON(value?: DynamicCareRequestEnvironment | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'light_exposure': value.lightExposure,
        'humidity_level': value.humidityLevel,
    };
}
