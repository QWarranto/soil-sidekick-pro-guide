...
import {
    SmartReportSummarySummaryFromJSON,
    SmartReportSummarySummaryFromJSONTyped,
    SmartReportSummarySummaryToJSON,
} from './SmartReportSummarySummary';
 ...
 */
export function instanceOfSmartReportSummary(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SmartReportSummaryFromJSON(json: any): SmartReportSummary {
    return SmartReportSummaryFromJSONTyped(json, false);
}

export function SmartReportSummaryFromJSONTyped(json: any, ignoreDiscriminator: boolean): SmartReportSummary {
    ...
    return {
        ...
        'summary': !exists(json, 'summary') ? undefined : SmartReportSummarySummaryFromJSON(json['summary']),
        'modelUsed': !exists(json, 'modelUsed') ? undefined : json['modelUsed'],
    };
}

export function SmartReportSummaryToJSON(value?: SmartReportSummary | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
