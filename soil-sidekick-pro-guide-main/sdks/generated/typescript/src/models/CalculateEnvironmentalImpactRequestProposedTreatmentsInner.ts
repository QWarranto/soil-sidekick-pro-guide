 ...
 */
export function instanceOfCalculateEnvironmentalImpactRequestProposedTreatmentsInner(value: object): boolean {
    let isInstance = true;
...
export function CalculateEnvironmentalImpactRequestProposedTreatmentsInnerToJSON(value?: CalculateEnvironmentalImpactRequestProposedTreatmentsInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
