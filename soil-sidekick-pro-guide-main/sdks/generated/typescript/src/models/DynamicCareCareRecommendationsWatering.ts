 ...
 * 
 * @export
 * @interface DynamicCareCareRecommendationsWatering
 */
export interface DynamicCareCareRecommendationsWatering {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareCareRecommendationsWatering
     */
    action?: DynamicCareCareRecommendationsWateringActionEnum;
    /**
     * 
     * @type {string}
     * @memberof DynamicCareCareRecommendationsWatering
 ...
 * @export
 */
export const DynamicCareCareRecommendationsWateringActionEnum = {
    WaterNow: 'water_now',
    Wait: 'wait',
    CheckSoil: 'check_soil',
    ReduceFrequency: 'reduce_frequency'
} as const;
export type DynamicCareCareRecommendationsWateringActionEnum = typeof DynamicCareCareRecommendationsWateringActionEnum[keyof typeof DynamicCareCareRecommendationsWateringActionEnum];


/**
 * Check if a given object implements the DynamicCareCareRecommendationsWatering interface.
 */
export function instanceOfDynamicCareCareRecommendationsWatering(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareCareRecommendationsWateringFromJSON(json: any): DynamicCareCareRecommendationsWatering {
    return DynamicCareCareRecommendationsWateringFromJSONTyped(json, false);
}

export function DynamicCareCareRecommendationsWateringFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareCareRecommendationsWatering {
    ...
    return {
        ...
        'nextCheckDays': !exists(json, 'next_check_days') ? undefined : json['next_check_days'],
        'amountGuidance': !exists(json, 'amount_guidance') ? undefined : json['amount_guidance'],
    };
}

export function DynamicCareCareRecommendationsWateringToJSON(value?: DynamicCareCareRecommendationsWatering | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'next_check_days': value.nextCheckDays,
        'amount_guidance': value.amountGuidance,
    };
}
