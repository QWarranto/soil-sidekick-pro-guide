 ...
 */
export function instanceOfCalculateCarbonCreditsRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "fieldName" in value;
    isInstance = isInstance && "fieldSizeAcres" in value;
...
export function CalculateCarbonCreditsRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CalculateCarbonCreditsRequest {
    ...
    return {
        ...
        'soilOrganicMatter': !exists(json, 'soil_organic_matter') ? undefined : json['soil_organic_matter'],
        'soilAnalysisId': !exists(json, 'soil_analysis_id') ? undefined : json['soil_analysis_id'],
        'verificationType': !exists(json, 'verification_type') ? undefined : json['verification_type'],
    };
}

export function CalculateCarbonCreditsRequestToJSON(value?: CalculateCarbonCreditsRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
