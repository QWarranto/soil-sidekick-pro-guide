 ...
 * 
 * @export
 * @interface DynamicCareCareRecommendationsHumidity
 */
export interface DynamicCareCareRecommendationsHumidity {
    /**
     * 
     * @type {string}
     * @memberof DynamicCareCareRecommendationsHumidity
     */
    currentLevel?: string;
    /**
     * 
...
/**
 * Check if a given object implements the DynamicCareCareRecommendationsHumidity interface.
 */
export function instanceOfDynamicCareCareRecommendationsHumidity(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function DynamicCareCareRecommendationsHumidityFromJSON(json: any): DynamicCareCareRecommendationsHumidity {
    return DynamicCareCareRecommendationsHumidityFromJSONTyped(json, false);
}

export function DynamicCareCareRecommendationsHumidityFromJSONTyped(json: any, ignoreDiscriminator: boolean): DynamicCareCareRecommendationsHumidity {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'currentLevel': !exists(json, 'current_level') ? undefined : json['current_level'],
        'idealRange': !exists(json, 'ideal_range') ? undefined : json['ideal_range'],
        'adjustmentRecommendation': !exists(json, 'adjustment_recommendation') ? undefined : json['adjustment_recommendation'],
    };
}

export function DynamicCareCareRecommendationsHumidityToJSON(value?: DynamicCareCareRecommendationsHumidity | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'ideal_range': value.idealRange,
        'adjustment_recommendation': value.adjustmentRecommendation,
    };
}
