 ...
 * 
 * @export
 * @interface CarbonCreditCalculationCreditRecord
 */
export interface CarbonCreditCalculationCreditRecord {
    /**
     * 
     * @type {string}
     * @memberof CarbonCreditCalculationCreditRecord
     */
    id?: string;
    /**
     * 
     ...
     * @memberof CarbonCreditCalculationCreditRecord
     */
    verificationStatus?: CarbonCreditCalculationCreditRecordVerificationStatusEnum;
}
 ...
 * @export
 */
export const CarbonCreditCalculationCreditRecordVerificationStatusEnum = {
    Pending: 'pending',
    Verified: 'verified'
} as const;
export type CarbonCreditCalculationCreditRecordVerificationStatusEnum = typeof CarbonCreditCalculationCreditRecordVerificationStatusEnum[keyof typeof CarbonCreditCalculationCreditRecordVerificationStatusEnum];


/**
 * Check if a given object implements the CarbonCreditCalculationCreditRecord interface.
 */
export function instanceOfCarbonCreditCalculationCreditRecord(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function CarbonCreditCalculationCreditRecordFromJSON(json: any): CarbonCreditCalculationCreditRecord {
    return CarbonCreditCalculationCreditRecordFromJSONTyped(json, false);
}

export function CarbonCreditCalculationCreditRecordFromJSONTyped(json: any, ignoreDiscriminator: boolean): CarbonCreditCalculationCreditRecord {
    ...
    return {
        ...
        'fieldSizeAcres': !exists(json, 'field_size_acres') ? undefined : json['field_size_acres'],
...
export function CarbonCreditCalculationCreditRecordToJSON(value?: CarbonCreditCalculationCreditRecord | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
