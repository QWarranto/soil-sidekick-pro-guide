 ...
 */
export function instanceOfSeasonalPlanningResponseWeatherData(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SeasonalPlanningResponseWeatherDataFromJSON(json: any): SeasonalPlanningResponseWeatherData {
    return SeasonalPlanningResponseWeatherDataFromJSONTyped(json, false);
}

export function SeasonalPlanningResponseWeatherDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SeasonalPlanningResponseWeatherData {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'currentSeason': !exists(json, 'currentSeason') ? undefined : json['currentSeason'],
        'temperature': !exists(json, 'temperature') ? undefined : json['temperature'],
        'rainfall': !exists(json, 'rainfall') ? undefined : json['rainfall'],
        'frostDates': !exists(json, 'frostDates') ? undefined : json['frostDates'],
        'growingSeason': !exists(json, 'growingSeason') ? undefined : json['growingSeason'],
        'zone': !exists(json, 'zone') ? undefined : json['zone'],
    };
}

export function SeasonalPlanningResponseWeatherDataToJSON(value?: SeasonalPlanningResponseWeatherData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
