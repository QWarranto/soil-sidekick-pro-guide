 ...
 */
export function instanceOfAIAnalysis(value: object): boolean {
    let isInstance = true;
...
export function AIAnalysisFromJSONTyped(json: any, ignoreDiscriminator: boolean): AIAnalysis {
    ...
    return {
        ...
        'recommendations': !exists(json, 'recommendations') ? undefined : ((json['recommendations'] as Array<any>).map(AIAnalysisRecommendationsInnerFromJSON)),
    };
}

export function AIAnalysisToJSON(value?: AIAnalysis | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'recommendations': value.recommendations === undefined ? undefined : ((value.recommendations as Array<any>).map(AIAnalysisRecommendationsInnerToJSON)),
    };
}
