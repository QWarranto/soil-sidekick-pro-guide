 ...
 * 
 * @export
 * @interface VRTPrescriptionZonesInner
 */
export interface VRTPrescriptionZonesInner {
    /**
     * 
     * @type {number}
     * @memberof VRTPrescriptionZonesInner
     */
    zoneId?: number;
    /**
     * 
...
/**
 * Check if a given object implements the VRTPrescriptionZonesInner interface.
 */
export function instanceOfVRTPrescriptionZonesInner(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VRTPrescriptionZonesInnerFromJSON(json: any): VRTPrescriptionZonesInner {
    return VRTPrescriptionZonesInnerFromJSONTyped(json, false);
}

export function VRTPrescriptionZonesInnerFromJSONTyped(json: any, ignoreDiscriminator: boolean): VRTPrescriptionZonesInner {
    ...
    return {
        ...
        'applicationRate': !exists(json, 'application_rate') ? undefined : json['application_rate'],
        'geometry': !exists(json, 'geometry') ? undefined : json['geometry'],
    };
}

export function VRTPrescriptionZonesInnerToJSON(value?: VRTPrescriptionZonesInner | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'application_rate': value.applicationRate,
