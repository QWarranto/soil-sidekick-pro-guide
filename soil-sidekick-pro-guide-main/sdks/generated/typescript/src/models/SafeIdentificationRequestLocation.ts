...
import type { SafeIdentificationRequestLocationCoordinates } from './SafeIdentificationRequestLocationCoordinates';
import {
    SafeIdentificationRequestLocationCoordinatesFromJSON,
    SafeIdentificationRequestLocationCoordinatesFromJSONTyped,
    SafeIdentificationRequestLocationCoordinatesToJSON,
} from './SafeIdentificationRequestLocationCoordinates';

/**
 * 
 * @export
 * @interface SafeIdentificationRequestLocation
 */
export interface SafeIdentificationRequestLocation {
    /**
     * 
     * @type {string}
     * @memberof SafeIdentificationRequestLocation
     */
    countyFips?: string;
    /**
     * 
    ...
    /**
     * 
     * @type {SafeIdentificationRequestLocationCoordinates}
     * @memberof SafeIdentificationRequestLocation
     */
    coordinates?: SafeIdentificationRequestLocationCoordinates;
}

/**
 * Check if a given object implements the SafeIdentificationRequestLocation interface.
 */
export function instanceOfSafeIdentificationRequestLocation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationRequestLocationFromJSON(json: any): SafeIdentificationRequestLocation {
    return SafeIdentificationRequestLocationFromJSONTyped(json, false);
}

export function SafeIdentificationRequestLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationRequestLocation {
    ...
    return {
        ...
        'coordinates': !exists(json, 'coordinates') ? undefined : SafeIdentificationRequestLocationCoordinatesFromJSON(json['coordinates']),
    };
}

export function SafeIdentificationRequestLocationToJSON(value?: SafeIdentificationRequestLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'coordinates': SafeIdentificationRequestLocationCoordinatesToJSON(value.coordinates),
    };
}
