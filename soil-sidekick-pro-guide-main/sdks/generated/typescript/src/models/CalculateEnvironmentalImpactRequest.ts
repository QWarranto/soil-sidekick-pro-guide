 ...
 */
export function instanceOfCalculateEnvironmentalImpactRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "analysisId" in value;
    isInstance = isInstance && "countyFips" in value;
    isInstance = isInstance && "soilData" in value;
...
export function CalculateEnvironmentalImpactRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): CalculateEnvironmentalImpactRequest {
    ...
    return {
        ...
        'proposedTreatments': !exists(json, 'proposed_treatments') ? undefined : ((json['proposed_treatments'] as Array<any>).map(CalculateEnvironmentalImpactRequestProposedTreatmentsInnerFromJSON)),
        'waterBodyData': !exists(json, 'water_body_data') ? undefined : CalculateEnvironmentalImpactRequestWaterBodyDataFromJSON(json['water_body_data']),
    };
}

export function CalculateEnvironmentalImpactRequestToJSON(value?: CalculateEnvironmentalImpactRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'proposed_treatments': value.proposedTreatments === undefined ? undefined : ((value.proposedTreatments as Array<any>).map(CalculateEnvironmentalImpactRequestProposedTreatmentsInnerToJSON)),
