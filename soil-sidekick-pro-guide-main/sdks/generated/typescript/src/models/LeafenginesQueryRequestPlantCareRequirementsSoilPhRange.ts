 ...
 */
export function instanceOfLeafenginesQueryRequestPlantCareRequirementsSoilPhRange(value: object): boolean {
    let isInstance = true;
...
export function LeafenginesQueryRequestPlantCareRequirementsSoilPhRangeToJSON(value?: LeafenginesQueryRequestPlantCareRequirementsSoilPhRange | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
