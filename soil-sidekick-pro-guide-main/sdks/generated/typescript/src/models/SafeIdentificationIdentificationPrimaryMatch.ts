 ...
 * 
 * @export
 * @interface SafeIdentificationIdentificationPrimaryMatch
 */
export interface SafeIdentificationIdentificationPrimaryMatch {
    /**
     * 
     * @type {string}
     * @memberof SafeIdentificationIdentificationPrimaryMatch
     */
    commonName?: string;
    /**
     * 
...
/**
 * Check if a given object implements the SafeIdentificationIdentificationPrimaryMatch interface.
 */
export function instanceOfSafeIdentificationIdentificationPrimaryMatch(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function SafeIdentificationIdentificationPrimaryMatchFromJSON(json: any): SafeIdentificationIdentificationPrimaryMatch {
    return SafeIdentificationIdentificationPrimaryMatchFromJSONTyped(json, false);
}

export function SafeIdentificationIdentificationPrimaryMatchFromJSONTyped(json: any, ignoreDiscriminator: boolean): SafeIdentificationIdentificationPrimaryMatch {
...
export function SafeIdentificationIdentificationPrimaryMatchToJSON(value?: SafeIdentificationIdentificationPrimaryMatch | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
