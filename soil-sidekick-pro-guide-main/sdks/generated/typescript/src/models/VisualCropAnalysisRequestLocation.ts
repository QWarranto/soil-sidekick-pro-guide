 ...
 */
export function instanceOfVisualCropAnalysisRequestLocation(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VisualCropAnalysisRequestLocationFromJSON(json: any): VisualCropAnalysisRequestLocation {
    return VisualCropAnalysisRequestLocationFromJSONTyped(json, false);
}

export function VisualCropAnalysisRequestLocationFromJSONTyped(json: any, ignoreDiscriminator: boolean): VisualCropAnalysisRequestLocation {
...
export function VisualCropAnalysisRequestLocationToJSON(value?: VisualCropAnalysisRequestLocation | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
