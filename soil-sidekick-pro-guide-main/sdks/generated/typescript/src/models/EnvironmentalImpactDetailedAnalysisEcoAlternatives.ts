 ...
 */
export function instanceOfEnvironmentalImpactDetailedAnalysisEcoAlternatives(value: object): boolean {
    let isInstance = true;
...
export function EnvironmentalImpactDetailedAnalysisEcoAlternativesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EnvironmentalImpactDetailedAnalysisEcoAlternatives {
    ...
    return {
        ...
        'alternatives': !exists(json, 'alternatives') ? undefined : ((json['alternatives'] as Array<any>).map(EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInnerFromJSON)),
    };
}

export function EnvironmentalImpactDetailedAnalysisEcoAlternativesToJSON(value?: EnvironmentalImpactDetailedAnalysisEcoAlternatives | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'alternatives': value.alternatives === undefined ? undefined : ((value.alternatives as Array<any>).map(EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInnerToJSON)),
    };
}
