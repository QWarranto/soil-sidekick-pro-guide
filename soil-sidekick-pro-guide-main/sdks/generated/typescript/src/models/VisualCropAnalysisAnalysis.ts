 ...
 * 
 * @export
 * @interface VisualCropAnalysisAnalysis
 */
export interface VisualCropAnalysisAnalysis {
    /**
     * 
     * @type {string}
     * @memberof VisualCropAnalysisAnalysis
     */
    analysisType?: string;
    /**
     * 
     ...
     * @memberof VisualCropAnalysisAnalysis
     */
    severity?: VisualCropAnalysisAnalysisSeverityEnum;
}
 ...
 * @export
 */
export const VisualCropAnalysisAnalysisSeverityEnum = {
    Low: 'low',
    Medium: 'medium',
    High: 'high'
} as const;
export type VisualCropAnalysisAnalysisSeverityEnum = typeof VisualCropAnalysisAnalysisSeverityEnum[keyof typeof VisualCropAnalysisAnalysisSeverityEnum];


/**
 * Check if a given object implements the VisualCropAnalysisAnalysis interface.
 */
export function instanceOfVisualCropAnalysisAnalysis(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function VisualCropAnalysisAnalysisFromJSON(json: any): VisualCropAnalysisAnalysis {
    return VisualCropAnalysisAnalysisFromJSONTyped(json, false);
}

export function VisualCropAnalysisAnalysisFromJSONTyped(json: any, ignoreDiscriminator: boolean): VisualCropAnalysisAnalysis {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'analysisType': !exists(json, 'analysis_type') ? undefined : json['analysis_type'],
...
export function VisualCropAnalysisAnalysisToJSON(value?: VisualCropAnalysisAnalysis | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
