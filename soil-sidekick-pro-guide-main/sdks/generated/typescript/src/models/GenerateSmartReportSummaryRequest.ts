 ...
 * @export
 */
export const GenerateSmartReportSummaryRequestReportTypeEnum = {
    Soil: 'soil',
 ...
 */
export function instanceOfGenerateSmartReportSummaryRequest(value: object): boolean {
    let isInstance = true;
...
export function GenerateSmartReportSummaryRequestFromJSON(json: any): GenerateSmartReportSummaryRequest {
    return GenerateSmartReportSummaryRequestFromJSONTyped(json, false);
}

export function GenerateSmartReportSummaryRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenerateSmartReportSummaryRequest {
...
export function GenerateSmartReportSummaryRequestToJSON(value?: GenerateSmartReportSummaryRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
