 ...
 */
export function instanceOfGetPlantingCalendarRequest(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "countyFips" in value;
    isInstance = isInstance && "cropType" in value;

    return isInstance;
}

export function GetPlantingCalendarRequestFromJSON(json: any): GetPlantingCalendarRequest {
    return GetPlantingCalendarRequestFromJSONTyped(json, false);
}

export function GetPlantingCalendarRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): GetPlantingCalendarRequest {
...
export function GetPlantingCalendarRequestToJSON(value?: GetPlantingCalendarRequest | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
