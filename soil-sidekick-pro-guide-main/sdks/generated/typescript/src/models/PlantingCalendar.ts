...
export interface PlantingCalendar {
     ...
     * @memberof PlantingCalendar
     */
    optimalPlantingWindow?: GetTerritorialWaterAnalyticsRequestDateRange;
    /**
     * 
     * @type {object}
     * @memberof PlantingCalendar
     */
    climateFactors?: object;
    /**
     * 
     * @type {object}
     * @memberof PlantingCalendar
...
/**
 * Check if a given object implements the PlantingCalendar interface.
 */
export function instanceOfPlantingCalendar(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PlantingCalendarFromJSON(json: any): PlantingCalendar {
    return PlantingCalendarFromJSONTyped(json, false);
}

export function PlantingCalendarFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlantingCalendar {
    ...
    return {
        ...
        'optimalPlantingWindow': !exists(json, 'optimal_planting_window') ? undefined : GetTerritorialWaterAnalyticsRequestDateRangeFromJSON(json['optimal_planting_window']),
        'climateFactors': !exists(json, 'climate_factors') ? undefined : json['climate_factors'],
        'soilFactors': !exists(json, 'soil_factors') ? undefined : json['soil_factors'],
        'recommendations': !exists(json, 'recommendations') ? undefined : json['recommendations'],
    };
}

export function PlantingCalendarToJSON(value?: PlantingCalendar | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'optimal_planting_window': GetTerritorialWaterAnalyticsRequestDateRangeToJSON(value.optimalPlantingWindow),
        'climate_factors': value.climateFactors,
        'soil_factors': value.soilFactors,
