...
module SoilSidekick
  class WaterQualityApi
    ...
    # @param get_water_quality_request [GetWaterQualityRequest] 
    # @param [Hash] opts the optional parameters
    # @return [WaterQuality]
    def get_water_quality(get_water_quality_request, opts = {})
      data, _status_code, _headers = get_water_quality_with_http_info(get_water_quality_request, opts)
      data
    end
    ...
    def get_water_quality_with_http_info(get_water_quality_request, opts = {})
      if @api_client.config.debugging
      ...
      if @api_client.config.client_side_validation && get_water_quality_request.nil?
        fail ArgumentError, "Missing the required parameter 'get_water_quality_request' when calling WaterQualityApi.get_water_quality"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(get_water_quality_request)
