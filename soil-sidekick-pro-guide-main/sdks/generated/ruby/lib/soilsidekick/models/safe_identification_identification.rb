...
module SoilSidekick
  class SafeIdentificationIdentification
    attr_accessor :primary_match

    # Likelihood this plant exists in the given environment
    attr_accessor :environmental_probability

    attr_accessor :growth_stage_detected
    ...
    def self.openapi_types
      {
        :'primary_match' => :'SafeIdentificationIdentificationPrimaryMatch',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SafeIdentificationIdentification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SafeIdentificationIdentification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'primary_match')
        self.primary_match = attributes[:'primary_match']
      end

      if attributes.key?(:'environmental_probability')
        self.environmental_probability = attributes[:'environmental_probability']
      end

      if attributes.key?(:'growth_stage_detected')
        self.growth_stage_detected = attributes[:'growth_stage_detected']
      end
    end
    ...
    def valid?
      ...
      growth_stage_detected_validator = EnumAttributeValidator.new('String', ["seedling", "juvenile", "mature", "flowering", "fruiting"])
      return false unless growth_stage_detected_validator.valid?(@growth_stage_detected)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] growth_stage_detected Object to be assigned
    def growth_stage_detected=(growth_stage_detected)
      validator = EnumAttributeValidator.new('String', ["seedling", "juvenile", "mature", "flowering", "fruiting"])
      unless validator.valid?(growth_stage_detected)
        fail ArgumentError, "invalid value for \"growth_stage_detected\", must be one of #{validator.allowable_values}."
      end
      @growth_stage_detected = growth_stage_detected
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          environmental_probability == o.environmental_probability &&
          growth_stage_detected == o.growth_stage_detected
    end
    ...
    def hash
      [primary_match, environmental_probability, growth_stage_detected].hash
    end
