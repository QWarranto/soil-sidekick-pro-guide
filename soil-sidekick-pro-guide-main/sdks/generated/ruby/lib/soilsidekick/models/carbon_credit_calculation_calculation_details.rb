...
module SoilSidekick
  class CarbonCreditCalculationCalculationDetails
    attr_accessor :credits_earned

    attr_accessor :calculation_method

    attr_accessor :baseline_carbon

    attr_accessor :enhanced_carbon

    attr_accessor :verification_confidence
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::CarbonCreditCalculationCalculationDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::CarbonCreditCalculationCalculationDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'credits_earned')
        self.credits_earned = attributes[:'credits_earned']
      end
      ...
      if attributes.key?(:'baseline_carbon')
        self.baseline_carbon = attributes[:'baseline_carbon']
      end

      if attributes.key?(:'enhanced_carbon')
        self.enhanced_carbon = attributes[:'enhanced_carbon']
      end

      if attributes.key?(:'verification_confidence')
        self.verification_confidence = attributes[:'verification_confidence']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          credits_earned == o.credits_earned &&
          calculation_method == o.calculation_method &&
          baseline_carbon == o.baseline_carbon &&
          enhanced_carbon == o.enhanced_carbon &&
    ...
    def hash
      [credits_earned, calculation_method, baseline_carbon, enhanced_carbon, verification_confidence, metadata].hash
    end
