...
module SoilSidekick
  ...
  class DynamicCare
    ...
    attr_accessor :care_recommendations
    ...
    def self.openapi_types
      {
        ...
        :'current_conditions' => :'DynamicCareCurrentConditions',
        :'care_recommendations' => :'DynamicCareCareRecommendations',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCare` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCare`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'plant')
        self.plant = attributes[:'plant']
      end

      if attributes.key?(:'current_conditions')
        self.current_conditions = attributes[:'current_conditions']
      end

      if attributes.key?(:'care_recommendations')
        self.care_recommendations = attributes[:'care_recommendations']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          success == o.success &&
          plant == o.plant &&
          current_conditions == o.current_conditions &&
          care_recommendations == o.care_recommendations &&
          warnings == o.warnings &&
          metadata == o.metadata
    end
    ...
    def hash
      [success, plant, current_conditions, care_recommendations, warnings, metadata].hash
    end
