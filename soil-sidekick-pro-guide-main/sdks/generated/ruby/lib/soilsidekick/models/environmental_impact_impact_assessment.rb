...
module SoilSidekick
  class EnvironmentalImpactImpactAssessment
    attr_accessor :runoff_risk_score

    attr_accessor :water_body_proximity

    attr_accessor :contamination_risk

    attr_accessor :carbon_footprint_score

    attr_accessor :biodiversity_impact
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::EnvironmentalImpactImpactAssessment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::EnvironmentalImpactImpactAssessment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'runoff_risk_score')
        self.runoff_risk_score = attributes[:'runoff_risk_score']
      end

      if attributes.key?(:'water_body_proximity')
        self.water_body_proximity = attributes[:'water_body_proximity']
      end

      if attributes.key?(:'contamination_risk')
        self.contamination_risk = attributes[:'contamination_risk']
      end

      if attributes.key?(:'carbon_footprint_score')
        self.carbon_footprint_score = attributes[:'carbon_footprint_score']
      end

      if attributes.key?(:'biodiversity_impact')
        self.biodiversity_impact = attributes[:'biodiversity_impact']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          runoff_risk_score == o.runoff_risk_score &&
          water_body_proximity == o.water_body_proximity &&
          contamination_risk == o.contamination_risk &&
          carbon_footprint_score == o.carbon_footprint_score &&
          biodiversity_impact == o.biodiversity_impact
    end
    ...
    def hash
      [runoff_risk_score, water_body_proximity, contamination_risk, carbon_footprint_score, biodiversity_impact].hash
    end
