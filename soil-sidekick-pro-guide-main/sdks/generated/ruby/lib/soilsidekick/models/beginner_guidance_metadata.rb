...
module SoilSidekick
  class BeginnerGuidanceMetadata
    attr_accessor :expertise_level_used

    attr_accessor :plant_identified
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::BeginnerGuidanceMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::BeginnerGuidanceMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'expertise_level_used')
        self.expertise_level_used = attributes[:'expertise_level_used']
      end

      if attributes.key?(:'plant_identified')
        self.plant_identified = attributes[:'plant_identified']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          expertise_level_used == o.expertise_level_used &&
          plant_identified == o.plant_identified &&
    ...
    def hash
      [expertise_level_used, plant_identified, environmental_context].hash
    end
