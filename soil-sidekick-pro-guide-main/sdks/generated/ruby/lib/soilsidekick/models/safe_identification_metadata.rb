...
module SoilSidekick
  class SafeIdentificationMetadata
    attr_accessor :analysis_id

    attr_accessor :timestamp

    attr_accessor :environmental_data_used
    ...
    def self.openapi_types
      {
        :'analysis_id' => :'String',
        :'timestamp' => :'Time',
        :'environmental_data_used' => :'Array<String>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SafeIdentificationMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SafeIdentificationMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'environmental_data_used')
        if (value = attributes[:'environmental_data_used']).is_a?(Array)
          self.environmental_data_used = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          environmental_data_used == o.environmental_data_used
    end
    ...
    def hash
      [analysis_id, timestamp, environmental_data_used].hash
    end
