...
module SoilSidekick
  ...
  class SafeIdentification
    attr_accessor :success

    attr_accessor :identification

    attr_accessor :safety_analysis

    attr_accessor :confidence_breakdown
    ...
    def self.openapi_types
      {
        ...
        :'safety_analysis' => :'SafeIdentificationSafetyAnalysis',
        :'confidence_breakdown' => :'SafeIdentificationConfidenceBreakdown',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SafeIdentification` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SafeIdentification`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'safety_analysis')
        self.safety_analysis = attributes[:'safety_analysis']
      end

      if attributes.key?(:'confidence_breakdown')
        self.confidence_breakdown = attributes[:'confidence_breakdown']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          safety_analysis == o.safety_analysis &&
    ...
    def hash
      [success, identification, safety_analysis, confidence_breakdown, metadata].hash
    end
