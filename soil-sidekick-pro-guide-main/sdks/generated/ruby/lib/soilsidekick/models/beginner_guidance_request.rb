...
module SoilSidekick
  class BeginnerGuidanceRequest
    ...
    def self.openapi_types
      {
        :'question' => :'String',
        :'plant_context' => :'BeginnerGuidanceRequestPlantContext',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::BeginnerGuidanceRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::BeginnerGuidanceRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'plant_context')
        self.plant_context = attributes[:'plant_context']
      end
      ...
      if attributes.key?(:'user_expertise')
        self.user_expertise = attributes[:'user_expertise']
      else
        self.user_expertise = 'complete_beginner'
      end
    end
    ...
    def valid?
      ...
      user_expertise_validator = EnumAttributeValidator.new('String', ["complete_beginner", "some_experience", "intermediate"])
      return false unless user_expertise_validator.valid?(@user_expertise)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] user_expertise Object to be assigned
    def user_expertise=(user_expertise)
      validator = EnumAttributeValidator.new('String', ["complete_beginner", "some_experience", "intermediate"])
      unless validator.valid?(user_expertise)
        fail ArgumentError, "invalid value for \"user_expertise\", must be one of #{validator.allowable_values}."
      end
      @user_expertise = user_expertise
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          question == o.question &&
          plant_context == o.plant_context &&
          location == o.location &&
          user_expertise == o.user_expertise
    end
    ...
    def hash
      [question, plant_context, location, user_expertise].hash
    end
