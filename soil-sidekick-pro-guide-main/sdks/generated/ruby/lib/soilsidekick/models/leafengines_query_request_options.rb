...
module SoilSidekick
  class LeafenginesQueryRequestOptions
    attr_accessor :include_satellite_data

    attr_accessor :include_water_quality

    attr_accessor :include_recommendations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::LeafenginesQueryRequestOptions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::LeafenginesQueryRequestOptions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'include_satellite_data')
        self.include_satellite_data = attributes[:'include_satellite_data']
      end

      if attributes.key?(:'include_water_quality')
        self.include_water_quality = attributes[:'include_water_quality']
      end

      if attributes.key?(:'include_recommendations')
        self.include_recommendations = attributes[:'include_recommendations']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          include_satellite_data == o.include_satellite_data &&
          include_water_quality == o.include_water_quality &&
          include_recommendations == o.include_recommendations
    end
    ...
    def hash
      [include_satellite_data, include_water_quality, include_recommendations].hash
    end
