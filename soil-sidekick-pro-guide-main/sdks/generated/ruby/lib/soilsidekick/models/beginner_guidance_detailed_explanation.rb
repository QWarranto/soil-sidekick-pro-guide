...
module SoilSidekick
  ...
  class BeginnerGuidanceDetailedExplanation
    attr_accessor :technical_term

    attr_accessor :plain_english

    attr_accessor :common_causes

    attr_accessor :prevention_tips
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::BeginnerGuidanceDetailedExplanation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::BeginnerGuidanceDetailedExplanation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'technical_term')
        self.technical_term = attributes[:'technical_term']
      end

      if attributes.key?(:'plain_english')
        self.plain_english = attributes[:'plain_english']
      end

      if attributes.key?(:'common_causes')
        if (value = attributes[:'common_causes']).is_a?(Array)
          self.common_causes = value
        end
      end

      if attributes.key?(:'prevention_tips')
        if (value = attributes[:'prevention_tips']).is_a?(Array)
          self.prevention_tips = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          technical_term == o.technical_term &&
          plain_english == o.plain_english &&
          common_causes == o.common_causes &&
          prevention_tips == o.prevention_tips
    end
    ...
    def hash
      [technical_term, plain_english, common_causes, prevention_tips].hash
    end
