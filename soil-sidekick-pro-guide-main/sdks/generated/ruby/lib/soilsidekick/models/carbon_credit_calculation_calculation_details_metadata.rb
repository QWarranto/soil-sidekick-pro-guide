...
module SoilSidekick
  class CarbonCreditCalculationCalculationDetailsMetadata
    attr_accessor :calculation_factors
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::CarbonCreditCalculationCalculationDetailsMetadata` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::CarbonCreditCalculationCalculationDetailsMetadata`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'calculation_factors')
        self.calculation_factors = attributes[:'calculation_factors']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          calculation_factors == o.calculation_factors &&
    ...
    def hash
      [calculation_factors, data_sources, confidence_score].hash
    end
