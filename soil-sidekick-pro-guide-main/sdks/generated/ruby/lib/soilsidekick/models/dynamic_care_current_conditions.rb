...
module SoilSidekick
  class DynamicCareCurrentConditions
    attr_accessor :temperature_f

    attr_accessor :humidity_percent

    attr_accessor :recent_rainfall_inches

    attr_accessor :season

    attr_accessor :days_since_watered
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareCurrentConditions` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareCurrentConditions`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'temperature_f')
        self.temperature_f = attributes[:'temperature_f']
      end

      if attributes.key?(:'humidity_percent')
        self.humidity_percent = attributes[:'humidity_percent']
      end

      if attributes.key?(:'recent_rainfall_inches')
        self.recent_rainfall_inches = attributes[:'recent_rainfall_inches']
      end
      ...
      if attributes.key?(:'days_since_watered')
        self.days_since_watered = attributes[:'days_since_watered']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          temperature_f == o.temperature_f &&
          humidity_percent == o.humidity_percent &&
          recent_rainfall_inches == o.recent_rainfall_inches &&
          season == o.season &&
          days_since_watered == o.days_since_watered
    end
    ...
    def hash
      [temperature_f, humidity_percent, recent_rainfall_inches, season, days_since_watered].hash
    end
