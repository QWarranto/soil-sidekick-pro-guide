...
module SoilSidekick
  class SoilData
    ...
    attr_accessor :potassium_level

    attr_accessor :recommendations

    attr_accessor :analysis_data
    ...
    def self.openapi_types
      {
        ...
        :'analysis_data' => :'Hash<String, Object>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SoilData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SoilData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'potassium_level')
        self.potassium_level = attributes[:'potassium_level']
      end
      ...
      if attributes.key?(:'analysis_data')
        if (value = attributes[:'analysis_data']).is_a?(Hash)
          self.analysis_data = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          potassium_level == o.potassium_level &&
          recommendations == o.recommendations &&
          analysis_data == o.analysis_data
    end
    ...
    def hash
      [id, county_fips, county_name, state_code, ph_level, organic_matter, nitrogen_level, phosphorus_level, potassium_level, recommendations, analysis_data].hash
    end
