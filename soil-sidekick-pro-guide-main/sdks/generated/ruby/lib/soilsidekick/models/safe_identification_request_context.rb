...
module SoilSidekick
  class SafeIdentificationRequestContext
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SafeIdentificationRequestContext` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SafeIdentificationRequestContext`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'growth_stage')
        self.growth_stage = attributes[:'growth_stage']
      end
    end
    ...
    def valid?
      ...
      environment_validator = EnumAttributeValidator.new('String', ["wild", "garden", "indoor", "agricultural"])
      return false unless environment_validator.valid?(@environment)
      purpose_validator = EnumAttributeValidator.new('String', ["foraging", "gardening", "curiosity", "pet_safety"])
      return false unless purpose_validator.valid?(@purpose)
      growth_stage_validator = EnumAttributeValidator.new('String', ["seedling", "juvenile", "mature", "flowering", "fruiting"])
      return false unless growth_stage_validator.valid?(@growth_stage)
      true
    end
    ...
    def environment=(environment)
      validator = EnumAttributeValidator.new('String', ["wild", "garden", "indoor", "agricultural"])
    ...
    def purpose=(purpose)
      validator = EnumAttributeValidator.new('String', ["foraging", "gardening", "curiosity", "pet_safety"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] growth_stage Object to be assigned
    def growth_stage=(growth_stage)
      validator = EnumAttributeValidator.new('String', ["seedling", "juvenile", "mature", "flowering", "fruiting"])
      unless validator.valid?(growth_stage)
        fail ArgumentError, "invalid value for \"growth_stage\", must be one of #{validator.allowable_values}."
      end
      @growth_stage = growth_stage
    end
    ...
    def hash
      [environment, purpose, growth_stage].hash
    end
