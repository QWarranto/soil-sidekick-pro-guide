...
module SoilSidekick
  class GenerateVRTPrescriptionRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::GenerateVRTPrescriptionRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::GenerateVRTPrescriptionRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      application_type_validator = EnumAttributeValidator.new('String', ["fertilizer", "seed", "pesticide"])
    ...
    def application_type=(application_type)
      validator = EnumAttributeValidator.new('String', ["fertilizer", "seed", "pesticide"])
    ...
    def hash
      [field_id, application_type, soil_analysis_id].hash
    end
