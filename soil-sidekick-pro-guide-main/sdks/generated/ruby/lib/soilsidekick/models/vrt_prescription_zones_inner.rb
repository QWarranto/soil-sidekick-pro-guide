...
module SoilSidekick
  class VRTPrescriptionZonesInner
    attr_accessor :zone_id

    attr_accessor :application_rate
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::VRTPrescriptionZonesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::VRTPrescriptionZonesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'application_rate')
        self.application_rate = attributes[:'application_rate']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          zone_id == o.zone_id &&
          application_rate == o.application_rate &&
          geometry == o.geometry
    end
    ...
    def hash
      [zone_id, application_rate, geometry].hash
    end
