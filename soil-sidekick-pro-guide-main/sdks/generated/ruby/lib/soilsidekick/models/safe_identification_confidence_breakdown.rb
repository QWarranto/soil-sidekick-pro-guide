...
module SoilSidekick
  class SafeIdentificationConfidenceBreakdown
    attr_accessor :visual_match

    attr_accessor :environmental_context

    attr_accessor :regional_prevalence

    attr_accessor :growth_stage_alignment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SafeIdentificationConfidenceBreakdown` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SafeIdentificationConfidenceBreakdown`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'visual_match')
        self.visual_match = attributes[:'visual_match']
      end

      if attributes.key?(:'environmental_context')
        self.environmental_context = attributes[:'environmental_context']
      end

      if attributes.key?(:'regional_prevalence')
        self.regional_prevalence = attributes[:'regional_prevalence']
      end

      if attributes.key?(:'growth_stage_alignment')
        self.growth_stage_alignment = attributes[:'growth_stage_alignment']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          visual_match == o.visual_match &&
          environmental_context == o.environmental_context &&
          regional_prevalence == o.regional_prevalence &&
          growth_stage_alignment == o.growth_stage_alignment
    end
    ...
    def hash
      [visual_match, environmental_context, regional_prevalence, growth_stage_alignment].hash
    end
