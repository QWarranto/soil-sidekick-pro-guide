...
module SoilSidekick
  class SeasonalPlanningResponseWeatherData
    ...
    attr_accessor :frost_dates

    attr_accessor :growing_season
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SeasonalPlanningResponseWeatherData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SeasonalPlanningResponseWeatherData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rainfall')
        self.rainfall = attributes[:'rainfall']
      end

      if attributes.key?(:'frost_dates')
        self.frost_dates = attributes[:'frost_dates']
      end

      if attributes.key?(:'growing_season')
        self.growing_season = attributes[:'growing_season']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rainfall == o.rainfall &&
          frost_dates == o.frost_dates &&
          growing_season == o.growing_season &&
          zone == o.zone
    end
    ...
    def hash
      [current_season, temperature, rainfall, frost_dates, growing_season, zone].hash
    end
