...
module SoilSidekick
  class DynamicCareCareRecommendationsHumidity
    attr_accessor :current_level

    attr_accessor :ideal_range

    attr_accessor :adjustment_recommendation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareCareRecommendationsHumidity` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareCareRecommendationsHumidity`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ideal_range')
        self.ideal_range = attributes[:'ideal_range']
      end

      if attributes.key?(:'adjustment_recommendation')
        self.adjustment_recommendation = attributes[:'adjustment_recommendation']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ideal_range == o.ideal_range &&
          adjustment_recommendation == o.adjustment_recommendation
    end
    ...
    def hash
      [current_level, ideal_range, adjustment_recommendation].hash
    end
