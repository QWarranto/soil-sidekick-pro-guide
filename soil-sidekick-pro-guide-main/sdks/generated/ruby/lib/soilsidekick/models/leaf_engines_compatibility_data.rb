...
module SoilSidekick
  class LeafEnginesCompatibilityData
    # Overall compatibility score (0-100)
    attr_accessor :overall_score

    attr_accessor :soil_compatibility

    attr_accessor :water_compatibility

    attr_accessor :climate_compatibility
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::LeafEnginesCompatibilityData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::LeafEnginesCompatibilityData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'soil_compatibility')
        self.soil_compatibility = attributes[:'soil_compatibility']
      end

      if attributes.key?(:'water_compatibility')
        self.water_compatibility = attributes[:'water_compatibility']
      end

      if attributes.key?(:'climate_compatibility')
        self.climate_compatibility = attributes[:'climate_compatibility']
      end
    ...
    def valid?
      ...
      risk_level_validator = EnumAttributeValidator.new('String', ["low", "medium", "high"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          soil_compatibility == o.soil_compatibility &&
          water_compatibility == o.water_compatibility &&
          climate_compatibility == o.climate_compatibility &&
    ...
    def hash
      [overall_score, soil_compatibility, water_compatibility, climate_compatibility, breakdown, recommendations, risk_level, metadata].hash
    end
