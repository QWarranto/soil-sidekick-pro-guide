...
module SoilSidekick
  class TerritorialWaterAnalyticsAnalytics
    attr_accessor :territorial_coverage

    attr_accessor :water_quality_metrics

    attr_accessor :regional_insights
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::TerritorialWaterAnalyticsAnalytics` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::TerritorialWaterAnalyticsAnalytics`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'territorial_coverage')
        self.territorial_coverage = attributes[:'territorial_coverage']
      end

      if attributes.key?(:'water_quality_metrics')
        self.water_quality_metrics = attributes[:'water_quality_metrics']
      end

      if attributes.key?(:'regional_insights')
        self.regional_insights = attributes[:'regional_insights']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          territorial_coverage == o.territorial_coverage &&
          water_quality_metrics == o.water_quality_metrics &&
          regional_insights == o.regional_insights &&
    ...
    def hash
      [territorial_coverage, water_quality_metrics, regional_insights, compliance_status].hash
    end
