...
module SoilSidekick
  class SeasonalPlanningResponse
    ...
    def self.openapi_types
      {
        ...
        :'weather_data' => :'SeasonalPlanningResponseWeatherData',
        :'model_used' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::SeasonalPlanningResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::SeasonalPlanningResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'weather_data')
        self.weather_data = attributes[:'weather_data']
      end

      if attributes.key?(:'model_used')
        self.model_used = attributes[:'model_used']
      end
    end
    ...
    def hash
      [success, recommendations, weather_data, model_used].hash
    end
