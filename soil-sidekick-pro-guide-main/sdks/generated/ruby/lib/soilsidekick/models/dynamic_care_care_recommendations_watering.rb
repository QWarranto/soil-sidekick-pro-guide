...
module SoilSidekick
  class DynamicCareCareRecommendationsWatering
    attr_accessor :action

    attr_accessor :reasoning

    attr_accessor :next_check_days

    attr_accessor :amount_guidance
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareCareRecommendationsWatering` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareCareRecommendationsWatering`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'next_check_days')
        self.next_check_days = attributes[:'next_check_days']
      end

      if attributes.key?(:'amount_guidance')
        self.amount_guidance = attributes[:'amount_guidance']
      end
    end
    ...
    def valid?
      ...
      action_validator = EnumAttributeValidator.new('String', ["water_now", "wait", "check_soil", "reduce_frequency"])
    ...
    def action=(action)
      validator = EnumAttributeValidator.new('String', ["water_now", "wait", "check_soil", "reduce_frequency"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          next_check_days == o.next_check_days &&
          amount_guidance == o.amount_guidance
    end
    ...
    def hash
      [action, reasoning, next_check_days, amount_guidance].hash
    end
