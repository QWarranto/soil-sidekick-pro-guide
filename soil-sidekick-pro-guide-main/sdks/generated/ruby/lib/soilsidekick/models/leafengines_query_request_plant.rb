...
module SoilSidekick
  class LeafenginesQueryRequestPlant
    ...
    attr_accessor :care_requirements
    ...
    def self.openapi_types
      {
        ...
        :'plant_id' => :'String',
        :'care_requirements' => :'LeafenginesQueryRequestPlantCareRequirements'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::LeafenginesQueryRequestPlant` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::LeafenginesQueryRequestPlant`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'plant_id')
        self.plant_id = attributes[:'plant_id']
      end

      if attributes.key?(:'care_requirements')
        self.care_requirements = attributes[:'care_requirements']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          plant_id == o.plant_id &&
          care_requirements == o.care_requirements
    end
    ...
    def hash
      [common_name, scientific_name, plant_id, care_requirements].hash
    end
