...
module SoilSidekick
  class EnvironmentalImpactDetailedAnalysisRunoffRisk
    attr_accessor :score

    attr_accessor :risk_level

    attr_accessor :contributing_factors
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'contributing_factors')
        self.contributing_factors = attributes[:'contributing_factors']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          contributing_factors == o.contributing_factors
    end
    ...
    def hash
      [score, risk_level, contributing_factors].hash
    end
