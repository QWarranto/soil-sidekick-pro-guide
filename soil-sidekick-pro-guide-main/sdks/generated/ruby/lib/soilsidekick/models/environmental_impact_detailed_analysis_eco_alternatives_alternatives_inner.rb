...
module SoilSidekick
  class EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner
    ...
    attr_accessor :environmental_benefit

    attr_accessor :effectiveness_score
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'environmental_benefit')
        self.environmental_benefit = attributes[:'environmental_benefit']
      end

      if attributes.key?(:'effectiveness_score')
        self.effectiveness_score = attributes[:'effectiveness_score']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          environmental_benefit == o.environmental_benefit &&
    ...
    def hash
      [category, alternative, description, environmental_benefit, effectiveness_score].hash
    end
