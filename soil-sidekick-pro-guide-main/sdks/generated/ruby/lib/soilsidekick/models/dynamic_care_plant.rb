...
module SoilSidekick
  class DynamicCarePlant
    attr_accessor :common_name

    attr_accessor :scientific_name

    attr_accessor :care_difficulty
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCarePlant` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCarePlant`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scientific_name')
        self.scientific_name = attributes[:'scientific_name']
      end

      if attributes.key?(:'care_difficulty')
        self.care_difficulty = attributes[:'care_difficulty']
      end
    end
    ...
    def valid?
      ...
      care_difficulty_validator = EnumAttributeValidator.new('String', ["easy", "moderate", "challenging"])
      return false unless care_difficulty_validator.valid?(@care_difficulty)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] care_difficulty Object to be assigned
    def care_difficulty=(care_difficulty)
      validator = EnumAttributeValidator.new('String', ["easy", "moderate", "challenging"])
      unless validator.valid?(care_difficulty)
        fail ArgumentError, "invalid value for \"care_difficulty\", must be one of #{validator.allowable_values}."
      end
      @care_difficulty = care_difficulty
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          care_difficulty == o.care_difficulty
    end
    ...
    def hash
      [common_name, scientific_name, care_difficulty].hash
    end
