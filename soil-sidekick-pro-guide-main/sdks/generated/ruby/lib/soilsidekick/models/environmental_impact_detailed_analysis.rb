...
module SoilSidekick
  class EnvironmentalImpactDetailedAnalysis
    attr_accessor :runoff_risk

    attr_accessor :contamination_assessment

    attr_accessor :eco_alternatives

    attr_accessor :carbon_analysis

    attr_accessor :biodiversity_assessment
    ...
    def self.openapi_types
      {
        :'runoff_risk' => :'EnvironmentalImpactDetailedAnalysisRunoffRisk',
        :'contamination_assessment' => :'Object',
        :'eco_alternatives' => :'EnvironmentalImpactDetailedAnalysisEcoAlternatives',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::EnvironmentalImpactDetailedAnalysis` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::EnvironmentalImpactDetailedAnalysis`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'runoff_risk')
        self.runoff_risk = attributes[:'runoff_risk']
      end

      if attributes.key?(:'contamination_assessment')
        self.contamination_assessment = attributes[:'contamination_assessment']
      end

      if attributes.key?(:'eco_alternatives')
        self.eco_alternatives = attributes[:'eco_alternatives']
      end

      if attributes.key?(:'carbon_analysis')
        self.carbon_analysis = attributes[:'carbon_analysis']
      end

      if attributes.key?(:'biodiversity_assessment')
        self.biodiversity_assessment = attributes[:'biodiversity_assessment']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          runoff_risk == o.runoff_risk &&
          contamination_assessment == o.contamination_assessment &&
          eco_alternatives == o.eco_alternatives &&
          carbon_analysis == o.carbon_analysis &&
          biodiversity_assessment == o.biodiversity_assessment
    end
    ...
    def hash
      [runoff_risk, contamination_assessment, eco_alternatives, carbon_analysis, biodiversity_assessment].hash
    end
