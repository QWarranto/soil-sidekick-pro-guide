...
module SoilSidekick
  class DynamicCareRequestContainerDetails
    attr_accessor :type

    attr_accessor :size_inches

    attr_accessor :has_drainage
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareRequestContainerDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareRequestContainerDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'size_inches')
        self.size_inches = attributes[:'size_inches']
      end

      if attributes.key?(:'has_drainage')
        self.has_drainage = attributes[:'has_drainage']
      end
    end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["terracotta", "plastic", "ceramic", "fabric", "ground"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["terracotta", "plastic", "ceramic", "fabric", "ground"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          type == o.type &&
          size_inches == o.size_inches &&
          has_drainage == o.has_drainage
    end
    ...
    def hash
      [type, size_inches, has_drainage].hash
    end
