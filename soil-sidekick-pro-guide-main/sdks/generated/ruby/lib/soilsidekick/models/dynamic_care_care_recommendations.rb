...
module SoilSidekick
  class DynamicCareCareRecommendations
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SoilSidekick::DynamicCareCareRecommendations` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SoilSidekick::DynamicCareCareRecommendations`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'watering')
        self.watering = attributes[:'watering']
      end
      ...
      if attributes.key?(:'seasonal_notes')
        self.seasonal_notes = attributes[:'seasonal_notes']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          light == o.light &&
          humidity == o.humidity &&
          seasonal_notes == o.seasonal_notes
    end
    ...
    def hash
      [watering, light, humidity, seasonal_notes].hash
    end
