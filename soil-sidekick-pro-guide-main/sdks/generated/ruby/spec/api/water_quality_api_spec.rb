...
# Unit tests for SoilSidekick::WaterQualityApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'WaterQualityApi' do
  before do
  ...
  describe 'test an instance of WaterQualityApi' do
    it 'should create an instance of WaterQualityApi' do
      expect(@api_instance).to be_instance_of(SoilSidekick::WaterQualityApi)
    end
  end

  # unit tests for get_territorial_water_analytics
  # Get territorial water analytics
  # Generate territorial water quality analytics across regions
  # @param get_territorial_water_analytics_request 
  # @param [Hash] opts the optional parameters
  # @return [TerritorialWaterAnalytics]
  describe 'get_territorial_water_analytics test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_water_quality
  # Get water quality data
  # Retrieve water quality metrics for a specific county
  # @param get_water_quality_request 
  # @param [Hash] opts the optional parameters
  # @return [WaterQuality]
  describe 'get_water_quality test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
