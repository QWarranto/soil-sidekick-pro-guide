...
# Unit tests for SoilSidekick::GetSatelliteDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetSatelliteDataRequest do
  let(:instance) { SoilSidekick::GetSatelliteDataRequest.new }

  describe 'test an instance of GetSatelliteDataRequest' do
    it 'should create an instance of GetSatelliteDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetSatelliteDataRequest)
    end
  end
