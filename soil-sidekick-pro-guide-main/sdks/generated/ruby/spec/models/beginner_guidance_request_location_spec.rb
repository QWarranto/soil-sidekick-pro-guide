...
# Unit tests for SoilSidekick::BeginnerGuidanceRequestLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidanceRequestLocation do
  let(:instance) { SoilSidekick::BeginnerGuidanceRequestLocation.new }

  describe 'test an instance of BeginnerGuidanceRequestLocation' do
    it 'should create an instance of BeginnerGuidanceRequestLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidanceRequestLocation)
    end
  end
