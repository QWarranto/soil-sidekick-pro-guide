...
# Unit tests for SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner do
  let(:instance) { SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner.new }

  describe 'test an instance of EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner' do
    it 'should create an instance of EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner)
    end
  end
  ...
  describe 'test attribute "environmental_benefit"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "effectiveness_score"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
