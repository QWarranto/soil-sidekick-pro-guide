...
# Unit tests for SoilSidekick::TQContextMode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::TQContextMode do
  let(:instance) { SoilSidekick::TQContextMode.new }

  describe 'test an instance of TQContextMode' do
    it 'should create an instance of TQContextMode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::TQContextMode)
    end
  end
