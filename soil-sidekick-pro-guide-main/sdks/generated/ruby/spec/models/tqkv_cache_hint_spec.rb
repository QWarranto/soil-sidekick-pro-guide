...
# Unit tests for SoilSidekick::TQKVCacheHint
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::TQKVCacheHint do
  let(:instance) { SoilSidekick::TQKVCacheHint.new }

  describe 'test an instance of TQKVCacheHint' do
    it 'should create an instance of TQKVCacheHint' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::TQKVCacheHint)
    end
  end
