...
# Unit tests for SoilSidekick::LeafenginesQueryRequestLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequestLocation do
  let(:instance) { SoilSidekick::LeafenginesQueryRequestLocation.new }

  describe 'test an instance of LeafenginesQueryRequestLocation' do
    it 'should create an instance of LeafenginesQueryRequestLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequestLocation)
    end
  end
