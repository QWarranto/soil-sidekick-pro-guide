...
# Unit tests for SoilSidekick::VRTPrescriptionZonesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VRTPrescriptionZonesInner do
  let(:instance) { SoilSidekick::VRTPrescriptionZonesInner.new }

  describe 'test an instance of VRTPrescriptionZonesInner' do
    it 'should create an instance of VRTPrescriptionZonesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VRTPrescriptionZonesInner)
    end
  end
  ...
  describe 'test attribute "application_rate"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
