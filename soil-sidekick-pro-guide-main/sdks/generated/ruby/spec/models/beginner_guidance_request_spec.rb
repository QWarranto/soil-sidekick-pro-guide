...
# Unit tests for SoilSidekick::BeginnerGuidanceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidanceRequest do
  let(:instance) { SoilSidekick::BeginnerGuidanceRequest.new }

  describe 'test an instance of BeginnerGuidanceRequest' do
    it 'should create an instance of BeginnerGuidanceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidanceRequest)
    end
  end
  ...
  describe 'test attribute "plant_context"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "user_expertise"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["complete_beginner", "some_experience", "intermediate"])
      # validator.allowable_values.each do |value|
      #   expect { instance.user_expertise = value }.not_to raise_error
      # end
    end
  end
