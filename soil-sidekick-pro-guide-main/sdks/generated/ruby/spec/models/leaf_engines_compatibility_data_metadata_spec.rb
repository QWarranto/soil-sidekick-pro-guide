...
# Unit tests for SoilSidekick::LeafEnginesCompatibilityDataMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibilityDataMetadata do
  let(:instance) { SoilSidekick::LeafEnginesCompatibilityDataMetadata.new }

  describe 'test an instance of LeafEnginesCompatibilityDataMetadata' do
    it 'should create an instance of LeafEnginesCompatibilityDataMetadata' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibilityDataMetadata)
    end
  end
