...
# Unit tests for SoilSidekick::LeafenginesQueryRequestPlantCareRequirements
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequestPlantCareRequirements do
  let(:instance) { SoilSidekick::LeafenginesQueryRequestPlantCareRequirements.new }

  describe 'test an instance of LeafenginesQueryRequestPlantCareRequirements' do
    it 'should create an instance of LeafenginesQueryRequestPlantCareRequirements' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequestPlantCareRequirements)
    end
  end

  describe 'test attribute "sun_exposure"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["full_sun", "partial_shade", "full_shade"])
      # validator.allowable_values.each do |value|
      #   expect { instance.sun_exposure = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "water_needs"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["low", "medium", "high"])
      # validator.allowable_values.each do |value|
      #   expect { instance.water_needs = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "soil_ph_range"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
