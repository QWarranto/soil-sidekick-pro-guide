...
# Unit tests for SoilSidekick::VisualCropAnalysisRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VisualCropAnalysisRequest do
  let(:instance) { SoilSidekick::VisualCropAnalysisRequest.new }

  describe 'test an instance of VisualCropAnalysisRequest' do
    it 'should create an instance of VisualCropAnalysisRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VisualCropAnalysisRequest)
    end
  end
  ...
  describe 'test attribute "analysis_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pest_detection", "crop_health", "disease_screening"])
  ...
  describe 'test attribute "crop_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
