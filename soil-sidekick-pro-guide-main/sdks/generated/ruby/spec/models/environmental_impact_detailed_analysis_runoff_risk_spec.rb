...
# Unit tests for SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk do
  let(:instance) { SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk.new }

  describe 'test an instance of EnvironmentalImpactDetailedAnalysisRunoffRisk' do
    it 'should create an instance of EnvironmentalImpactDetailedAnalysisRunoffRisk' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::EnvironmentalImpactDetailedAnalysisRunoffRisk)
    end
  end
  ...
  describe 'test attribute "contributing_factors"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
