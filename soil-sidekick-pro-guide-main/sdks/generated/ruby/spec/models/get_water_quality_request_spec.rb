...
# Unit tests for SoilSidekick::GetWaterQualityRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetWaterQualityRequest do
  let(:instance) { SoilSidekick::GetWaterQualityRequest.new }

  describe 'test an instance of GetWaterQualityRequest' do
    it 'should create an instance of GetWaterQualityRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetWaterQualityRequest)
    end
  end
