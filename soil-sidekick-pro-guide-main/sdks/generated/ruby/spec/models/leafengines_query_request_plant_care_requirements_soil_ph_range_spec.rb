...
# Unit tests for SoilSidekick::LeafenginesQueryRequestPlantCareRequirementsSoilPhRange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequestPlantCareRequirementsSoilPhRange do
  let(:instance) { SoilSidekick::LeafenginesQueryRequestPlantCareRequirementsSoilPhRange.new }

  describe 'test an instance of LeafenginesQueryRequestPlantCareRequirementsSoilPhRange' do
    it 'should create an instance of LeafenginesQueryRequestPlantCareRequirementsSoilPhRange' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequestPlantCareRequirementsSoilPhRange)
    end
  end
