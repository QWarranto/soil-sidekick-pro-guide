...
# Unit tests for SoilSidekick::GetTerritorialWaterAnalyticsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetTerritorialWaterAnalyticsRequest do
  let(:instance) { SoilSidekick::GetTerritorialWaterAnalyticsRequest.new }

  describe 'test an instance of GetTerritorialWaterAnalyticsRequest' do
    it 'should create an instance of GetTerritorialWaterAnalyticsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetTerritorialWaterAnalyticsRequest)
    end
  end

  describe 'test attribute "territory_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["state", "territory", "compact_state"])
      # validator.allowable_values.each do |value|
      #   expect { instance.territory_type = value }.not_to raise_error
      # end
    end
  end

  describe 'test attribute "epa_region"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
