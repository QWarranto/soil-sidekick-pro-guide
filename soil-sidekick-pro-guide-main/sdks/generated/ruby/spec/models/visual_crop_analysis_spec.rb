...
# Unit tests for SoilSidekick::VisualCropAnalysis
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VisualCropAnalysis do
  let(:instance) { SoilSidekick::VisualCropAnalysis.new }

  describe 'test an instance of VisualCropAnalysis' do
    it 'should create an instance of VisualCropAnalysis' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VisualCropAnalysis)
    end
  end
