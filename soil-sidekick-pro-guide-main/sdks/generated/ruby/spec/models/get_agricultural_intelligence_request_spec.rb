...
# Unit tests for SoilSidekick::GetAgriculturalIntelligenceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetAgriculturalIntelligenceRequest do
  let(:instance) { SoilSidekick::GetAgriculturalIntelligenceRequest.new }

  describe 'test an instance of GetAgriculturalIntelligenceRequest' do
    it 'should create an instance of GetAgriculturalIntelligenceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetAgriculturalIntelligenceRequest)
    end
  end
  ...
  describe 'test attribute "analysis_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["crop_recommendation", "yield_prediction", "pest_analysis"])
