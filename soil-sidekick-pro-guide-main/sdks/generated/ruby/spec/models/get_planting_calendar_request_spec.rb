...
# Unit tests for SoilSidekick::GetPlantingCalendarRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetPlantingCalendarRequest do
  let(:instance) { SoilSidekick::GetPlantingCalendarRequest.new }

  describe 'test an instance of GetPlantingCalendarRequest' do
    it 'should create an instance of GetPlantingCalendarRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetPlantingCalendarRequest)
    end
  end
