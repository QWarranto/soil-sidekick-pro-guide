...
# Unit tests for SoilSidekick::BeginnerGuidanceRequestPlantContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidanceRequestPlantContext do
  let(:instance) { SoilSidekick::BeginnerGuidanceRequestPlantContext.new }

  describe 'test an instance of BeginnerGuidanceRequestPlantContext' do
    it 'should create an instance of BeginnerGuidanceRequestPlantContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidanceRequestPlantContext)
    end
  end
