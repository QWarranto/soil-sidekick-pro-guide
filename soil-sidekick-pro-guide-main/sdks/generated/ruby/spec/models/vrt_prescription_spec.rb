...
# Unit tests for SoilSidekick::VRTPrescription
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::VRTPrescription do
  let(:instance) { SoilSidekick::VRTPrescription.new }

  describe 'test an instance of VRTPrescription' do
    it 'should create an instance of VRTPrescription' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::VRTPrescription)
    end
  end
