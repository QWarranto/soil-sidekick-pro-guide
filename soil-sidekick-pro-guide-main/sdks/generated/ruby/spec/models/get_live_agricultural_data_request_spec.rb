...
# Unit tests for SoilSidekick::GetLiveAgriculturalDataRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetLiveAgriculturalDataRequest do
  let(:instance) { SoilSidekick::GetLiveAgriculturalDataRequest.new }

  describe 'test an instance of GetLiveAgriculturalDataRequest' do
    it 'should create an instance of GetLiveAgriculturalDataRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetLiveAgriculturalDataRequest)
    end
  end
  ...
  describe 'test attribute "data_types"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["weather", "soil", "crop", "environmental"])
      # validator.allowable_values.each do |value|
      #   expect { instance.data_types = value }.not_to raise_error
      # end
    end
  end
