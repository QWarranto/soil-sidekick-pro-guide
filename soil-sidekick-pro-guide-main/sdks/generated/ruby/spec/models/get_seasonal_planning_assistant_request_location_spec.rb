...
# Unit tests for SoilSidekick::GetSeasonalPlanningAssistantRequestLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::GetSeasonalPlanningAssistantRequestLocation do
  let(:instance) { SoilSidekick::GetSeasonalPlanningAssistantRequestLocation.new }

  describe 'test an instance of GetSeasonalPlanningAssistantRequestLocation' do
    it 'should create an instance of GetSeasonalPlanningAssistantRequestLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::GetSeasonalPlanningAssistantRequestLocation)
    end
  end
