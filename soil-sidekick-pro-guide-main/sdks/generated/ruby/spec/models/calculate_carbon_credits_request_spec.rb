...
# Unit tests for SoilSidekick::CalculateCarbonCreditsRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::CalculateCarbonCreditsRequest do
  let(:instance) { SoilSidekick::CalculateCarbonCreditsRequest.new }

  describe 'test an instance of CalculateCarbonCreditsRequest' do
    it 'should create an instance of CalculateCarbonCreditsRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::CalculateCarbonCreditsRequest)
    end
  end
  ...
  describe 'test attribute "soil_organic_matter"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "soil_analysis_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "verification_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["self_reported", "third_party", "satellite"])
