...
# Unit tests for SoilSidekick::SafeIdentificationConfidenceBreakdown
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::SafeIdentificationConfidenceBreakdown do
  let(:instance) { SoilSidekick::SafeIdentificationConfidenceBreakdown.new }

  describe 'test an instance of SafeIdentificationConfidenceBreakdown' do
    it 'should create an instance of SafeIdentificationConfidenceBreakdown' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::SafeIdentificationConfidenceBreakdown)
    end
  end

  describe 'test attribute "visual_match"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "environmental_context"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "regional_prevalence"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "growth_stage_alignment"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
