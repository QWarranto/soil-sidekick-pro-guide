...
# Unit tests for SoilSidekick::LeafenginesQueryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafenginesQueryRequest do
  let(:instance) { SoilSidekick::LeafenginesQueryRequest.new }

  describe 'test an instance of LeafenginesQueryRequest' do
    it 'should create an instance of LeafenginesQueryRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafenginesQueryRequest)
    end
  end
