...
# Unit tests for SoilSidekick::LeafEnginesCompatibilityData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::LeafEnginesCompatibilityData do
  let(:instance) { SoilSidekick::LeafEnginesCompatibilityData.new }

  describe 'test an instance of LeafEnginesCompatibilityData' do
    it 'should create an instance of LeafEnginesCompatibilityData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::LeafEnginesCompatibilityData)
    end
  end
  ...
  describe 'test attribute "soil_compatibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "water_compatibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "climate_compatibility"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
