...
# Unit tests for SoilSidekick::BeginnerGuidanceDetailedExplanation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidanceDetailedExplanation do
  let(:instance) { SoilSidekick::BeginnerGuidanceDetailedExplanation.new }

  describe 'test an instance of BeginnerGuidanceDetailedExplanation' do
    it 'should create an instance of BeginnerGuidanceDetailedExplanation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidanceDetailedExplanation)
    end
  end

  describe 'test attribute "technical_term"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "plain_english"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "prevention_tips"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
