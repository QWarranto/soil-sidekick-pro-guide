...
# Unit tests for SoilSidekick::BeginnerGuidance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidance do
  let(:instance) { SoilSidekick::BeginnerGuidance.new }

  describe 'test an instance of BeginnerGuidance' do
    it 'should create an instance of BeginnerGuidance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidance)
    end
  end
  ...
  describe 'test attribute "simple_answer"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "what_to_do_now"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "why_this_happens"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "detailed_explanation"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "encouragement"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "related_questions"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
