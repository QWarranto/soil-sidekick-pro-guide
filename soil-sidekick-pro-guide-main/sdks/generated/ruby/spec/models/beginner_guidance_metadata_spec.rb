...
# Unit tests for SoilSidekick::BeginnerGuidanceMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe SoilSidekick::BeginnerGuidanceMetadata do
  let(:instance) { SoilSidekick::BeginnerGuidanceMetadata.new }

  describe 'test an instance of BeginnerGuidanceMetadata' do
    it 'should create an instance of BeginnerGuidanceMetadata' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(SoilSidekick::BeginnerGuidanceMetadata)
    end
  end

  describe 'test attribute "expertise_level_used"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "plant_identified"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
