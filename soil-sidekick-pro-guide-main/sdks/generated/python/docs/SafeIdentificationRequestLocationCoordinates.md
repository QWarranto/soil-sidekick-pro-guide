...
safe_identification_request_location_coordinates_form_dict = safe_identification_request_location_coordinates.from_dict(safe_identification_request_location_coordinates_dict)
```
