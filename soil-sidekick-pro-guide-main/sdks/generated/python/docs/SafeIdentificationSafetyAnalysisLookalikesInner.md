...
safe_identification_safety_analysis_lookalikes_inner_form_dict = safe_identification_safety_analysis_lookalikes_inner.from_dict(safe_identification_safety_analysis_lookalikes_inner_dict)
```
