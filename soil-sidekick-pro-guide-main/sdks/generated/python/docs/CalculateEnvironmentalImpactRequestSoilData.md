...
calculate_environmental_impact_request_soil_data_form_dict = calculate_environmental_impact_request_soil_data.from_dict(calculate_environmental_impact_request_soil_data_dict)
```
