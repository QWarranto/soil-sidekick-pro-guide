...
with soilsidekick.ApiClient(configuration) as api_client:
    ...
    api_instance = soilsidekick.CarbonApi(api_client)
    calculate_carbon_credits_request = soilsidekick.CalculateCarbonCreditsRequest() # CalculateCarbonCreditsRequest | 

    try:
        # Calculate carbon credits
        api_response = api_instance.calculate_carbon_credits(calculate_carbon_credits_request)
        print("The response of CarbonApi->calculate_carbon_credits:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CarbonApi->calculate_carbon_credits: %s\n" % e)
```
