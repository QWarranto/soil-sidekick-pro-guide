...
class SafeIdentificationIdentification(BaseModel):
    ...
    def growth_stage_detected_validate_enum(cls, value):
        ...
        if value not in ('seedling', 'juvenile', 'mature', 'flowering', 'fruiting'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "primary_match": SafeIdentificationIdentificationPrimaryMatch.from_dict(obj.get("primary_match")) if obj.get("primary_match") is not None else None,
