...
class EnvironmentalImpactDetailedAnalysis(BaseModel):
    """
    EnvironmentalImpactDetailedAnalysis
    """ # noqa: E501
    runoff_risk: Optional[EnvironmentalImpactDetailedAnalysisRunoffRisk] = None
    contamination_assessment: Optional[Dict[str, Any]] = None
    eco_alternatives: Optional[EnvironmentalImpactDetailedAnalysisEcoAlternatives] = None
    carbon_analysis: Optional[Dict[str, Any]] = None
    biodiversity_assessment: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["runoff_risk", "contamination_assessment", "eco_alternatives", "carbon_analysis", "biodiversity_assessment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of runoff_risk
        if self.runoff_risk:
            _dict['runoff_risk'] = self.runoff_risk.to_dict()
        # override the default output from pydantic by calling `to_dict()` of eco_alternatives
        if self.eco_alternatives:
            _dict['eco_alternatives'] = self.eco_alternatives.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "runoff_risk": EnvironmentalImpactDetailedAnalysisRunoffRisk.from_dict(obj.get("runoff_risk")) if obj.get("runoff_risk") is not None else None,
            "contamination_assessment": obj.get("contamination_assessment"),
            "eco_alternatives": EnvironmentalImpactDetailedAnalysisEcoAlternatives.from_dict(obj.get("eco_alternatives")) if obj.get("eco_alternatives") is not None else None,
            "carbon_analysis": obj.get("carbon_analysis"),
            "biodiversity_assessment": obj.get("biodiversity_assessment")
        })
        return _obj
