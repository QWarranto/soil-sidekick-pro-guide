...
class SafeIdentificationSafetyAnalysis(BaseModel):
    ...
    def toxicity_level_validate_enum(cls, value):
        ...
        if value not in ('safe', 'mildly_toxic', 'toxic', 'highly_toxic'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "lookalikes": [SafeIdentificationSafetyAnalysisLookalikesInner.from_dict(_item) for _item in obj.get("lookalikes")] if obj.get("lookalikes") is not None else None,
