...
class CarbonCreditCalculationCalculationDetails(BaseModel):
    """
    CarbonCreditCalculationCalculationDetails
    """ # noqa: E501
    credits_earned: Optional[Union[StrictFloat, StrictInt]] = None
    calculation_method: Optional[StrictStr] = None
    baseline_carbon: Optional[Union[StrictFloat, StrictInt]] = None
    enhanced_carbon: Optional[Union[StrictFloat, StrictInt]] = None
    verification_confidence: Optional[Union[StrictFloat, StrictInt]] = None
    metadata: Optional[CarbonCreditCalculationCalculationDetailsMetadata] = None
    __properties: ClassVar[List[str]] = ["credits_earned", "calculation_method", "baseline_carbon", "enhanced_carbon", "verification_confidence", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "credits_earned": obj.get("credits_earned"),
            "calculation_method": obj.get("calculation_method"),
            "baseline_carbon": obj.get("baseline_carbon"),
            "enhanced_carbon": obj.get("enhanced_carbon"),
            "verification_confidence": obj.get("verification_confidence"),
            "metadata": CarbonCreditCalculationCalculationDetailsMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
