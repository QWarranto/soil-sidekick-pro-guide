...
class LeafEnginesCompatibility(BaseModel):
    """
    LeafEnginesCompatibility
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[LeafEnginesCompatibilityData] = None
    usage: Optional[LeafEnginesCompatibilityUsage] = None
    __properties: ClassVar[List[str]] = ["success", "data", "usage"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "data": LeafEnginesCompatibilityData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "usage": LeafEnginesCompatibilityUsage.from_dict(obj.get("usage")) if obj.get("usage") is not None else None
        })
        return _obj
