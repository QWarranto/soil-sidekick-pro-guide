...
class CalculateCarbonCreditsRequest(BaseModel):
    """
    CalculateCarbonCreditsRequest
    """ # noqa: E501
    field_name: StrictStr = Field(description="Name of the field")
    field_size_acres: Union[Annotated[float, Field(strict=True, ge=0.1)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="Field size in acres")
    soil_organic_matter: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Soil organic matter percentage")
    soil_analysis_id: Optional[StrictStr] = Field(default=None, description="Reference to existing soil analysis")
    verification_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["field_name", "field_size_acres", "soil_organic_matter", "soil_analysis_id", "verification_type"]
    ...
    def verification_type_validate_enum(cls, value):
        ...
        if value not in ('self_reported', 'third_party', 'satellite'):
            raise ValueError("must be one of enum values ('self_reported', 'third_party', 'satellite')")
        return value
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "field_size_acres": obj.get("field_size_acres"),
            "soil_organic_matter": obj.get("soil_organic_matter"),
            "soil_analysis_id": obj.get("soil_analysis_id"),
