...
class SafeIdentificationIdentificationPrimaryMatch(BaseModel):
    """
    SafeIdentificationIdentificationPrimaryMatch
    """ # noqa: E501
    common_name: Optional[StrictStr] = None
    scientific_name: Optional[StrictStr] = None
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence percentage (0-100)")
    family: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["common_name", "scientific_name", "confidence", "family"]
