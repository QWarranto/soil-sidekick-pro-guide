...
class LeafEnginesCompatibilityData(BaseModel):
    """
    LeafEnginesCompatibilityData
    """ # noqa: E501
    overall_score: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Overall compatibility score (0-100)")
    soil_compatibility: Optional[Union[StrictFloat, StrictInt]] = None
    water_compatibility: Optional[Union[StrictFloat, StrictInt]] = None
    climate_compatibility: Optional[Union[StrictFloat, StrictInt]] = None
    breakdown: Optional[LeafEnginesCompatibilityDataBreakdown] = None
    recommendations: Optional[List[StrictStr]] = None
    risk_level: Optional[StrictStr] = None
    metadata: Optional[LeafEnginesCompatibilityDataMetadata] = None
    __properties: ClassVar[List[str]] = ["overall_score", "soil_compatibility", "water_compatibility", "climate_compatibility", "breakdown", "recommendations", "risk_level", "metadata"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "soil_compatibility": obj.get("soil_compatibility"),
            "water_compatibility": obj.get("water_compatibility"),
            "climate_compatibility": obj.get("climate_compatibility"),
            "breakdown": LeafEnginesCompatibilityDataBreakdown.from_dict(obj.get("breakdown")) if obj.get("breakdown") is not None else None,
            "recommendations": obj.get("recommendations"),
            "risk_level": obj.get("risk_level"),
            "metadata": LeafEnginesCompatibilityDataMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
