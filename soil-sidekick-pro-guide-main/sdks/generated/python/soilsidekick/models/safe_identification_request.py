...
class SafeIdentificationRequest(BaseModel):
    """
    SafeIdentificationRequest
    """ # noqa: E501
    image: StrictStr = Field(description="Base64 encoded image or image URL")
    location: Optional[SafeIdentificationRequestLocation] = None
    context: Optional[SafeIdentificationRequestContext] = None
    __properties: ClassVar[List[str]] = ["image", "location", "context"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "image": obj.get("image"),
            "location": SafeIdentificationRequestLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
            "context": SafeIdentificationRequestContext.from_dict(obj.get("context")) if obj.get("context") is not None else None
        })
        return _obj
