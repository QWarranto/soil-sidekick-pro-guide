...
class BeginnerGuidanceRequestPlantContext(BaseModel):
    """
    BeginnerGuidanceRequestPlantContext
    """ # noqa: E501
    plant_name: Optional[StrictStr] = Field(default=None, description="Common plant name if known")
    image: Optional[StrictStr] = Field(default=None, description="Base64 image for context")
    __properties: ClassVar[List[str]] = ["plant_name", "image"]
