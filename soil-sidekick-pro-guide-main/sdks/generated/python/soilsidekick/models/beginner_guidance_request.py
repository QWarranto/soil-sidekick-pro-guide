...
class BeginnerGuidanceRequest(BaseModel):
    ...
    """ # noqa: E501
    question: StrictStr = Field(description="User's plant question in natural language")
    ...
    def user_expertise_validate_enum(cls, value):
        ...
        if value not in ('complete_beginner', 'some_experience', 'intermediate'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "plant_context": BeginnerGuidanceRequestPlantContext.from_dict(obj.get("plant_context")) if obj.get("plant_context") is not None else None,
            "location": BeginnerGuidanceRequestLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
