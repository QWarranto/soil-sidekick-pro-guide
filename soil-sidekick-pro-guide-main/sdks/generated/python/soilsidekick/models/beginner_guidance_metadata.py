...
class BeginnerGuidanceMetadata(BaseModel):
    """
    BeginnerGuidanceMetadata
    """ # noqa: E501
    expertise_level_used: Optional[StrictStr] = None
    plant_identified: Optional[StrictBool] = None
    environmental_context: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["expertise_level_used", "plant_identified", "environmental_context"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "expertise_level_used": obj.get("expertise_level_used"),
            "plant_identified": obj.get("plant_identified"),
