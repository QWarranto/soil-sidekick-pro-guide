...
class EnvironmentalImpact(BaseModel):
    ...
    EnvironmentalImpact
    """ # noqa: E501
    impact_assessment: Optional[EnvironmentalImpactImpactAssessment] = None
    detailed_analysis: Optional[EnvironmentalImpactDetailedAnalysis] = None
    recommendations: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["impact_assessment", "detailed_analysis", "recommendations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of impact_assessment
        if self.impact_assessment:
            _dict['impact_assessment'] = self.impact_assessment.to_dict()
        # override the default output from pydantic by calling `to_dict()` of detailed_analysis
        if self.detailed_analysis:
            _dict['detailed_analysis'] = self.detailed_analysis.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "impact_assessment": EnvironmentalImpactImpactAssessment.from_dict(obj.get("impact_assessment")) if obj.get("impact_assessment") is not None else None,
            "detailed_analysis": EnvironmentalImpactDetailedAnalysis.from_dict(obj.get("detailed_analysis")) if obj.get("detailed_analysis") is not None else None,
