...
class TerritorialWaterAnalytics(BaseModel):
    """
    TerritorialWaterAnalytics
    """ # noqa: E501
    success: Optional[StrictBool] = None
    analytics: Optional[TerritorialWaterAnalyticsAnalytics] = None
    generated_at: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["success", "analytics", "generated_at"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "analytics": TerritorialWaterAnalyticsAnalytics.from_dict(obj.get("analytics")) if obj.get("analytics") is not None else None,
