...
class PlantingCalendar(BaseModel):
    ...
    PlantingCalendar
    """ # noqa: E501
    crop_type: Optional[StrictStr] = None
    optimal_planting_window: Optional[GetTerritorialWaterAnalyticsRequestDateRange] = None
    climate_factors: Optional[Dict[str, Any]] = None
    soil_factors: Optional[Dict[str, Any]] = None
    recommendations: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["crop_type", "optimal_planting_window", "climate_factors", "soil_factors", "recommendations"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of optimal_planting_window
        if self.optimal_planting_window:
            _dict['optimal_planting_window'] = self.optimal_planting_window.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "optimal_planting_window": GetTerritorialWaterAnalyticsRequestDateRange.from_dict(obj.get("optimal_planting_window")) if obj.get("optimal_planting_window") is not None else None,
            "climate_factors": obj.get("climate_factors"),
            "soil_factors": obj.get("soil_factors"),
