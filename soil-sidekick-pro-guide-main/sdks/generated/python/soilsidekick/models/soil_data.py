...
class SoilData(BaseModel):
    ...
    county_fips: Optional[StrictStr] = None
    county_name: Optional[StrictStr] = None
    ...
    potassium_level: Optional[StrictStr] = None
    recommendations: Optional[StrictStr] = None
    analysis_data: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "county_fips", "county_name", "state_code", "ph_level", "organic_matter", "nitrogen_level", "phosphorus_level", "potassium_level", "recommendations", "analysis_data"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "potassium_level": obj.get("potassium_level"),
