...
class VisualCropAnalysis(BaseModel):
    """
    VisualCropAnalysis
    """ # noqa: E501
    success: Optional[StrictBool] = None
    analysis: Optional[VisualCropAnalysisAnalysis] = None
    analysis_id: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    __properties: ClassVar[List[str]] = ["success", "analysis", "analysis_id", "timestamp"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "analysis": VisualCropAnalysisAnalysis.from_dict(obj.get("analysis")) if obj.get("analysis") is not None else None,
