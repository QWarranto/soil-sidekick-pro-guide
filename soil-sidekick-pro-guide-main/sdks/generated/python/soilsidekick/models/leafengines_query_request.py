...
class LeafenginesQueryRequest(BaseModel):
    """
    LeafenginesQueryRequest
    """ # noqa: E501
    location: LeafenginesQueryRequestLocation
    plant: LeafenginesQueryRequestPlant
    options: Optional[LeafenginesQueryRequestOptions] = None
    __properties: ClassVar[List[str]] = ["location", "plant", "options"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "location": LeafenginesQueryRequestLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
            "plant": LeafenginesQueryRequestPlant.from_dict(obj.get("plant")) if obj.get("plant") is not None else None,
            "options": LeafenginesQueryRequestOptions.from_dict(obj.get("options")) if obj.get("options") is not None else None
        })
        return _obj
