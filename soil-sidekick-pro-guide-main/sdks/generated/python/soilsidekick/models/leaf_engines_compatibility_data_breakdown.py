...
class LeafEnginesCompatibilityDataBreakdown(BaseModel):
    """
    LeafEnginesCompatibilityDataBreakdown
    """ # noqa: E501
    soil: Optional[LeafEnginesCompatibilityDataBreakdownSoil] = None
    water: Optional[Dict[str, Any]] = None
    climate: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["soil", "water", "climate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of soil
        if self.soil:
            _dict['soil'] = self.soil.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "soil": LeafEnginesCompatibilityDataBreakdownSoil.from_dict(obj.get("soil")) if obj.get("soil") is not None else None,
            "water": obj.get("water"),
