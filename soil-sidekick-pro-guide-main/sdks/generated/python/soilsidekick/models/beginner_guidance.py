...
class BeginnerGuidance(BaseModel):
    ...
    simple_answer: Optional[StrictStr] = Field(default=None, description="Plain-language answer without jargon, 1-2 sentences")
    what_to_do_now: Optional[StrictStr] = Field(default=None, description="Immediate actionable step")
    why_this_happens: Optional[StrictStr] = Field(default=None, description="Simple explanation of the cause")
    detailed_explanation: Optional[BeginnerGuidanceDetailedExplanation] = None
    encouragement: Optional[StrictStr] = Field(default=None, description="Supportive message for the user")
    related_questions: Optional[List[StrictStr]] = Field(default=None, description="Common follow-up questions")
    confidence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Confidence in the guidance (0-100)")
    metadata: Optional[BeginnerGuidanceMetadata] = None
    __properties: ClassVar[List[str]] = ["success", "simple_answer", "what_to_do_now", "why_this_happens", "detailed_explanation", "encouragement", "related_questions", "confidence", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of detailed_explanation
        if self.detailed_explanation:
            _dict['detailed_explanation'] = self.detailed_explanation.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "simple_answer": obj.get("simple_answer"),
            "what_to_do_now": obj.get("what_to_do_now"),
            "why_this_happens": obj.get("why_this_happens"),
            "detailed_explanation": BeginnerGuidanceDetailedExplanation.from_dict(obj.get("detailed_explanation")) if obj.get("detailed_explanation") is not None else None,
            "encouragement": obj.get("encouragement"),
            "related_questions": obj.get("related_questions"),
            "confidence": obj.get("confidence"),
            "metadata": BeginnerGuidanceMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
