...
class CarbonCreditCalculation(BaseModel):
    ...
    credit_record: Optional[CarbonCreditCalculationCreditRecord] = None
    calculation_details: Optional[CarbonCreditCalculationCalculationDetails] = None
    __properties: ClassVar[List[str]] = ["success", "credit_record", "calculation_details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of credit_record
        if self.credit_record:
            _dict['credit_record'] = self.credit_record.to_dict()
        # override the default output from pydantic by calling `to_dict()` of calculation_details
        if self.calculation_details:
            _dict['calculation_details'] = self.calculation_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "credit_record": CarbonCreditCalculationCreditRecord.from_dict(obj.get("credit_record")) if obj.get("credit_record") is not None else None,
            "calculation_details": CarbonCreditCalculationCalculationDetails.from_dict(obj.get("calculation_details")) if obj.get("calculation_details") is not None else None
        })
        return _obj
