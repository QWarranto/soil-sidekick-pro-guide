...
class DynamicCareCareRecommendations(BaseModel):
    """
    DynamicCareCareRecommendations
    """ # noqa: E501
    watering: Optional[DynamicCareCareRecommendationsWatering] = None
    light: Optional[DynamicCareCareRecommendationsLight] = None
    humidity: Optional[DynamicCareCareRecommendationsHumidity] = None
    seasonal_notes: Optional[StrictStr] = Field(default=None, description="Season-specific care adjustments")
    __properties: ClassVar[List[str]] = ["watering", "light", "humidity", "seasonal_notes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of watering
        if self.watering:
            _dict['watering'] = self.watering.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "watering": DynamicCareCareRecommendationsWatering.from_dict(obj.get("watering")) if obj.get("watering") is not None else None,
            "light": DynamicCareCareRecommendationsLight.from_dict(obj.get("light")) if obj.get("light") is not None else None,
            "humidity": DynamicCareCareRecommendationsHumidity.from_dict(obj.get("humidity")) if obj.get("humidity") is not None else None,
            "seasonal_notes": obj.get("seasonal_notes")
        })
        return _obj
