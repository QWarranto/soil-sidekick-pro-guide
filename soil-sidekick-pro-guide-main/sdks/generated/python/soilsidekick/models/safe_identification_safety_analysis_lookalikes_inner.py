...
class SafeIdentificationSafetyAnalysisLookalikesInner(BaseModel):
    """
    SafeIdentificationSafetyAnalysisLookalikesInner
    """ # noqa: E501
    plant_name: Optional[StrictStr] = None
    visual_similarity: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Visual similarity score (0-100)")
    toxicity_level: Optional[StrictStr] = None
    distinguishing_features: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["plant_name", "visual_similarity", "toxicity_level", "distinguishing_features"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "visual_similarity": obj.get("visual_similarity"),
            "toxicity_level": obj.get("toxicity_level"),
            "distinguishing_features": obj.get("distinguishing_features")
        })
        return _obj
