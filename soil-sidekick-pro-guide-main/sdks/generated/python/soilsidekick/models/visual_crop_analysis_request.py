...
class VisualCropAnalysisRequest(BaseModel):
    ...
    def analysis_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('pest_detection', 'crop_health', 'disease_screening'):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "location": VisualCropAnalysisRequestLocation.from_dict(obj.get("location")) if obj.get("location") is not None else None,
