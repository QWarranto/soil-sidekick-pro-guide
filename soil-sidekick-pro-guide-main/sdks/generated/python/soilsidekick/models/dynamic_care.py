...
class DynamicCare(BaseModel):
    """
    Dynamic, environment-aware plant care recommendations
    """ # noqa: E501
    success: Optional[StrictBool] = None
    plant: Optional[DynamicCarePlant] = None
    current_conditions: Optional[DynamicCareCurrentConditions] = None
    care_recommendations: Optional[DynamicCareCareRecommendations] = None
    warnings: Optional[List[StrictStr]] = Field(default=None, description="Any urgent care warnings")
    metadata: Optional[DynamicCareMetadata] = None
    __properties: ClassVar[List[str]] = ["success", "plant", "current_conditions", "care_recommendations", "warnings", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of care_recommendations
        if self.care_recommendations:
            _dict['care_recommendations'] = self.care_recommendations.to_dict()
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "plant": DynamicCarePlant.from_dict(obj.get("plant")) if obj.get("plant") is not None else None,
            "current_conditions": DynamicCareCurrentConditions.from_dict(obj.get("current_conditions")) if obj.get("current_conditions") is not None else None,
            "care_recommendations": DynamicCareCareRecommendations.from_dict(obj.get("care_recommendations")) if obj.get("care_recommendations") is not None else None,
            "warnings": obj.get("warnings"),
            "metadata": DynamicCareMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None
        })
        return _obj
