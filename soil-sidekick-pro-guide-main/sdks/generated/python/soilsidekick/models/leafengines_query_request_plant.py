...
class LeafenginesQueryRequestPlant(BaseModel):
    """
    ...
    care_requirements: Optional[LeafenginesQueryRequestPlantCareRequirements] = None
    __properties: ClassVar[List[str]] = ["common_name", "scientific_name", "plant_id", "care_requirements"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of care_requirements
        if self.care_requirements:
            _dict['care_requirements'] = self.care_requirements.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "care_requirements": LeafenginesQueryRequestPlantCareRequirements.from_dict(obj.get("care_requirements")) if obj.get("care_requirements") is not None else None
        })
        return _obj
