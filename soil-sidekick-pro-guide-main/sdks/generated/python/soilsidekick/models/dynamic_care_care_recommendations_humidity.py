...
class DynamicCareCareRecommendationsHumidity(BaseModel):
    """
    DynamicCareCareRecommendationsHumidity
    """ # noqa: E501
    current_level: Optional[StrictStr] = None
    ideal_range: Optional[StrictStr] = None
    adjustment_recommendation: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["current_level", "ideal_range", "adjustment_recommendation"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ideal_range": obj.get("ideal_range"),
            "adjustment_recommendation": obj.get("adjustment_recommendation")
        })
        return _obj
