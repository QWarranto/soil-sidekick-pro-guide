...
class SeasonalPlanningResponse(BaseModel):
    """
    SeasonalPlanningResponse
    """ # noqa: E501
    success: Optional[StrictBool] = None
    recommendations: Optional[SeasonalPlanningResponseRecommendations] = None
    weather_data: Optional[SeasonalPlanningResponseWeatherData] = Field(default=None, alias="weatherData")
    model_used: Optional[StrictStr] = Field(default=None, alias="modelUsed")
    __properties: ClassVar[List[str]] = ["success", "recommendations", "weatherData", "modelUsed"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of weather_data
        if self.weather_data:
            _dict['weatherData'] = self.weather_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "recommendations": SeasonalPlanningResponseRecommendations.from_dict(obj.get("recommendations")) if obj.get("recommendations") is not None else None,
            "weatherData": SeasonalPlanningResponseWeatherData.from_dict(obj.get("weatherData")) if obj.get("weatherData") is not None else None,
            "modelUsed": obj.get("modelUsed")
        })
        return _obj
