...
class EnvironmentalImpactDetailedAnalysisEcoAlternatives(BaseModel):
    """
    EnvironmentalImpactDetailedAnalysisEcoAlternatives
    """ # noqa: E501
    alternatives: Optional[List[EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner]] = None
    __properties: ClassVar[List[str]] = ["alternatives"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "alternatives": [EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner.from_dict(_item) for _item in obj.get("alternatives")] if obj.get("alternatives") is not None else None
        })
        return _obj
