...
class EnvironmentalImpactImpactAssessment(BaseModel):
    """
    EnvironmentalImpactImpactAssessment
    """ # noqa: E501
    runoff_risk_score: Optional[Union[StrictFloat, StrictInt]] = None
    water_body_proximity: Optional[Union[StrictFloat, StrictInt]] = None
    contamination_risk: Optional[StrictStr] = None
    carbon_footprint_score: Optional[Union[StrictFloat, StrictInt]] = None
    biodiversity_impact: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["runoff_risk_score", "water_body_proximity", "contamination_risk", "carbon_footprint_score", "biodiversity_impact"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "runoff_risk_score": obj.get("runoff_risk_score"),
            "water_body_proximity": obj.get("water_body_proximity"),
            "contamination_risk": obj.get("contamination_risk"),
            "carbon_footprint_score": obj.get("carbon_footprint_score"),
            "biodiversity_impact": obj.get("biodiversity_impact")
        })
        return _obj
