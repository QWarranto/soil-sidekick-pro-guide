...
class SmartReportSummary(BaseModel):
    """
    SmartReportSummary
    """ # noqa: E501
    success: Optional[StrictBool] = None
    summary: Optional[SmartReportSummarySummary] = None
    model_used: Optional[StrictStr] = Field(default=None, alias="modelUsed")
    __properties: ClassVar[List[str]] = ["success", "summary", "modelUsed"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "summary": SmartReportSummarySummary.from_dict(obj.get("summary")) if obj.get("summary") is not None else None,
