...
class DynamicCareCurrentConditions(BaseModel):
    """
    DynamicCareCurrentConditions
    """ # noqa: E501
    temperature_f: Optional[Union[StrictFloat, StrictInt]] = None
    humidity_percent: Optional[Union[StrictFloat, StrictInt]] = None
    recent_rainfall_inches: Optional[Union[StrictFloat, StrictInt]] = None
    season: Optional[StrictStr] = None
    days_since_watered: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["temperature_f", "humidity_percent", "recent_rainfall_inches", "season", "days_since_watered"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "temperature_f": obj.get("temperature_f"),
            "humidity_percent": obj.get("humidity_percent"),
            "recent_rainfall_inches": obj.get("recent_rainfall_inches"),
            "season": obj.get("season"),
            "days_since_watered": obj.get("days_since_watered")
        })
        return _obj
