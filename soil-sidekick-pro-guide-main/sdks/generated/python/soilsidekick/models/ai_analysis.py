...
class AIAnalysis(BaseModel):
    ...
    recommendations: Optional[List[AIAnalysisRecommendationsInner]] = None
    __properties: ClassVar[List[str]] = ["analysis_type", "confidence_score", "recommendations"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "recommendations": [AIAnalysisRecommendationsInner.from_dict(_item) for _item in obj.get("recommendations")] if obj.get("recommendations") is not None else None
        })
        return _obj
