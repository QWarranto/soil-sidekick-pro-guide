...
class WaterQualityApi:
    ...
    @validate_call
    def get_territorial_water_analytics(
        self,
        get_territorial_water_analytics_request: GetTerritorialWaterAnalyticsRequest,
        ...
        :param get_territorial_water_analytics_request: (required)
        :type get_territorial_water_analytics_request: GetTerritorialWaterAnalyticsRequest
        ...
        _param = self._get_territorial_water_analytics_serialize(
            get_territorial_water_analytics_request=get_territorial_water_analytics_request,
    ...
    @validate_call
    def get_territorial_water_analytics_with_http_info(
        self,
        get_territorial_water_analytics_request: GetTerritorialWaterAnalyticsRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TerritorialWaterAnalytics]:
        """Get territorial water analytics
    ...
    @validate_call
    def get_territorial_water_analytics_without_preload_content(
        self,
        get_territorial_water_analytics_request: GetTerritorialWaterAnalyticsRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_territorial_water_analytics_serialize(
        self,
        get_territorial_water_analytics_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if get_territorial_water_analytics_request is not None:
            _body_params = get_territorial_water_analytics_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/territorial-water-analytics',
    ...
    def get_water_quality(
        self,
        get_water_quality_request: GetWaterQualityRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param get_water_quality_request: (required)
        :type get_water_quality_request: GetWaterQualityRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_water_quality_serialize(
            get_water_quality_request=get_water_quality_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_water_quality_with_http_info(
        self,
        get_water_quality_request: GetWaterQualityRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_water_quality_without_preload_content(
        self,
        get_water_quality_request: GetWaterQualityRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_water_quality_serialize(
        self,
        get_water_quality_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if get_water_quality_request is not None:
            _body_params = get_water_quality_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/territorial-water-quality',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
