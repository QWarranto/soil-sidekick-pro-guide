...
class TestEnvironmentalImpactDetailedAnalysisRunoffRisk(unittest.TestCase):
    """EnvironmentalImpactDetailedAnalysisRunoffRisk unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentalImpactDetailedAnalysisRunoffRisk:
        """Test EnvironmentalImpactDetailedAnalysisRunoffRisk
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentalImpactDetailedAnalysisRunoffRisk`
        """
        model = EnvironmentalImpactDetailedAnalysisRunoffRisk()
        if include_optional:
            return EnvironmentalImpactDetailedAnalysisRunoffRisk(
                score = 1.337,
                risk_level = 'low',
    ...
    def testEnvironmentalImpactDetailedAnalysisRunoffRisk(self):
        """Test EnvironmentalImpactDetailedAnalysisRunoffRisk"""
