...
class TestCalculateEnvironmentalImpactRequestProposedTreatmentsInner(unittest.TestCase):
    """CalculateEnvironmentalImpactRequestProposedTreatmentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEnvironmentalImpactRequestProposedTreatmentsInner:
        """Test CalculateEnvironmentalImpactRequestProposedTreatmentsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEnvironmentalImpactRequestProposedTreatmentsInner`
        """
        model = CalculateEnvironmentalImpactRequestProposedTreatmentsInner()
        if include_optional:
            return CalculateEnvironmentalImpactRequestProposedTreatmentsInner(
    ...
    def testCalculateEnvironmentalImpactRequestProposedTreatmentsInner(self):
        """Test CalculateEnvironmentalImpactRequestProposedTreatmentsInner"""
