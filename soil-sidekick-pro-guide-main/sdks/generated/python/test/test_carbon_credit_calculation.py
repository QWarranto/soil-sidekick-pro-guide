...
class TestCarbonCreditCalculation(unittest.TestCase):
    """CarbonCreditCalculation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarbonCreditCalculation:
        """Test CarbonCreditCalculation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarbonCreditCalculation`
        """
        model = CarbonCreditCalculation()
        if include_optional:
            return CarbonCreditCalculation(
                success = True,
                credit_record = soilsidekick.models.carbon_credit_calculation_credit_record.CarbonCreditCalculation_credit_record(
                    id = '', 
                    field_name = '', 
                    field_size_acres = 1.337, 
                    credits_earned = 1.337, 
                    verification_status = 'pending', ),
                calculation_details = soilsidekick.models.carbon_credit_calculation_calculation_details.CarbonCreditCalculation_calculation_details(
                    credits_earned = 1.337, 
                    calculation_method = '', 
                    baseline_carbon = 1.337, 
                    enhanced_carbon = 1.337, 
                    verification_confidence = 1.337, 
                    metadata = soilsidekick.models.carbon_credit_calculation_calculation_details_metadata.CarbonCreditCalculation_calculation_details_metadata(
                        calculation_factors = soilsidekick.models.calculation_factors.calculation_factors(), 
                        data_sources = [
                            ''
                            ], 
    ...
    def testCarbonCreditCalculation(self):
        """Test CarbonCreditCalculation"""
