...
class TestEnvironmentalImpact(unittest.TestCase):
    """EnvironmentalImpact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentalImpact:
        """Test EnvironmentalImpact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentalImpact`
        """
        model = EnvironmentalImpact()
        if include_optional:
            return EnvironmentalImpact(
                impact_assessment = soilsidekick.models.environmental_impact_impact_assessment.EnvironmentalImpact_impact_assessment(
                    runoff_risk_score = 1.337, 
                    water_body_proximity = 1.337, 
                    contamination_risk = '', 
                    carbon_footprint_score = 1.337, 
                    biodiversity_impact = '', ),
                detailed_analysis = soilsidekick.models.environmental_impact_detailed_analysis.EnvironmentalImpact_detailed_analysis(
                    runoff_risk = soilsidekick.models.environmental_impact_detailed_analysis_runoff_risk.EnvironmentalImpact_detailed_analysis_runoff_risk(
                        score = 1.337, 
                        risk_level = 'low', 
                        contributing_factors = soilsidekick.models.contributing_factors.contributing_factors(), ), 
                    contamination_assessment = soilsidekick.models.contamination_assessment.contamination_assessment(), 
                    eco_alternatives = soilsidekick.models.environmental_impact_detailed_analysis_eco_alternatives.EnvironmentalImpact_detailed_analysis_eco_alternatives(
                        alternatives = [
                            soilsidekick.models.environmental_impact_detailed_analysis_eco_alternatives_alternatives_inner.EnvironmentalImpact_detailed_analysis_eco_alternatives_alternatives_inner(
                                category = '', 
                                alternative = '', 
                                description = '', 
                                environmental_benefit = '', 
                                effectiveness_score = 1.337, )
                            ], ), 
                    carbon_analysis = soilsidekick.models.carbon_analysis.carbon_analysis(), 
                    biodiversity_assessment = soilsidekick.models.biodiversity_assessment.biodiversity_assessment(), ),
                recommendations = [
                    ''
                    ]
            )
    ...
    def testEnvironmentalImpact(self):
        """Test EnvironmentalImpact"""
