...
class TestVRTPrescription(unittest.TestCase):
    """VRTPrescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VRTPrescription:
        """Test VRTPrescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VRTPrescription`
        """
        model = VRTPrescription()
        if include_optional:
            return VRTPrescription(
                ...
                application_type = '',
                zones = [
                    soilsidekick.models.vrt_prescription_zones_inner.VRTPrescription_zones_inner(
                        zone_id = 56, 
