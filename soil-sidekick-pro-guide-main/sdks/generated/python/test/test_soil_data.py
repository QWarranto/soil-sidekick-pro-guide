...
class TestSoilData(unittest.TestCase):
    """SoilData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoilData:
        """Test SoilData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoilData`
        """
        model = SoilData()
        if include_optional:
            return SoilData(
