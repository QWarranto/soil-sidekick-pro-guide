...
class TestLeafEnginesCompatibilityData(unittest.TestCase):
    """LeafEnginesCompatibilityData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafEnginesCompatibilityData:
        """Test LeafEnginesCompatibilityData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafEnginesCompatibilityData`
        """
        model = LeafEnginesCompatibilityData()
        if include_optional:
            return LeafEnginesCompatibilityData(
                overall_score = 1.337,
    ...
    def testLeafEnginesCompatibilityData(self):
        """Test LeafEnginesCompatibilityData"""
