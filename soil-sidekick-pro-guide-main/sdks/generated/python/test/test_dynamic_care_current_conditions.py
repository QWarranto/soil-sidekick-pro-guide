...
class TestDynamicCareCurrentConditions(unittest.TestCase):
    """DynamicCareCurrentConditions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareCurrentConditions:
        """Test DynamicCareCurrentConditions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareCurrentConditions`
        """
        model = DynamicCareCurrentConditions()
        if include_optional:
            return DynamicCareCurrentConditions(
                temperature_f = 1.337,
    ...
    def testDynamicCareCurrentConditions(self):
        """Test DynamicCareCurrentConditions"""
