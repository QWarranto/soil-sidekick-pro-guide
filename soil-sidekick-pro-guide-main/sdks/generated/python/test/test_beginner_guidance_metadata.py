...
class TestBeginnerGuidanceMetadata(unittest.TestCase):
    """BeginnerGuidanceMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidanceMetadata:
        """Test BeginnerGuidanceMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidanceMetadata`
        """
        model = BeginnerGuidanceMetadata()
        if include_optional:
            return BeginnerGuidanceMetadata(
    ...
    def testBeginnerGuidanceMetadata(self):
        """Test BeginnerGuidanceMetadata"""
