...
class TestBeginnerGuidanceRequest(unittest.TestCase):
    """BeginnerGuidanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidanceRequest:
        """Test BeginnerGuidanceRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidanceRequest`
        """
        model = BeginnerGuidanceRequest()
        if include_optional:
            return BeginnerGuidanceRequest(
                question = 'My plant has yellow leaves, what's wrong?',
                plant_context = soilsidekick.models.beginner_guidance_request_plant_context.beginnerGuidance_request_plant_context(
                    plant_name = '', 
                    image = '', ),
                location = soilsidekick.models.beginner_guidance_request_location.beginnerGuidance_request_location(
                    county_fips = '', 
                    indoor = True, ),
    ...
    def testBeginnerGuidanceRequest(self):
        """Test BeginnerGuidanceRequest"""
