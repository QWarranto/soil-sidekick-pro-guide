...
class TestGenerateVRTPrescriptionRequest(unittest.TestCase):
    """GenerateVRTPrescriptionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateVRTPrescriptionRequest:
        """Test GenerateVRTPrescriptionRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateVRTPrescriptionRequest`
        """
        model = GenerateVRTPrescriptionRequest()
        if include_optional:
            return GenerateVRTPrescriptionRequest(
                field_id = '',
    ...
    def testGenerateVRTPrescriptionRequest(self):
        """Test GenerateVRTPrescriptionRequest"""
