...
class TestLeafEnginesCompatibilityUsage(unittest.TestCase):
    """LeafEnginesCompatibilityUsage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafEnginesCompatibilityUsage:
        """Test LeafEnginesCompatibilityUsage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafEnginesCompatibilityUsage`
        """
        model = LeafEnginesCompatibilityUsage()
        if include_optional:
            return LeafEnginesCompatibilityUsage(
                credits_used = 56,
                response_time_ms = 56
            )
        else:
    ...
    def testLeafEnginesCompatibilityUsage(self):
        """Test LeafEnginesCompatibilityUsage"""
