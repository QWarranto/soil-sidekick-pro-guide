...
class TestCalculateEnvironmentalImpactRequest(unittest.TestCase):
    """CalculateEnvironmentalImpactRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalculateEnvironmentalImpactRequest:
        """Test CalculateEnvironmentalImpactRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalculateEnvironmentalImpactRequest`
        """
        model = CalculateEnvironmentalImpactRequest()
        if include_optional:
            return CalculateEnvironmentalImpactRequest(
                analysis_id = '',
                county_fips = '04807',
                soil_data = soilsidekick.models.calculate_environmental_impact_request_soil_data.calculateEnvironmentalImpact_request_soil_data(
                    ph_level = 1.337, 
                    organic_matter = 1.337, 
                    slope = 'flat', 
                    drainage = 'poor', 
                    nitrogen_level = '', 
                    phosphorus_level = '', ),
                proposed_treatments = [
                    soilsidekick.models.calculate_environmental_impact_request_proposed_treatments_inner.calculateEnvironmentalImpact_request_proposed_treatments_inner(
                        type = 'nitrogen_fertilizer', )
                    ],
                water_body_data = soilsidekick.models.calculate_environmental_impact_request_water_body_data.calculateEnvironmentalImpact_request_water_body_data(
    ...
    def testCalculateEnvironmentalImpactRequest(self):
        """Test CalculateEnvironmentalImpactRequest"""
