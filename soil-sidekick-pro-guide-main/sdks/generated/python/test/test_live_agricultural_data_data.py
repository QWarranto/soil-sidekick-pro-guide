...
class TestLiveAgriculturalDataData(unittest.TestCase):
    """LiveAgriculturalDataData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiveAgriculturalDataData:
        """Test LiveAgriculturalDataData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiveAgriculturalDataData`
        """
        model = LiveAgriculturalDataData()
        if include_optional:
            return LiveAgriculturalDataData(
    ...
    def testLiveAgriculturalDataData(self):
        """Test LiveAgriculturalDataData"""
