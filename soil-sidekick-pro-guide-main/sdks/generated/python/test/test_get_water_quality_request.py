...
class TestGetWaterQualityRequest(unittest.TestCase):
    """GetWaterQualityRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetWaterQualityRequest:
        """Test GetWaterQualityRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetWaterQualityRequest`
        """
        model = GetWaterQualityRequest()
        if include_optional:
            return GetWaterQualityRequest(
                county_fips = '12345'
            )
        else:
            return GetWaterQualityRequest(
    ...
    def testGetWaterQualityRequest(self):
        """Test GetWaterQualityRequest"""
