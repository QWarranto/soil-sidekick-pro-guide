...
class TestLeafenginesQueryRequest(unittest.TestCase):
    """LeafenginesQueryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafenginesQueryRequest:
        """Test LeafenginesQueryRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafenginesQueryRequest`
        """
        model = LeafenginesQueryRequest()
        if include_optional:
            return LeafenginesQueryRequest(
                location = soilsidekick.models.leafengines_query_request_location.leafenginesQuery_request_location(
                    latitude = 1.337, 
                    longitude = 1.337, 
                    address = '', 
                    county_fips = '', ),
                plant = soilsidekick.models.leafengines_query_request_plant.leafenginesQuery_request_plant(
                    common_name = '', 
                    scientific_name = '', 
                    plant_id = '', 
                    care_requirements = soilsidekick.models.leafengines_query_request_plant_care_requirements.leafenginesQuery_request_plant_care_requirements(
                        sun_exposure = 'full_sun', 
                        water_needs = 'low', 
                        soil_ph_range = soilsidekick.models.leafengines_query_request_plant_care_requirements_soil_ph_range.leafenginesQuery_request_plant_care_requirements_soil_ph_range(
                            min = 1.337, 
                            max = 1.337, ), ), ),
                options = soilsidekick.models.leafengines_query_request_options.leafenginesQuery_request_options(
    ...
    def testLeafenginesQueryRequest(self):
        """Test LeafenginesQueryRequest"""
