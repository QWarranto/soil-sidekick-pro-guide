...
class TestDynamicCareCareRecommendationsWatering(unittest.TestCase):
    """DynamicCareCareRecommendationsWatering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareCareRecommendationsWatering:
        """Test DynamicCareCareRecommendationsWatering
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareCareRecommendationsWatering`
        """
        model = DynamicCareCareRecommendationsWatering()
        if include_optional:
            return DynamicCareCareRecommendationsWatering(
                action = 'water_now',
                reasoning = '',
                next_check_days = 56,
                amount_guidance = ''
    ...
    def testDynamicCareCareRecommendationsWatering(self):
        """Test DynamicCareCareRecommendationsWatering"""
