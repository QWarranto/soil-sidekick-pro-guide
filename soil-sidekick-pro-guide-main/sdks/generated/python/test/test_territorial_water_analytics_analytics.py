...
class TestTerritorialWaterAnalyticsAnalytics(unittest.TestCase):
    """TerritorialWaterAnalyticsAnalytics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerritorialWaterAnalyticsAnalytics:
        """Test TerritorialWaterAnalyticsAnalytics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerritorialWaterAnalyticsAnalytics`
        """
        model = TerritorialWaterAnalyticsAnalytics()
        if include_optional:
            return TerritorialWaterAnalyticsAnalytics(
                territorial_coverage = soilsidekick.models.territorial_coverage.territorial_coverage(),
                water_quality_metrics = soilsidekick.models.water_quality_metrics.water_quality_metrics(),
                regional_insights = soilsidekick.models.regional_insights.regional_insights(),
                compliance_status = soilsidekick.models.compliance_status.compliance_status()
            )
        else:
            return TerritorialWaterAnalyticsAnalytics(
        )
    ...
    def testTerritorialWaterAnalyticsAnalytics(self):
        """Test TerritorialWaterAnalyticsAnalytics"""
