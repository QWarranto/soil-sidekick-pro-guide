...
class TestAIAnalysis(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AIAnalysis:
        """Test AIAnalysis
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysis`
        """
        model = AIAnalysis()
        if include_optional:
            return AIAnalysis(
                ...
                recommendations = [
                    soilsidekick.models.ai_analysis_recommendations_inner.AIAnalysis_recommendations_inner(
                        title = '', 
                        description = '', 
                        priority = 'low', )
                    ]
