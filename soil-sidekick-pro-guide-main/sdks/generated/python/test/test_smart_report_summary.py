...
class TestSmartReportSummary(unittest.TestCase):
    """SmartReportSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SmartReportSummary:
        """Test SmartReportSummary
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SmartReportSummary`
        """
        model = SmartReportSummary()
        if include_optional:
            return SmartReportSummary(
                success = True,
                summary = soilsidekick.models.smart_report_summary_summary.SmartReportSummary_summary(
                    executive_summary = '', 
                    key_findings = [
                        ''
                        ], 
    ...
    def testSmartReportSummary(self):
        """Test SmartReportSummary"""
