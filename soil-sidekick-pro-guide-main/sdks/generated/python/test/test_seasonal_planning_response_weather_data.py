...
class TestSeasonalPlanningResponseWeatherData(unittest.TestCase):
    """SeasonalPlanningResponseWeatherData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonalPlanningResponseWeatherData:
        """Test SeasonalPlanningResponseWeatherData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonalPlanningResponseWeatherData`
        """
        model = SeasonalPlanningResponseWeatherData()
        if include_optional:
            return SeasonalPlanningResponseWeatherData(
                current_season = '',
                temperature = '',
                rainfall = '',
    ...
    def testSeasonalPlanningResponseWeatherData(self):
        """Test SeasonalPlanningResponseWeatherData"""
