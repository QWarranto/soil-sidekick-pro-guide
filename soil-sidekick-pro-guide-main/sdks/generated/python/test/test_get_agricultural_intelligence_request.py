...
class TestGetAgriculturalIntelligenceRequest(unittest.TestCase):
    """GetAgriculturalIntelligenceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetAgriculturalIntelligenceRequest:
        """Test GetAgriculturalIntelligenceRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetAgriculturalIntelligenceRequest`
        """
        model = GetAgriculturalIntelligenceRequest()
        if include_optional:
            return GetAgriculturalIntelligenceRequest(
                county_fips = '04807',
    ...
    def testGetAgriculturalIntelligenceRequest(self):
        """Test GetAgriculturalIntelligenceRequest"""
