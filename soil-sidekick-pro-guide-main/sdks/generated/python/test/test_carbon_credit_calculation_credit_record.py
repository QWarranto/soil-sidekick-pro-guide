...
class TestCarbonCreditCalculationCreditRecord(unittest.TestCase):
    """CarbonCreditCalculationCreditRecord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarbonCreditCalculationCreditRecord:
        """Test CarbonCreditCalculationCreditRecord
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarbonCreditCalculationCreditRecord`
        """
        model = CarbonCreditCalculationCreditRecord()
        if include_optional:
            return CarbonCreditCalculationCreditRecord(
                id = '',
                field_name = '',
    ...
    def testCarbonCreditCalculationCreditRecord(self):
        """Test CarbonCreditCalculationCreditRecord"""
