...
class TestTerritorialWaterAnalytics(unittest.TestCase):
    """TerritorialWaterAnalytics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TerritorialWaterAnalytics:
        """Test TerritorialWaterAnalytics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TerritorialWaterAnalytics`
        """
        model = TerritorialWaterAnalytics()
        if include_optional:
            return TerritorialWaterAnalytics(
                success = True,
                analytics = soilsidekick.models.territorial_water_analytics_analytics.TerritorialWaterAnalytics_analytics(
    ...
    def testTerritorialWaterAnalytics(self):
        """Test TerritorialWaterAnalytics"""
