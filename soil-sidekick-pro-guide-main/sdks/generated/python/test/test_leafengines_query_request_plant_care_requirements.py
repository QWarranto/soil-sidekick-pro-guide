...
class TestLeafenginesQueryRequestPlantCareRequirements(unittest.TestCase):
    """LeafenginesQueryRequestPlantCareRequirements unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafenginesQueryRequestPlantCareRequirements:
        """Test LeafenginesQueryRequestPlantCareRequirements
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafenginesQueryRequestPlantCareRequirements`
        """
        model = LeafenginesQueryRequestPlantCareRequirements()
        if include_optional:
            return LeafenginesQueryRequestPlantCareRequirements(
    ...
    def testLeafenginesQueryRequestPlantCareRequirements(self):
        """Test LeafenginesQueryRequestPlantCareRequirements"""
