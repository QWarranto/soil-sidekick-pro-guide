...
class TestGetSatelliteDataRequest(unittest.TestCase):
    """GetSatelliteDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetSatelliteDataRequest:
        """Test GetSatelliteDataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetSatelliteDataRequest`
        """
        model = GetSatelliteDataRequest()
        if include_optional:
            return GetSatelliteDataRequest(
                latitude = -90,
                longitude = -180
            )
        else:
    ...
    def testGetSatelliteDataRequest(self):
        """Test GetSatelliteDataRequest"""
