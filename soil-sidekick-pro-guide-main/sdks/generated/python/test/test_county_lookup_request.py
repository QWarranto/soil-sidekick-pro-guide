...
class TestCountyLookupRequest(unittest.TestCase):
    """CountyLookupRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountyLookupRequest:
        """Test CountyLookupRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountyLookupRequest`
        """
        model = CountyLookupRequest()
        if include_optional:
            return CountyLookupRequest(
                term = 'Miami-Dade'
            )
        else:
            return CountyLookupRequest(
    ...
    def testCountyLookupRequest(self):
        """Test CountyLookupRequest"""
