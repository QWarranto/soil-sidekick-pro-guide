...
class TestLeafenginesQueryRequestPlant(unittest.TestCase):
    """LeafenginesQueryRequestPlant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeafenginesQueryRequestPlant:
        """Test LeafenginesQueryRequestPlant
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LeafenginesQueryRequestPlant`
        """
        model = LeafenginesQueryRequestPlant()
        if include_optional:
            return LeafenginesQueryRequestPlant(
                common_name = '',
                scientific_name = '',
                plant_id = '',
    ...
    def testLeafenginesQueryRequestPlant(self):
        """Test LeafenginesQueryRequestPlant"""
