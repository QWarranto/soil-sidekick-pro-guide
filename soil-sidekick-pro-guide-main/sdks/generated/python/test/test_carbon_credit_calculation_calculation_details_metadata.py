...
class TestCarbonCreditCalculationCalculationDetailsMetadata(unittest.TestCase):
    """CarbonCreditCalculationCalculationDetailsMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarbonCreditCalculationCalculationDetailsMetadata:
        """Test CarbonCreditCalculationCalculationDetailsMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarbonCreditCalculationCalculationDetailsMetadata`
        """
        model = CarbonCreditCalculationCalculationDetailsMetadata()
        if include_optional:
            return CarbonCreditCalculationCalculationDetailsMetadata(
    ...
    def testCarbonCreditCalculationCalculationDetailsMetadata(self):
        """Test CarbonCreditCalculationCalculationDetailsMetadata"""
