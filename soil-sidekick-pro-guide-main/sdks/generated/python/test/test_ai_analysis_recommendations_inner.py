...
class TestAIAnalysisRecommendationsInner(unittest.TestCase):
    """AIAnalysisRecommendationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AIAnalysisRecommendationsInner:
        """Test AIAnalysisRecommendationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AIAnalysisRecommendationsInner`
        """
        model = AIAnalysisRecommendationsInner()
        if include_optional:
            return AIAnalysisRecommendationsInner(
                title = '',
                description = '',
                priority = 'low'
            )
    ...
    def testAIAnalysisRecommendationsInner(self):
        """Test AIAnalysisRecommendationsInner"""
