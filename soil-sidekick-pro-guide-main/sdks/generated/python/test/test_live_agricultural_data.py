...
class TestLiveAgriculturalData(unittest.TestCase):
    """LiveAgriculturalData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LiveAgriculturalData:
        """Test LiveAgriculturalData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LiveAgriculturalData`
        """
        model = LiveAgriculturalData()
        if include_optional:
            return LiveAgriculturalData(
                county_fips = '',
                county_name = '',
                state_code = '',
                data = soilsidekick.models.live_agricultural_data_data.LiveAgriculturalData_data(
                    weather = soilsidekick.models.weather.weather(), 
                    soil = soilsidekick.models.soil.soil(), 
                    crop = soilsidekick.models.crop.crop(), 
                    environmental = soilsidekick.models.environmental.environmental(), ),
                sources = [
                    ''
                    ],
    ...
    def testLiveAgriculturalData(self):
        """Test LiveAgriculturalData"""
