...
class TestDynamicCareMetadata(unittest.TestCase):
    """DynamicCareMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DynamicCareMetadata:
        """Test DynamicCareMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DynamicCareMetadata`
        """
        model = DynamicCareMetadata()
        if include_optional:
            return DynamicCareMetadata(
    ...
    def testDynamicCareMetadata(self):
        """Test DynamicCareMetadata"""
