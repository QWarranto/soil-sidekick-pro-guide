...
class TestCountyLookup200Response(unittest.TestCase):
    """CountyLookup200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CountyLookup200Response:
        """Test CountyLookup200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CountyLookup200Response`
        """
        model = CountyLookup200Response()
        if include_optional:
            return CountyLookup200Response(
                counties = [
                    soilsidekick.models.county.County(
                        id = '', 
                        county_name = '', 
                        state_name = '', 
                        state_code = '', 
    ...
    def testCountyLookup200Response(self):
        """Test CountyLookup200Response"""
