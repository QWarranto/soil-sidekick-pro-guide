...
class TestSafeIdentificationSafetyAnalysisLookalikesInner(unittest.TestCase):
    """SafeIdentificationSafetyAnalysisLookalikesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationSafetyAnalysisLookalikesInner:
        """Test SafeIdentificationSafetyAnalysisLookalikesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationSafetyAnalysisLookalikesInner`
        """
        model = SafeIdentificationSafetyAnalysisLookalikesInner()
        if include_optional:
            return SafeIdentificationSafetyAnalysisLookalikesInner(
                plant_name = '',
    ...
    def testSafeIdentificationSafetyAnalysisLookalikesInner(self):
        """Test SafeIdentificationSafetyAnalysisLookalikesInner"""
