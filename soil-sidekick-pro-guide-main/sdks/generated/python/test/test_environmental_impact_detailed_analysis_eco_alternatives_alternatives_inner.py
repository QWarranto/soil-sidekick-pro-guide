...
class TestEnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner(unittest.TestCase):
    """EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner:
        """Test EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner`
        """
        model = EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner()
        if include_optional:
            return EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner(
                category = '',
                alternative = '',
                description = '',
    ...
    def testEnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner(self):
        """Test EnvironmentalImpactDetailedAnalysisEcoAlternativesAlternativesInner"""
