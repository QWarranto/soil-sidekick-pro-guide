...
class TestSafeIdentificationRequest(unittest.TestCase):
    """SafeIdentificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationRequest:
        """Test SafeIdentificationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationRequest`
        """
        model = SafeIdentificationRequest()
        if include_optional:
            return SafeIdentificationRequest(
                image = '',
                location = soilsidekick.models.safe_identification_request_location.safeIdentification_request_location(
                    county_fips = '04807', 
                    state_code = '', 
                    coordinates = soilsidekick.models.safe_identification_request_location_coordinates.safeIdentification_request_location_coordinates(
                        latitude = 1.337, 
                        longitude = 1.337, ), ),
                context = soilsidekick.models.safe_identification_request_context.safeIdentification_request_context(
                    environment = 'wild', 
                    purpose = 'foraging', 
    ...
    def testSafeIdentificationRequest(self):
        """Test SafeIdentificationRequest"""
