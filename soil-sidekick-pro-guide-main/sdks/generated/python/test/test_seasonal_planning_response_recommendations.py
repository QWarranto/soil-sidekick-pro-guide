...
class TestSeasonalPlanningResponseRecommendations(unittest.TestCase):
    """SeasonalPlanningResponseRecommendations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeasonalPlanningResponseRecommendations:
        """Test SeasonalPlanningResponseRecommendations
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeasonalPlanningResponseRecommendations`
        """
        model = SeasonalPlanningResponseRecommendations()
        if include_optional:
            return SeasonalPlanningResponseRecommendations(
                seasonal_tasks = [
                    None
                    ],
    ...
    def testSeasonalPlanningResponseRecommendations(self):
        """Test SeasonalPlanningResponseRecommendations"""
