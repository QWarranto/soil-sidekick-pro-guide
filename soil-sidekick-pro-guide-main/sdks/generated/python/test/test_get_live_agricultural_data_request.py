...
class TestGetLiveAgriculturalDataRequest(unittest.TestCase):
    """GetLiveAgriculturalDataRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetLiveAgriculturalDataRequest:
        """Test GetLiveAgriculturalDataRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetLiveAgriculturalDataRequest`
        """
        model = GetLiveAgriculturalDataRequest()
        if include_optional:
            return GetLiveAgriculturalDataRequest(
                county_fips = '04807',
                data_types = [
                    'weather'
                    ],
    ...
    def testGetLiveAgriculturalDataRequest(self):
        """Test GetLiveAgriculturalDataRequest"""
