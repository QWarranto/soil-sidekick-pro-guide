...
class TestVRTPrescriptionZonesInner(unittest.TestCase):
    """VRTPrescriptionZonesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VRTPrescriptionZonesInner:
        """Test VRTPrescriptionZonesInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VRTPrescriptionZonesInner`
        """
        model = VRTPrescriptionZonesInner()
        if include_optional:
            return VRTPrescriptionZonesInner(
                zone_id = 56,
                application_rate = 1.337,
                geometry = soilsidekick.models.geometry.geometry()
            )
        else:
            return VRTPrescriptionZonesInner(
        )
    ...
    def testVRTPrescriptionZonesInner(self):
        """Test VRTPrescriptionZonesInner"""
