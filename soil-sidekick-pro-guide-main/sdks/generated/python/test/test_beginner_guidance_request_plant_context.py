...
class TestBeginnerGuidanceRequestPlantContext(unittest.TestCase):
    """BeginnerGuidanceRequestPlantContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BeginnerGuidanceRequestPlantContext:
        """Test BeginnerGuidanceRequestPlantContext
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BeginnerGuidanceRequestPlantContext`
        """
        model = BeginnerGuidanceRequestPlantContext()
        if include_optional:
            return BeginnerGuidanceRequestPlantContext(
                plant_name = '',
                image = ''
            )
        else:
    ...
    def testBeginnerGuidanceRequestPlantContext(self):
        """Test BeginnerGuidanceRequestPlantContext"""
