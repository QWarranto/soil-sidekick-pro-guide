...
class TestGetPlantingCalendarRequest(unittest.TestCase):
    """GetPlantingCalendarRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetPlantingCalendarRequest:
        """Test GetPlantingCalendarRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetPlantingCalendarRequest`
        """
        model = GetPlantingCalendarRequest()
        if include_optional:
            return GetPlantingCalendarRequest(
                county_fips = '04807',
                crop_type = 'corn'
            )
        else:
    ...
    def testGetPlantingCalendarRequest(self):
        """Test GetPlantingCalendarRequest"""
