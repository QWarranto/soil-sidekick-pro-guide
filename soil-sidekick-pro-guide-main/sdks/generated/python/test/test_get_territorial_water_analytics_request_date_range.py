...
class TestGetTerritorialWaterAnalyticsRequestDateRange(unittest.TestCase):
    """GetTerritorialWaterAnalyticsRequestDateRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetTerritorialWaterAnalyticsRequestDateRange:
        """Test GetTerritorialWaterAnalyticsRequestDateRange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetTerritorialWaterAnalyticsRequestDateRange`
        """
        model = GetTerritorialWaterAnalyticsRequestDateRange()
        if include_optional:
            return GetTerritorialWaterAnalyticsRequestDateRange(
    ...
    def testGetTerritorialWaterAnalyticsRequestDateRange(self):
        """Test GetTerritorialWaterAnalyticsRequestDateRange"""
