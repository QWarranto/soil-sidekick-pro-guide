...
class TestSafeIdentificationRequestLocationCoordinates(unittest.TestCase):
    """SafeIdentificationRequestLocationCoordinates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationRequestLocationCoordinates:
        """Test SafeIdentificationRequestLocationCoordinates
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationRequestLocationCoordinates`
        """
        model = SafeIdentificationRequestLocationCoordinates()
        if include_optional:
            return SafeIdentificationRequestLocationCoordinates(
                latitude = 1.337,
                longitude = 1.337
            )
        else:
    ...
    def testSafeIdentificationRequestLocationCoordinates(self):
        """Test SafeIdentificationRequestLocationCoordinates"""
