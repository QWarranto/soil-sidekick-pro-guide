...
class TestSafeIdentificationIdentification(unittest.TestCase):
    """SafeIdentificationIdentification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SafeIdentificationIdentification:
        """Test SafeIdentificationIdentification
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SafeIdentificationIdentification`
        """
        model = SafeIdentificationIdentification()
        if include_optional:
            return SafeIdentificationIdentification(
    ...
    def testSafeIdentificationIdentification(self):
        """Test SafeIdentificationIdentification"""
