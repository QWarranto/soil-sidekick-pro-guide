...
// checks if the CountyLookupRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountyLookupRequest{}

// CountyLookupRequest struct for CountyLookupRequest
type CountyLookupRequest struct {
	// Search term (county name, state, or FIPS)
	Term string `json:"term"`
}

type _CountyLookupRequest CountyLookupRequest
...
func (o CountyLookupRequest) MarshalJSON() ([]byte, error) {
...
func (o CountyLookupRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["term"] = o.Term
	return toSerialize, nil
}

func (o *CountyLookupRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCountyLookupRequest := _CountyLookupRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCountyLookupRequest)

	if err != nil {
		return err
	}

	*o = CountyLookupRequest(varCountyLookupRequest)

	return err
}

type NullableCountyLookupRequest struct {
	value *CountyLookupRequest
	isSet bool
}

func (v NullableCountyLookupRequest) Get() *CountyLookupRequest {
	return v.value
}

func (v *NullableCountyLookupRequest) Set(val *CountyLookupRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCountyLookupRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCountyLookupRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountyLookupRequest(val *CountyLookupRequest) *NullableCountyLookupRequest {
	return &NullableCountyLookupRequest{value: val, isSet: true}
}

func (v NullableCountyLookupRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountyLookupRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
