...
// checks if the GetWaterQualityRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetWaterQualityRequest{}

// GetWaterQualityRequest struct for GetWaterQualityRequest
type GetWaterQualityRequest struct {
	CountyFips string `json:"county_fips"`
}

type _GetWaterQualityRequest GetWaterQualityRequest

// NewGetWaterQualityRequest instantiates a new GetWaterQualityRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetWaterQualityRequest(countyFips string) *GetWaterQualityRequest {
	this := GetWaterQualityRequest{}
	this.CountyFips = countyFips
	return &this
}

// NewGetWaterQualityRequestWithDefaults instantiates a new GetWaterQualityRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetWaterQualityRequestWithDefaults() *GetWaterQualityRequest {
	this := GetWaterQualityRequest{}
	return &this
}

// GetCountyFips returns the CountyFips field value
func (o *GetWaterQualityRequest) GetCountyFips() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *GetWaterQualityRequest) GetCountyFipsOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetWaterQualityRequest) SetCountyFips(v string) {
	o.CountyFips = v
}

func (o GetWaterQualityRequest) MarshalJSON() ([]byte, error) {
...
func (o GetWaterQualityRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["county_fips"] = o.CountyFips
	return toSerialize, nil
}

func (o *GetWaterQualityRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetWaterQualityRequest := _GetWaterQualityRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetWaterQualityRequest)

	if err != nil {
		return err
	}

	*o = GetWaterQualityRequest(varGetWaterQualityRequest)

	return err
}

type NullableGetWaterQualityRequest struct {
	value *GetWaterQualityRequest
	isSet bool
}

func (v NullableGetWaterQualityRequest) Get() *GetWaterQualityRequest {
	return v.value
}

func (v *NullableGetWaterQualityRequest) Set(val *GetWaterQualityRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableGetWaterQualityRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableGetWaterQualityRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetWaterQualityRequest(val *GetWaterQualityRequest) *NullableGetWaterQualityRequest {
	return &NullableGetWaterQualityRequest{value: val, isSet: true}
}

func (v NullableGetWaterQualityRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetWaterQualityRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
