...
// CarbonAPIService CarbonAPI service
type CarbonAPIService service

type ApiCalculateCarbonCreditsRequest struct {
	ctx context.Context
	ApiService *CarbonAPIService
	calculateCarbonCreditsRequest *CalculateCarbonCreditsRequest
}

func (r ApiCalculateCarbonCreditsRequest) CalculateCarbonCreditsRequest(calculateCarbonCreditsRequest CalculateCarbonCreditsRequest) ApiCalculateCarbonCreditsRequest {
	r.calculateCarbonCreditsRequest = &calculateCarbonCreditsRequest
	return r
}

func (r ApiCalculateCarbonCreditsRequest) Execute() (*CarbonCreditCalculation, *http.Response, error) {
	return r.ApiService.CalculateCarbonCreditsExecute(r)
}
...
Calculate carbon credits based on field data and soil organic matter
 ...
 @return ApiCalculateCarbonCreditsRequest
*/
func (a *CarbonAPIService) CalculateCarbonCredits(ctx context.Context) ApiCalculateCarbonCreditsRequest {
	return ApiCalculateCarbonCreditsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CarbonAPIService) CalculateCarbonCreditsExecute(r ApiCalculateCarbonCreditsRequest) (*CarbonCreditCalculation, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CarbonCreditCalculation
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CarbonAPIService.CalculateCarbonCredits")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/carbon-credit-calculator"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.calculateCarbonCreditsRequest == nil {
		return localVarReturnValue, nil, reportError("calculateCarbonCreditsRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.calculateCarbonCreditsRequest
	if r.ctx != nil {
