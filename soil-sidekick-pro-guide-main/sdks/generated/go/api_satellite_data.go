...
// SatelliteDataAPIService SatelliteDataAPI service
type SatelliteDataAPIService service

type ApiGetSatelliteDataRequest struct {
	ctx context.Context
	ApiService *SatelliteDataAPIService
	getSatelliteDataRequest *GetSatelliteDataRequest
}

func (r ApiGetSatelliteDataRequest) GetSatelliteDataRequest(getSatelliteDataRequest GetSatelliteDataRequest) ApiGetSatelliteDataRequest {
	r.getSatelliteDataRequest = &getSatelliteDataRequest
	return r
}

func (r ApiGetSatelliteDataRequest) Execute() (*SatelliteData, *http.Response, error) {
	return r.ApiService.GetSatelliteDataExecute(r)
}

/*
GetSatelliteData Get satellite environmental data

AlphaEarth satellite intelligence integration

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSatelliteDataRequest
*/
func (a *SatelliteDataAPIService) GetSatelliteData(ctx context.Context) ApiGetSatelliteDataRequest {
	return ApiGetSatelliteDataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *SatelliteDataAPIService) GetSatelliteDataExecute(r ApiGetSatelliteDataRequest) (*SatelliteData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SatelliteData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SatelliteDataAPIService.GetSatelliteData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/alpha-earth-environmental-enhancement"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.getSatelliteDataRequest == nil {
		return localVarReturnValue, nil, reportError("getSatelliteDataRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getSatelliteDataRequest
	if r.ctx != nil {
