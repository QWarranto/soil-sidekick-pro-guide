...
> WaterQuality GetWaterQuality(ctx).GetWaterQualityRequest(getWaterQualityRequest).Execute()
...
func main() {
	getWaterQualityRequest := *openapiclient.NewGetWaterQualityRequest("12345") // GetWaterQualityRequest | 

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WaterQualityAPI.GetWaterQuality(context.Background()).GetWaterQualityRequest(getWaterQualityRequest).Execute()
	if err != nil {
