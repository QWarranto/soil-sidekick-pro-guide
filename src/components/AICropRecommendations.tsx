      ...
      <CardHeader>
        ...
        {recommendations && (
          <div className="flex items-center gap-2 text-xs text-muted-foreground">
            ...
            {recommendations.source === 'Cached Data' && (
              <span className="rounded border border-amber-500/40 bg-amber-500/10 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-amber-700">
                Sample data
              </span>
            )}
          </div>
