...
╔═══════════════════════════════════════════════════════════╗
║              PROPERTY ADDRESS (WATERMARK)                 ║
║                                                           ║
║  ${data.property_address.padEnd(57)} ║
║                                                           ║
║  This report is valid ONLY for the property address      ║
║  shown above. Unauthorized use for other properties      ║
║  is strictly prohibited and may constitute fraud.        ║
╚═══════════════════════════════════════════════════════════╝
` : ''}
REPORT INFORMATION
─────────────────────────────────────────────────────────────
${data.property_address ? `Property Address: ${data.property_address}\n` : ''}County:           ${data.county_name}, ${data.state_code}
Report Date:      ${date}
...
ANTI-REUSE NOTICE
─────────────────────────────────────────────────────────────
This report contains a unique property address watermark:
${data.property_address}

This report is legally valid ONLY for the watermarked property.
Using this report for any other property constitutes unauthorized
use and may be considered fraudulent misrepresentation.
` : ''}
═══════════════════════════════════════════════════════════════
...
${data.property_address ? `               
WATERMARKED FOR: ${data.property_address}` : ''}
═══════════════════════════════════════════════════════════════
    `;
  };
