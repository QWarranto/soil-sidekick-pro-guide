...
import { docBySlug, publicDocs, type DocEntry } from "@/lib/publicDocs";
...
// Allowlisted public docs come from @/lib/publicDocs — the single boundary
// shared by this UI and the WebMCP tools. Internal material lives in
// internal-docs/ and is never bundled.
const docs: DocEntry[] = publicDocs;
...
const getStarted: NavLink[] = [
  ...
  { label: "Install from GitHub MCP Registry", to: "https://github.com/mcp", blurb: "Now listed on the official GitHub MCP Registry — searchable in Claude Desktop, Cursor, and every registry-aware client.", external: true },
...
const sidebarSections: { title: string; links: NavLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "LeafEngines Bot Architecture (Verified)", to: "/docs/telegram/leafengines-bot-architecture" },
      { label: "LeafEngines Bot Support", to: "/docs/telegram/leafengines-bot-support" },
      { label: "Telegram Onboarding Pathway", to: "/docs/telegram/leafengines-telegram-onboarding-pathway" },
    ],
  },
  {
    title: "Use Cases",
  ...
  },
  {
    ...
    links: [
      ...
      { label: "QGIS Plugin Changelog (v1.0.10)", to: "/docs/workflows/qgis-plugin-changelog" },
      { label: "QGIS Feature Matrix", to: "/docs/qgis/feature-matrix" },
      { label: "QGIS Roadmap", to: "/docs/qgis/roadmap" },
      { label: "QGIS Cross-Platform", to: "/docs/qgis/leafengines-cross-platform" },
    ],
  },
  {
    title: "SDK",
    links: [
      ...
      { label: "SDK v3.0 Generation Guide", to: "/docs/sdk/sdk-v3-generation-guide" },
...
export default function DocsHub() {
  ...
  // WebMCP: expose docs + free-tier data tools to in-page agents.
  // No-ops when the flag is off or the browser has no navigator.modelContext.
