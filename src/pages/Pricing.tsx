  ...
  const tiers = [
    {
      ...
      monthlyPrice: 149,
      annualPrice: 1639,
      annualDiscount: "Save $149",
      description: "Perfect for emerging apps looking to integrate environmental intelligence",
      icon: Zap,
      popular: false,
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 499,
      annualPrice: 5489,
      annualDiscount: "Save $499",
      description: "Full environmental intelligence with EPA data and satellite monitoring",
      icon: Sparkles,
      popular: true,
      features: [
    ...
    },
    {
      ...
      monthlyPrice: 1999,
      annualPrice: 21989,
      annualDiscount: "Save $1,999",
      description: "White-label solution with EPA, satellite, and dedicated support",
      icon: Shield,
      popular: false,
      features: [
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="p-4 text-center text-sm font-semibold text-foreground">Developer</th>
                ...
                <tbody>
                  {[
                    ...
                    { feature: "Monthly API Calls", starter: "25K", pro: "100K", enterprise: "500K" },
                    { feature: "Rate Limit (req/min)", starter: "500", pro: "1,500", enterprise: "5,000" },
            ...
            <div className="mt-12 rounded-xl bg-gradient-to-r from-primary/10 via-purple-500/10 to-blue-500/10 p-8 text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Button size="lg" asChild>
                  <Link to="/docs/enterprise-client-questionnaire">
