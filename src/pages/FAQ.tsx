  ...
  const faqs = [
    {
      ...
      answer: "The Seasonal Task Manager helps you remember and improve farming practices from one season to the next. One of the biggest challenges farmers face is forgetting what needs to be done and when. The Task Manager provides 20+ pre-built task templates, recurring task automation, and task history tracking so you never forget critical seasonal tasks. Free tier allows 10 tasks, Hobby tier offers unlimited tasks with annual recurring, Grower tier adds advanced recurring patterns, and Pro tier layers on AI-powered insights and team features."
    },
    {
    ...
    },
    {
      ...
      answer: "Recurring tasks automatically remind you of seasonal activities year after year. Hobby tier ($29/mo) includes annual recurring tasks - perfect for yearly activities like spring soil testing or fall cover crop planting. Grower tier ($79/mo) unlocks advanced recurring patterns including seasonal (quarterly), monthly, and custom frequencies - ideal for intensive rotations, succession planting, and frequent monitoring tasks. Pro tier ($149/mo) adds AI-powered scheduling recommendations and team assignment. Free tier does not support recurring tasks."
    },
    {
      question: "What's the difference between Free, Hobby, Grower, and Pro tiers for task management?",
      answer: "Free tier: View templates (read-only) and create up to 10 tasks per season with basic status tracking. Hobby tier ($29/mo): Unlimited tasks, full template library access, task history tracking, annual recurring tasks, field assignment, and 50 email reminders/month. Grower tier ($79/mo): Everything in Hobby plus advanced recurring patterns (seasonal/monthly/custom), task learnings & notes, year-over-year comparison, unlimited reminders, and task export. Pro tier ($149/mo): Everything in Grower plus AI recommendations, team collaboration, API access, and priority support. Legacy 'Starter' and 'Pro' plan names still map to Hobby and Grower for existing subscribers."
    },
    {
    ...
    {
      question: "What are the current SoilSidekick Pro subscription plans and prices?",
      answer: "As of the November 2026 refresh, SoilSidekick Pro uses three consumer tiers: Hobby ($29/mo or $290/yr), Grower ($79/mo or $790/yr), and Pro ($149/mo or $1,490/yr) — annual billing gives you two months free. The legacy plan names (Starter, Pro, Enterprise) still work at checkout and are automatically mapped to the new names for existing subscribers. A separate LeafEngines API pricing page covers developer/API tiers at $149/$499/$1,999/month with blended per-call quotas. Founder lifetime pricing expired June 1, 2026 and is no longer available to new customers."
    },
    {
      question: "What has changed recently in SoilSidekick Pro and LeafEngines?",
      answer: "Highlights since our last FAQ refresh: (1) Consumer plans renamed to Hobby/Grower/Pro at $29/$79/$149. (2) Founder $10 and $49 lifetime pricing sunset on June 1, 2026. (3) LeafEngines API per-call packs and blended subscription quotas refreshed for June 2026. (4) SDK v3.1.0 released with auto-generated clients in TypeScript, Python, Ruby, Java, PHP, and Go. (5) QGIS plugin now supports WFS-T with case-insensitive OGC params and QGIS-compatible auth. (6) New SoilCertify GIS docs (Infrastructure Use Case, Developer Landing, Technical Overview) and a consolidated QGIS Developer Landing page. (7) Architecture, data-flow, and ERD diagrams added across the technical docs. (8) Offline suite hardened with Service Worker v3 and Gemma/WebGPU on-device LLM routing. (9) MCP server + audit governance for AI agents. (10) Affiliate program, Stripe metered billing, and V3 AES-256 encryption rollout."
    }
  ];

  const lastUpdated = "2026-11-19";
