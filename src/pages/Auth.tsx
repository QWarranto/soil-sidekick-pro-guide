...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithApple, signInWithLinkedIn, signInWithFacebook, signInWithPhone, verifyOtp, signInWithTrial, resetPassword, updatePassword, user, session, trialUser } = useAuth();
