...
const Auth = () => {
  ...
  const { signIn, signUp, signInWithGoogle, signInWithApple, signInWithLinkedIn, signInWithPhone, verifyOtp, signInWithTrial, resetPassword, updatePassword, user, session, trialUser } = useAuth();
